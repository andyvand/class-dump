...
public: // (access info unavailable from symbols alone)
    ...
    blit(IOAccel2DBlitCommand*, unsigned long long);
    blit(IOAccel2DBlitCommand*, unsigned long long)::_os_log_fmt;
    contextStart();
    contextStop();
    finish(unsigned int);
    getMetaClass() const;
    ...
    set_surface(unsigned int, eIOAccelContextModeBits);
    set_surface(unsigned int, eIOAccelContextModeBits)::_os_log_fmt;
    ~IOAccel2DContext2();
};
