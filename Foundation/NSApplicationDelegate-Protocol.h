...
- (_Bool)applicationShouldAutomaticallyLocalizeKeyEquivalents:(NSApplication *)arg1;
- (_Bool)application:(NSApplication *)arg1 delegateHandlesKey:(NSString *)arg2;
...
- (_Bool)application:(NSApplication *)arg1 continueUserActivity:(NSUserActivity *)arg2 restorationHandler:(void (^)(NSArray *))arg3;
- (_Bool)application:(NSApplication *)arg1 willContinueUserActivityWithType:(NSString *)arg2;
...
- (_Bool)applicationSupportsSecureRestorableState:(NSApplication *)arg1;
...
- (_Bool)applicationShouldHandleReopen:(NSApplication *)arg1 hasVisibleWindows:(_Bool)arg2;
- (_Bool)applicationShouldTerminateAfterLastWindowClosed:(NSApplication *)arg1;
- (unsigned long long)application:(NSApplication *)arg1 printFiles:(NSArray *)arg2 withSettings:(NSDictionary *)arg3 showPrintPanels:(_Bool)arg4;
- (_Bool)application:(NSApplication *)arg1 printFile:(NSString *)arg2;
- (_Bool)application:(id)arg1 openFileWithoutUI:(NSString *)arg2;
- (_Bool)applicationOpenUntitledFile:(NSApplication *)arg1;
- (_Bool)applicationShouldOpenUntitledFile:(NSApplication *)arg1;
- (_Bool)application:(NSApplication *)arg1 openTempFile:(NSString *)arg2;
- (void)application:(NSApplication *)arg1 openFiles:(NSArray *)arg2;
- (_Bool)application:(NSApplication *)arg1 openFile:(NSString *)arg2;
