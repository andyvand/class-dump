...
@interface CustomInstallController : InstallerPane <NSOpenSavePanelDelegate>
{
    ...
    NSView *uiBottomView;
    _Bool _userHasBeenAlertedAboutNeedForAdditionalMedia;
    NSCell *_locationPopUpMenuCell;
    _Bool _installAlwaysCustomizes;
...
- (_Bool)drawsPaneBorder;
- (id)bottomContentView;
- (void)willExitPane:(long long)arg1;
- (_Bool)shouldExitPane:(long long)arg1;
- (void)warningSheetDidEnd:(id)arg1 returnCode:(long long)arg2 contextInfo:(_Bool *)arg3;
