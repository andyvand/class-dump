...
@implementation CDLCFVMFile
{
    struct fvmfile_command _command;
    NSString *_path;
}
...
- (id)initWithDataCursor:(CDMachOFileDataCursor *)cursor;
{
    if ((self = [super initWithDataCursor:cursor])) {
        ...
        _command.header_addr = [cursor readInt32];

        NSUInteger headerSize = sizeof(uint32_t) * 4;
