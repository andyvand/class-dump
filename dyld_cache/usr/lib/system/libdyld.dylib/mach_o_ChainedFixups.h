...
public: // (access info unavailable from symbols alone)
    ...
    valid(unsigned long long, std::__1::span<mach_o::MappedSegment const, 18446744073709551615ul>, bool, bool) const;
    validLinkedit(unsigned long long, bool, std::__1::span<mach_o::MappedSegment const, 18446744073709551615ul>) const;
};
