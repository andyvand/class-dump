...
- (id);
- (oneway void)X&;
- (_Bool)DocumentsService setiCloudHome:(Class)arg1 withDataclassOption:]_block_invoke /* Error: Ran out of types for this method. */;
- (id)3e;
- (_Bool)InfoUpdater:(Protocol *)arg1;
- (id)s request. This is approximately the time when
