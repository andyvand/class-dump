...
- (id);
- (struct CGSize);
- (void)etchSavingStateForWebsiteURL:(id)arg1 applicationIdentifier:credential:passwordIsAutoGenerated:context:completionHandler: /* Error: Ran out of types for this method. */;
- (id)lid; domain=%{sensitive, mask.hash}@;
- (void);
