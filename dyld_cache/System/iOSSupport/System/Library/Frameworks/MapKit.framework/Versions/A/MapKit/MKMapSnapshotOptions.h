...
@class GEOApplicationAuditToken, GEOComposedRoute, MKMapCamera, MKMapConfiguration, MKPointOfInterestFilter, NSArray, NSMutableDictionary, NSNumber, NSString, UITraitCollection, VKRouteContext, _MKKVOProxy;
