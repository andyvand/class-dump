...
@class LPARAsset, LPARAssetMetadata, LPAudio, LPAudioMetadata, LPIconMetadata, LPImage, LPImageMetadata, LPProductMetadata, LPSourceApplicationMetadata, LPSpecializationMetadata, LPVideo, LPVideoMetadata, NSArray, NSItemProvider, NSMutableArray, NSObject, NSString, NSURL, SYContentItem, TUConversationActivity, UIColor, _SWCollaborationMetadata;
...
+ (id);
+ (id)Style;
+ (_Bool)lowing:,V__disableLinkFollowing /* Error: Ran out of types for this method. */;
- (id);
- (id);
- (void);
- (void);
...
- (id);
- (void);
- (void)IndicatorThinkingDotSpace;
- (void);
- (void)N_FAILURE;
- (void)ed;
- (id)0CKSuggestedReplyView;
- (id);
- (void);
- (id);
- (void);
...
- (void);
- (unsigned long long);
- (id)TemporaryDirectory: /* Error: Ran out of types for this method. */;
- (id);
- (id);
- (_Bool);
- (void);
...
- (id);
- (id);
- (id)iderShort: /* Error: Ran out of types for this method. */;
- (id)ryCaptionButton;
