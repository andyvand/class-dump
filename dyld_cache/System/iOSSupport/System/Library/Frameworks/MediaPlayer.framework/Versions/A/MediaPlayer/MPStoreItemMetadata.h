...
+ (id);
+ (id)shortVersionString:(id)arg1 exactBundleVersion: /* Error: Ran out of types for this method. */;
+ (_Bool)cessory=nil];
- (id);
- (id);
- (id);
...
- (id);
- (id);
- (id)otes: /* Error: Ran out of types for this method. */;
- (long long)MappingCallback: /* Error: Ran out of types for this method. */;
- (_Bool)Primary: /* Error: Ran out of types for this method. */;
- (id)ntId: /* Error: Ran out of types for this method. */;
- (id)stPartyDonation: /* Error: Ran out of types for this method. */;
- (id)pprovalTime: /* Error: Ran out of types for this method. */;
- (long long)etHandleType: /* Error: Ran out of types for this method. */;
- (id)ntProcessValidator: /* Error: Ran out of types for this method. */;
- (_Bool);
- (id);
- (id)key sequence;
- (_Bool);
...
- (id);
- (void);
- (long long)ceroy(NSString *, BOOL, BOOL, FTAWDConferenceEndedReason, FTAWDConferenceError, FTAWDConferenceViceroyError, FTAWDConferenceGameKitError, FTAWDConferenceMessageDeliveryError, FTAWDConferenceMiscError, FTAWDConferenceRegistrationError, FTAWDConferenceRelayError, FTAWDConferenceInvitationServiceError, NSNumber *, NSNumber *, NSNumber *, NSNumber *, NSNumber *, BOOL, BOOL, BOOL, FTAWDNetworkCheckResult, NSNumber *, NSNumber *, NSNumber *, NSNumber *, NSNumber *, FTAWDNetworkConnectionType, FTAWDNetworkConnectionType, FTAWDConnectionType, BOOL, NSNumber *, NSNumber *, NSNumber *, BOOL, BOOL, BOOL, NSNumber *, NSNumber *, BOOL);
- (id)H(;
- (long long);
- (id)ng dispatch_queue_t, __strong IMSPIMessageQueryCallback);
- (id);
- (unsigned long long);
- (id)U;
- (_Bool);
...
- (_Bool);
- (long long);
- (double)oveObserver:name:object: /* Error: Ran out of types for this method. */;
- (_Bool),V_videoURLCache;
- (_Bool)pirationDate;
- (id)ublic}@ Completion handler for catalog id %{public}@ found in map;
- (_Bool)n state:%@ /* Error: Ran out of types for this method. */;
- (long long)_PLAYLIST_NAME;
- (id)dToPlaylistBehaviorDidChangeNotification;
- (id);
- (id)ÖÃ
;
- (id)eoØ
