...
- (struct os_unfair_lock_s)owPlayingInfoCenter:remoteArtworkForContentItem:format:size:completion: /* Error: Ran out of types for this method. */;
- (void)edPerson;
- (void)ers;
- (void)ies;
- (id)yResponseDidInvalidateNotification: /* Error: Ran out of types for this method. */;
