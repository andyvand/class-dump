...
@interface WKWebView
{
    ...
    struct unique_ptr<WebKit::PointerTouchCompatibilitySimulator, std::default_delete<WebKit::PointerTouchCompatibilitySimulator>> _pointerTouchCompatibilitySimulator;
