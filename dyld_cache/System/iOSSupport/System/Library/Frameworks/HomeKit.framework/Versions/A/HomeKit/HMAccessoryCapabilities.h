...
- (_Bool);
- (_Bool)tings"24;
- (_Bool)mplete:completion: /* Error: Ran out of types for this method. */;
- (_Bool)abled:allowHeySiri:airPlayEnabled:playbackInfluencesForYouEnabled:shareSiriAnalyticsEnabled:explicitContentAllowed: /* Error: Ran out of types for this method. */;
- (_Bool)eManager;
- (_Bool)nerIDs;
- (_Bool);
- (id)Identifier:%@ where current user has uuid %@ and uniqueIdentifier %@ /* Error: Ran out of types for this method. */;
