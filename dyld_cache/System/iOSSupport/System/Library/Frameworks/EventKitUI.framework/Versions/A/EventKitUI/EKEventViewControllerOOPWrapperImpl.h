...
@class EKEvent, EKEventStore, EKUIEventStatusButtonsView, EKUIRecurrenceAlertController, NSDictionary, NSString, SingleToolbarItemContainerView, UIScrollView, UIViewController, _TtC10EventKitUI28EKEventViewControllerOOPImpl;
...
@property(retain, nonatomic) _TtC10EventKitUI28EKEventViewControllerOOPImpl *vc; // @synthesize vc=_vc;
