...
@class NSDictionary, NSString, NSURL, WBSReaderConfigurationManager, WBSReaderFontManager;
...
- (_Bool)ec3(tmp), vec3(not(tmp)), vec3(equal(b,vec3(0.))) );
...
- (long long);
- (void)8";
- (void)origin FROM history_visits WHERE history_item IN (%@) AND origin = ? LIMIT 1;
- (WBSReaderConfigurationManager *)ovider: /* Error: Ran out of types for this method. */;
