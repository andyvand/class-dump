...
+ (id);
+ (_Bool);
+ (_Bool)yerRequestError;
- (_Bool);
- (id);
- (id);
- (id);
- (void){ accountMediaTypes:(_Bool)arg1 %@, oldAccount:%@, newAccount:%@, changeType:%@, didSignIn:%@, isInGoodStateForRepair:%@, didSignOut:%@ } /* Error: Ran out of types for this method. */;
- (void)ionPlugin  PROJECT:(id)arg1 IDSAccountNotificationsPlugin-
;
- (void);
- (void);
- (void);
...
- (id);
- (id);
- (id)ID"16@?<v@?@"NSData">24;
- (id)ateResult">24;
- (_Bool);
- (id)erateObjectsUsingBlock:(id)arg1;
- (void)henticated;
- (void);
- (void);
- (id);
