...
+ (_Bool)xisting account. accountToDelete = %{public}@ | error = %{public}@;
- (void);
- (id);
- (void);
- (void);
...
- (id);
- (void);
- (id):8@"ACAccount"16@"ACDAccountStore"24@?<v@?@"ACAccount"@"NSError">32 /* Error: Ran out of types for this method. */;
- (id)?@"ACAccount"@"NSError">32;
- (void)aida_alternateDSID;
- (void)store:(id)arg1 options:(id)arg2;
- (id);
- (id);
- (_Bool);
- (_Bool);
...
- (id)iceDescription;
- (id)on;
- (id)tingWithState:(id)arg1 objects:(_Bool)arg2 count: /* Error: Ran out of types for this method. */;
- (void)iption;
- (void);
- (void)B;
- (void);
...
- (void)R{;
- (id);
- (void)Frameworks/SPOwner.framework/Versions/A/SPOwner;
- (id)rary/PrivateFrameworks/AppleAccount.framework/Versions/A/AppleAccount;
- (void);
- (void)A;
- (id);
- (void);
...
- (id);
- (_Bool);
- (id)ifiedPlaybackRequestEnvironmentWithReasons - Account Manager accounts:%@ /* Error: Ran out of types for this method. */;
