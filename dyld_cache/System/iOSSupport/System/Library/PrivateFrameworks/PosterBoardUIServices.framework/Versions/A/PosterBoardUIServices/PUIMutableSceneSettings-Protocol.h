...
@protocol PUIMutableSceneSettings

// Remaining properties
@property(nonatomic, getter=pui_isAdaptiveTimeDisabled, setter=pui_setAdaptiveTimeDisabled:) _Bool pui_adaptiveTimeDisabled;
@property(nonatomic, getter=pui_isComplicationRowAtBottom, setter=pui_setComplicationRowAtBottom:) _Bool pui_complicationRowAtBottom;
...
@property(retain, nonatomic, setter=pui_setContentOcclusionRectangles:) PUIPosterContentOcclusionRectSet *pui_contentOcclusionRectangles;
@property(nonatomic, setter=pui_setDeviceOrientation:) long long pui_deviceOrientation;
@property(nonatomic, getter=pui_isEditorPreview, setter=pui_setEditorPreview:) _Bool pui_editorPreview;
...
@property(nonatomic, getter=pui_isIdle, setter=pui_setIdle:) _Bool pui_idle;
...
@property(nonatomic, setter=pui_setSalientContentRectangle:) struct CGRect pui_salientContentRectangle;
@property(retain, nonatomic, setter=pui_setSceneAttachments:) NSArray *pui_sceneAttachments;
@property(nonatomic, getter=pui_isShowingIdealizedTime, setter=pui_setShowingIdealizedTime:) _Bool pui_showingIdealizedTime;
