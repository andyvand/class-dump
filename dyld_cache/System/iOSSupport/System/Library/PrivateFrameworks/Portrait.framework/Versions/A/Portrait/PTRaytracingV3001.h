...
@class MISSING_TYPE, NSDictionary, NSString, PTColorConversion, PTGlobalReduction, PTGuidedFilter, PTMetalContext, PTPyramid, PTQualitySettings, PTRaytracingInterpolateResult, PTRaytracingUtils, PTRenderDebugLayer;
...
- (id);
- (void);
- (int)Rkÿ{RkÿRkÿRkÿRkÿRkÿ¥Rkÿ­RkÿµRkÿ½RkÿÅRkÿÎRkÿÖRkÿÞRkÿæRkÿïSkÿ÷SkÿÿSkÿ;
