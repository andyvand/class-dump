...
- (_Bool);
- (_Bool);
- (unsigned long long)etadataLoadedFromURLs: /* Error: Ran out of types for this method. */;
- (void)thString:(unsigned long long)arg1 relativeToURL: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void);
- (id);
