...
@class CKBusinessInfoView, CKComposeNavbarManager, CKComposeRecipientSelectionController, CKComposeTransitionCoordinator, CKComposition, CKTranscriptMultilineLabelCell, IMHandle, NSArray, NSDictionary, NSObject, NSString, UIBarButtonItem, UINavigationController, UIView;
...
- (void)h;
- (id);
- (id)or deletion before we could attempt to update its thumbnail. Bailing out.;
- (id)nail;
- (id)ly updated recent System Paper thumbnail;
- (void)aper thumbnail because the most recent note doesn't have one;
- (void)re expiry;
- (_Bool)w thumbnail cleared;
- (double)lock…;
- (void)senting locked notes welcome migration prompt…;
- (id)e password mode…;
- (_Bool)t ID string for CID URL %@;
- (struct UIEdgeInsets)tachment:(id)arg1 %@;
- (void)e for attachment %@;
- (id)generate System Paper image for attachment %@;
- (void)Outline Controller with missing text storage;
- (void)pple.notes.outlinecontroller.atomic.index;
- (void)xtView;
- (struct UIEdgeInsets)a password for your locked notes—just use your login password or Touch ID.;
- (void)ord?;
- (_Bool)ghts;
- (_Bool)onController saveShare:forObject:accountID:container:qualityOfService:retryPrepHandler:completionHandler:] /* Error: Ran out of types for this method. */;
- (_Bool)ring"8s16;
- (_Bool)note.;
- (void)roncade/SharedUI/Views/ICLoadingPieLayer.m;
- (id)rect;
- (id)];
- (_Bool)== selections.count;
- (_Bool)-savedSelectionWithSelectionAffinity: /* Error: Ran out of types for this method. */;
- (id)ock_invoke;
- (_Bool);
- (_Bool);
- (_Bool);
...
- (void)_blurEffect;
- (void)µúÿ;
- (id)yNå<G_7¨¬Qo_G>)¬G8¬yª¬SgGGSg_AXtGG§¬G_AHSgQo__SSQo__Qo__X«¬y_i¦¬yytAKyÎ¨¬GGQo_Qo_;
- (void)yÂ´®GGAHySiSgGGAHy?®GG°ª®GtGGW®G_ADyº®_ABydµ®yAByABy`¹®AHy(®SgGGAHy´®SgGG_Qo_AHy¹®GGtGSgtGGö®GAByACyADyAF_ASA11_tGGA14_GG;
- (id)ay"16;
- (_Bool)l.slash;
- (void)Hÿ6U4è/;
- (id);
