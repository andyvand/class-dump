...
- (id);
- (id)mô;
- (id)ocation:inTextStorage:forNewTypingAttributes: /* Error: Ran out of types for this method. */;
- (id)lers;
- (id)bjects;
- (id)SyncingObjectActivityEvents;
- (id);
- (id)ogglePlayPause: /* Error: Ran out of types for this method. */;
- (id)oteSkipForward: /* Error: Ran out of types for this method. */;
- (id)otePause: /* Error: Ran out of types for this method. */;
- (id)oxy;
- (id)hAccount: /* Error: Ran out of types for this method. */;
- (id)tedKeyForAccount: /* Error: Ran out of types for this method. */;
- (id);
- (id)Reason: /* Error: Ran out of types for this method. */;
- (id)IndexPaths: /* Error: Ran out of types for this method. */;
- (_Bool)iew: /* Error: Ran out of types for this method. */;
- (_Bool)ote:fromNote:parentAttachment: /* Error: Ran out of types for this method. */;
- (id)ow;
- (id)ObjectContext: /* Error: Ran out of types for this method. */;
- (id);
- (id)dernNotes;
- (void)Handler:(long long)arg1;
- (id)tachment:(BOOL)arg1;
- (id)xSizeAllowed:(BOOL)arg1;
- (id)associatedObjectIdentifiers;
- (id)bleItemAttributeSet:(BOOL)arg1;
- (id)ndoWithBlock: /* Error: Ran out of types for this method. */;
- (id)icipants:range:textView:mentionString: /* Error: Ran out of types for this method. */;
- (id)litySelectionChangedByMerge;
- (id)omponent;
- (id)lowsUnmanagedToManagedMove;
- (id)SearchIndexablesForChangedKeys: /* Error: Ran out of types for this method. */;
- (id)ctionFromPasteboard: /* Error: Ran out of types for this method. */;
- (long long)User:completionHandler: /* Error: Ran out of types for this method. */;
- (id)lock;
- (id)e;
- (id)_privateModernNoteWithAttachmentsInSource;
- (id)Queue;
- (id)reviewGenerationState;
- (id)ntrollerForWebView: /* Error: Ran out of types for this method. */;
- (id)eThumbnail;
- (id)repareForImmediateActionAnimationForWebView: /* Error: Ran out of types for this method. */;
- (id)edViewSize;
- (id)ng;
- (id)meObserver;
- (id)ded: /* Error: Ran out of types for this method. */;
- (id)ttachment:atCharacterIndex:createIfNeeded: /* Error: Ran out of types for this method. */;
- (id)ayer;
- (id)gSeekTime;
- (id)geForScrollingCounter;
- (id)dTextField;
- (id)wordLabel;
...
- (id)eAttachmentIsSet;
- (id)ally;
- (id)ngeSelectorDelayer;
- (id)get;
- (id)ier;
- (id)bject;
- (id)ginalImage;
- (id)ntedImageTransform;
- (id)oms;
- (id)Label;
- (id)correctTextViewHeightConstraint;
- (id)wordContainer;
- (id)uttons;
- (id)ypes;
- (id)bleDeviceInfo;
- (id)tesInSource;
- (double)HighlightedClickableAttributedString;
- (id)troller;
- (id)MovingBetweenManagedAndUnmanagedAccounts;
- (id)FactorIndex;
- (id)t;
- (id)_legacyManagedObjectContext;
- (id)didAuthenticateWithBiometrics;
- (id)ales;
- (id)ges;
- (id)Save;
- (id)elayedFixupAfterEditingWantsUndoCommand;
- (id)ultTitle;
- (id)mageSize;
- (id);
- (id)ntextForWebView: /* Error: Ran out of types for this method. */;
- (id)rea;
- (id)er;
- (id)ect;
- (id)nController;
- (id)tons;
- (id)StoragePolicy: /* Error: Ran out of types for this method. */;
- (id)defaultImageSize;
- (id)ntContentSize;
- (id),N;
- (id)olor;
...
- (id)es;
- (id)B,N,V_isVisible;
- (id)orationActionSecondCancelForObject:share:isInviting: /* Error: Ran out of types for this method. */;
- (id)pLeft;
- (id)gglePlayPause;
- (id)ueue: /* Error: Ran out of types for this method. */;
- (id)STouchBar",&,N,V_groupTouchBar;
- (id)orNoteObjectIDs:dates:referenceDate:direction: /* Error: Ran out of types for this method. */;
- (id)STextView",W,N,V_textView;
- (id)tedAtColumnID:rowID:edited:range:changeInLength: /* Error: Ran out of types for this method. */;
- (id)ew",V_oldPasswordIncorrectTextView;
- (id)temBlueColor;
- (id)",W,N,V_titleLabel;
- (id)asswordHintWarningLabel;
- (id)Label;
- (id)sion: /* Error: Ran out of types for this method. */;
- (id)",W,N,V_oldPasswordIncorrectTextViewScrollView;
- (id)x;
- (id)gularExpression",&,N,V_normalRegex;
- (id)SystemPaperNotesInSource: /* Error: Ran out of types for this method. */;
- (id)tualSmartFolderIdentifiers;
- (id)ctionary",&,N,V_folderListSectionIdentifiersToVirtualSmartFolderIdentifiers;
- (id)tifiersToButtonIdentifiers;
- (id);
- (id),N,V_folderItemIdentifiersToChildFolderItemIdentifiers;
- (id)rdID;
- (id)erver: /* Error: Ran out of types for this method. */;
- (id)ary",&,N,V_buttonIdentifiersToTouchBarItems;
- (id)egenerateTitle;
- (id)eArray",R,N,V_deletedRanges;
- (id)y",&,N,V_undoCommands;
- (id)erNotesInSource;
- (id)ehavior;
- (id)",&,N,V_image;
- (id)hedResultsController;
- (id)hFrame:siriSnippetWidth: /* Error: Ran out of types for this method. */;
- (long long)N,V_queue;
- (long long)ributedString;
- (id)hing>",R,N,V_cache;
- (id)houldIncludeSystemPaper;
- (id)T@"<ICTableUndoHelping>",R,N;
- (id)rageStyler>",&,N,V_styler;
- (id)N,V_sectionIdentifier;
- (id)IncludeTagOperator;
- (id)hIndexable>",R,N,V_object;
- (id)egate;
- (id)ectContextChangeControllerDelegate>",W,N,V_delegate;
- (id)wDelegate>",W,N,V_clickDelegate;
- (id)r>",R,N,V_folder;
- (id)onFolder;
- (id),R,N;
- (id)cyContext>",&,N,V_legacyContext;
- (id)entifier;
- (id)y;
- (id)onDelegate>",W,N,V_delegate;
- (id)textField;
- (id)archResults;
- (id)ew;
- (id)ueue;
- (id)ThumbnailOperation;
- (id)PasswordChangeSheetViewController;
- (id)hmentFindable;
- (id)trings;
- (id)ifiedNoteContext;
- (id)apsibleImageView;
...
- (id)UIModel;
- (id)round;
- (id)CSystemPaperTextAttachmentNotesEditorBridgeWorkaround;
- (id)xtAttachment;
- (id)onverter;
- (id)ew;
- (id)melineController;
...
- (id);
- (id);
- (id)utedStringC5valuetSg;
- (id)CTTTextEditCG5valuetSg;
- (id);
- (id)0;
- (id)ManagedObjectIDCa&@G;
- (id);
- (id)@G;
- (id);
- (id)SgXw;
- (id);
- (id);
- (id)lculateDocumentControllerCSgXwz_Xx;
- (id)eAttributedStringC;
- (id);
- (id);
- (id)y_AGGAGG;
- (id);
...
- (id);
- (id);
- (id)yADyAN_AOyADyAQ_ARA3_tGGtGGAKtGGA6_G_G;
- (id);
- (id);
- (id);
- (id);
...
- (id);
- (id);
- (id)iftUI13PreferenceKeyP;
- (id)GALG_Qo_tGG;
- (long long);
- (id);
- (id)archIndexerCSgXw;
- (id)NSManagedObjectIDCG;
- (id)teCG;
- (id);
- (id);
- (id);
...
- (id);
- (id)%d;
- (id)ShareIfNeededWithOwnedObjectID ::Deleting share for objectID %@ failed with error %@ /* Error: Ran out of types for this method. */;
- (id)are %@;
- (id)dOrJoinedNotesWithGuiltyObjects:CompletionHandler: /* Error: Ran out of types for this method. */;
- (id){note:%@, attachment:%@} /* Error: Ran out of types for this method. */;
- (id)fication for attachment because it is either cancelled or not needed:%@ /* Error: Ran out of types for this method. */;
- (id)classifcation %d;
- (id)er;
- (id);
- (id)magenta pink;
- (long long):]_block_invoke /* Error: Ran out of types for this method. */;
- (id)pdf;
- (id)eople who currently have access to these notes may lose it.;
- (id)it them.;
- (long long)ItemTypeSectionIdentifier;
- (long long)xpansionStateItemTypeObjectID;
- (id);
- (long long);
- (id);
- (id);
