...
- (id);
- (void)d;
- (id)entInitialPreviewDidLoadNotification;
- (id)olderListSectionTypeCloudKitPrimary;
- (id)erListSectionTypeSystemPaper;
- (id)olderListSectionTypeSystem;
- (id)e `initWithObject:` for %@ /* Error: Ran out of types for this method. */;
- (_Bool)ipad/get-started-with-notes-ipadfeea407c/ipados;
- (void);
- (_Bool);
- (id);
- (void);
