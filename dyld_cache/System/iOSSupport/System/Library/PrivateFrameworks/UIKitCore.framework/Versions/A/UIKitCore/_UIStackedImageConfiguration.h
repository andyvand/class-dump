...
@property(nonatomic) struct CACornerRadii cornerRadii; // @synthesize cornerRadii=_cornerRadii;
...
@property(nonatomic) double expansionAmount; // @synthesize expansionAmount=_expansionAmount;
