...
- (id);
- (void);
- (long long)rocessingDoneAndFinalImageDisplayedChanged: /* Error: Ran out of types for this method. */;
- (_Bool)temAtIndexPath;
- (void)lbumsPickerViewControllerWithConfiguration:sessionInfo:collectionList:selectionCoordinator: /* Error: Ran out of types for this method. */;
- (_Bool);
