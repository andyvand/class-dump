...
@class AVTClippableImageStore, AVTSerialTaskScheduler, AVTStickerConfigurationProvider, AVTStickerGenerator, AVTStickerRecentsLayout, AVTStickerRecentsMigrator, AVTUIEnvironment, AVTUIStickerGeneratorPool, NSArray, NSObject, NSString;
@protocol AVTAvatarRecord, AVTAvatarStoreInternal, AVTResourceCache, AVTStickerRecentsSwiftProviderDelegate, NSObject, OS_dispatch_queue;
