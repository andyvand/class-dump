...
- (id);
- (void)rs:(id)arg1;
- (struct CGRect)willDecelerate:(id)arg1;
- (void)hNameComponents:address:addressType: /* Error: Ran out of types for this method. */;
- (id)andSelectedSearchResultForComposeRecipientView:(struct CGPoint)arg1;
- (id)tactPicker;
- (void)EndContextMenuInteractionWithConfiguration:animator: /* Error: Ran out of types for this method. */;
- (id)entAddresses;
- (id)ts;
- (_Bool)îê;
