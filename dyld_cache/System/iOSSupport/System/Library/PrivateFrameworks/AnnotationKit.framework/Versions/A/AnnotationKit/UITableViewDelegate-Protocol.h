...
@optional
- (_Bool);
- (NSIndexPath *)al.xyz * displacement.y + bitangent.xyz * displacement.z;
                                           ...
                                           )
{
    ...
    _geometry.position = float4(scn:(UITableView *)arg1:(NSIndexPath *)arg2 barycentric_mix(in.controlPoints[0].position, in.controlPoints[1].position, in.controlPoints[2].position, patchCoord), 1.f);
#if defined(USE_NORMAL) && defined(HAS_NORMAL)
