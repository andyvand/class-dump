...
- (id);
- (void)ttomConstraint;
- (id)upportsAppleFamily;
- (id);
- (id);
- (long long)dStayOpenWhenCommitIsCanceled;
- (void)ewControllerManagerImpl;
- (id);
- (void);
- (void);
- (void);
...
inline float4 colorFromMask(float4 col, int mask)
{
    switch (mask) {
        ...
        case kC3DColorMaskRed|kC3DColorMaskGreen:(id)arg2 return float4(col.rg, 0.f, 1.f);
