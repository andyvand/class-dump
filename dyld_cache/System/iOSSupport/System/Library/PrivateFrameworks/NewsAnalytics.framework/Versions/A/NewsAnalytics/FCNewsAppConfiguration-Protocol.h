...
- (NSArray *)oHistoryFeedConfigurationResourceId;
- (long long);
- (long long)p;
- (NTPBDiscoverMoreVideosInfo *)geColMajorSet:leftToRight: /* Error: Ran out of types for this method. */;
- (long long)ps should never get a bitmap allocated;
- (_Bool)tic CGFloat TSWPLineFragment::baselineAdjustAtCharIndex(TSWPCharIndex, TSWPStorage *, TSWPColumn *, bool, NSUInteger) /* Error: Ran out of types for this method. */;
- (NSString *)'t have read while waiting on write;
- (FCIAdConfiguration *);
- (_Bool)?;
- (double);
...
- (double)\;
- (double)v;
- (FCOfflineDownloadsConfiguration *)_;
- (long long)@;
- (NSString *)(
;
- (double)nitWithLongLong: /* Error: Ran out of types for this method. */;
- (NSArray *)didTapView: /* Error: Ran out of types for this method. */;
- (NSString *)tVersion;
- (NSString *)perErrorMessage;
- (double)u;
- (NSDictionary *);
- (_Bool)P;
- (_Bool);
- (_Bool)d;
- (NSString *)Got back %{public}@ headlines from reading history before earliest session date %{public}@;
- (_Bool)n article seen embeddings minimum of ;
- (_Bool)rites configuration requires minExternalRecommendations be >= 0, was supplied %{public}@, falling back to default %lu;
- (NSDictionary *);
- (unsigned long long)#;
- (_Bool)p"16;
- (_Bool)caseLetterCharacterSet;
- (NSString *)ace: /* Error: Ran out of types for this method. */;
- (NSString *)wRect: /* Error: Ran out of types for this method. */;
- (long long)ets;
- (long long)geBroadcaster.mm;
- (long long)DStyledInfo styleClass];
- (NSString *)tShowErrorBarScatterXProperty;
- (NSDictionary *)l;
- (_Bool)nternal/Library/BuildRoots/4~CG47ugDCQf_fC3_YETQ_yy4HAgij0NOJE2d8MJw/Library/Caches/com.apple.xbs/Sources/AlderShared/persistence/src/TSPLazyReference.mm;
- (_Bool)";
- (double);
- (NSString *) `�G;
- (_Bool));
- (long long)¤;
- (NSString *)´vÏÿ÷ØvÏÿ;
- (id <FCNewsAppConfigurationInternal>)Ñÿ;
