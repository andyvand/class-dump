...
@class IMAccount, IMHandle, IMInlineReplyController, IMMergedDomainIdentifiers, IMMomentShareCache, IMMomentSharePresentationCache, IMOrderingTools, IMParticipantChangeChatItem, IMReasonTrackingUpdater, IMScheduledUpdater, IMSendProgress, IMTimingCollection, NSArray, NSData, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSNumber, NSSet, NSString;
...
@interface IMChat : IMItemsController
{
    ...
    _Bool _forceMMS;
    _Bool _isSubscriptionSwitchParticipantAddTypeFound;
