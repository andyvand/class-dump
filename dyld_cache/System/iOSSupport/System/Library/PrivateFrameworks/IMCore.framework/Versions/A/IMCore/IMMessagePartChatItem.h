...
+ (_Bool);
+ (id);
+ (id)DragDocumentWithEvent:from:withPasteboard: /* Error: Ran out of types for this method. */;
+ (id)w;
+ (long long)tInputParameters: /* Error: Ran out of types for this method. */;
+ (id)ale:(id)arg1;
+ (id):(id)arg1;
+ (id)ow:(id)arg1;
+ (id)d;
...
- (id);
- (_Bool);
- (_Bool)"NSMutableDictionary",&,N,V_fetchHighQualityVariantCompletionHandlers;
- (unsigned char)ID:%@; bundleID:%@; Payload length:%lu; Num. attachments:%tu] /* Error: Ran out of types for this method. */;
