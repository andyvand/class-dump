...
- (NSArray *)R;
- (id <MTLArgumentEncoder>)imd_float4x4 lightProjFromCrWorldMatrix;
...
typedef re:(unsigned long long)arg1:(id *)arg2 LightSpot LightSpot;
...
- (void)ON_PROBE_RADIANCE_PASS;
- (unsigned long long)?,ÃAå~Ï¾@ÒJ?PE;
