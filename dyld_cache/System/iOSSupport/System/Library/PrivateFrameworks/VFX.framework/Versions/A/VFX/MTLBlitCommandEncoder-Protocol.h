...
- (void)àøîÿðwÿK;
- (void)excoord3FunctionConstantIndex    11
                                           ...
                                           )
{
    ...
    _geometry.position = float4(vfx:(id <MTLIndirectCommandBuffer>)arg1:(struct _NSRange)arg2 barycentric_mix(in.controlPoints[0].position, in.controlPoints[1].position, in.controlPoints[2].position, patchCoord), 1.f);
#if defined(USE_NORMAL) && defined(HAS_NORMAL)
