...
- (float);
- (void);
- (double)oNode",R,N,V_audioNode;
- (void)&           u_re_globalConstants
                                      ...
                                      , constant VirtualEnvironmentProbeLighting:(double)arg1:TextureArgumentBuffer& u_re_vfx_virtualEnvProbeTextures
#endif
#endif
