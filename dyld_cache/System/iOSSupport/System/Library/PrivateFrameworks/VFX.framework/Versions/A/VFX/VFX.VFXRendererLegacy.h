...
- (void);
- (void);
- (id)V´VàVxX¼X,YXYYZZ;
- (void);
- (id);
- (id)[[ function_constant(particle_constants_has_angle) ]];
...
struct particle_counters {
    ...
    int32_t get_spawn_id_if_present(uint index, int32_t dispatch_spawn_id) device {
        ...
        if (!has_spawn_id) {
            ...
            sid = dispatch_spawn_id != -1 ? dispatch_spawn_id :(id)arg1 get_spawn_id(index);
        }
...
- (id)FXWorldDidUpdateNotification;
