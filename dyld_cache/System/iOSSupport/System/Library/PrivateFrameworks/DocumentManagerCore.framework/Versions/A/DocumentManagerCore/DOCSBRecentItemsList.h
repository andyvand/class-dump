...
@class FPQueryCollection, MISSING_TYPE, NSTimer;

@interface DOCSBRecentItemsList
{
    _Bool _isObserving;
    MISSING_TYPE *$__lazy_storage_$__recentsQueryCollection;
...
- (void);
- (void);
- (void)w(scn_shadow_sampler, pos, light.shadowMatrix, light.parameters.directional.cascadeScale, light.parameters.directional.cascadeBias, cascadeCount, shadowMaps, blendCascade, shadowKernel, sampleCount, light.shadowRadius).a;
