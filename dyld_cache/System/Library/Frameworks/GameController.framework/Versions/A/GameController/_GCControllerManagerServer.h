...
@class GCHIDEventSystemClient, GCSSettingsStore, GCXPCEventPublisher, NSArray, NSFileHandle, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject, NSSet, NSString, NSURL;
