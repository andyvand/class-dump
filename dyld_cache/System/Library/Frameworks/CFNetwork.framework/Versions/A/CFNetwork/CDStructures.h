...
struct HTTPConnectionCacheLimits {
    ...
    double fHTTPConnectionCachePurgeTimeout;
    double fHTTPConnectionCacheCellPurgeTimeout;
    double fLongLivedConnectionCachePurgeTimeout;
    double fLongLivedConnectionCacheCellPurgeTimeout;
};
...
struct URLRequest {
    ...
    struct __CFString *fCookiePartitionIdentifier;
    ...
    unsigned char fPrivacyProxyStrictFailClosed;
    ...
    unsigned char fAllowOnlyPartitionedCookies;
    unsigned char fUnsafeAllowedInEarlyData;
    unsigned char fRequiresDNSSECValidation;
    unsigned char fAllowsPersistentDNS;
    ...
    unsigned char fAllowsExpensiveNetworkAccess;
    unsigned char fAllowsConstrainedNetworkAccess;
    unsigned char fAllowsUltraConstrainedNetworkAccess;
...
struct map<std::string, std::set<std::shared_ptr<__CoalescingConnectionKey>, CoalescingConnectionKeyComparator>, std::less<std::string>, std::allocator<std::pair<const std::string, std::set<std::shared_ptr<__CoalescingConnectionKey>, CoalescingConnectionKeyComparator>>>> {
    struct __tree<std::__value_type<std::string, std::set<std::shared_ptr<__CoalescingConnectionKey>, CoalescingConnectionKeyComparator>>, std::__map_value_compare<std::string, std::pair<const std::string, std::set<std::shared_ptr<__CoalescingConnectionKey>, CoalescingConnectionKeyComparator>>, std::less<std::string>>, std::allocator<std::pair<const std::string, std::set<std::shared_ptr<__CoalescingConnectionKey>, CoalescingConnectionKeyComparator>>>> {
        void *__begin_node_;
        CDStruct_09bd28e6 ;
        CDStruct_a7186859 ;
    } __tree_;
...
struct map<std::string, std::shared_ptr<__CoalescingConnectionKey>, std::less<std::string>, std::allocator<std::pair<const std::string, std::shared_ptr<__CoalescingConnectionKey>>>> {
    struct __tree<std::__value_type<std::string, std::shared_ptr<__CoalescingConnectionKey>>, std::__map_value_compare<std::string, std::pair<const std::string, std::shared_ptr<__CoalescingConnectionKey>>, std::less<std::string>>, std::allocator<std::pair<const std::string, std::shared_ptr<__CoalescingConnectionKey>>>> {
        void *__begin_node_;
        CDStruct_09bd28e6 ;
        CDStruct_a7186859 ;
    } __tree_;
