...
@class LPPadding, LPPointUnit, LPShadowStyle, LPSize, NSColor, NSFont, NSNumber, NSString;
...
@interface LPImageViewStyle
{
    ...
    NSFont *_fixedFallbackImageFont;
...
@property(retain, nonatomic) NSFont *fixedFallbackImageFont; // @synthesize fixedFallbackImageFont=_fixedFallbackImageFont;
