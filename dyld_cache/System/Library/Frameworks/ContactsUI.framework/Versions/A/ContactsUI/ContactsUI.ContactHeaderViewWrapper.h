...
@protocol _TtP10ContactsUI32ContactHeaderViewWrapperDelegate_;
...
@property(nonatomic) __weak id <_TtP10ContactsUI32ContactHeaderViewWrapperDelegate_> delegate; // @synthesize delegate;
