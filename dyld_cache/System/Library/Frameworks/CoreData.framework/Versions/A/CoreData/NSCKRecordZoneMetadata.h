...
@class CKServerChangeToken, NSCKDatabaseMetadata, NSCKRecordZoneMetadataEncodedShareAsset, NSDate, NSNumber, NSSet, NSString;
...
@property(retain, nonatomic) NSCKRecordZoneMetadataEncodedShareAsset *encodedShareAsset; // @dynamic encodedShareAsset;
