...
@class MISSING_TYPE, NSMapTable, NSMutableSet, SCNMTLRenderPipeline;
...
struct Info {
    ...
    id clusterTexture;
    id lightIndicesBuffer;
    unsigned int lightIndicesBufferOffset;
    unsigned int lightIndicesBufferSize;
