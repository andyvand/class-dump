...
@class AVAudioEngine, AVAudioEnvironmentNode, MISSING_TYPE, MTLRenderPassDescriptor, NSArray, NSColor, NSObject, NSOpenGLContext, NSString, SCNAuthoringEnvironment, SCNMTLRenderContext, SCNNode, SCNRecursiveLock, SCNRendererTransitionContext, SCNScene, SCNTechnique, SKScene, __SKSCNRenderer;
