...
@interface TSDTextureDescription
{
    ...
    _Bool _shouldAddVideoBackgroundFill;
...
@property(nonatomic) _Bool shouldAddVideoBackgroundFill; // @synthesize shouldAddVideoBackgroundFill=_shouldAddVideoBackgroundFill;
