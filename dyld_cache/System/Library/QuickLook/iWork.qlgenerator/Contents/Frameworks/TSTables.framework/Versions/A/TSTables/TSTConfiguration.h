...
@interface TSTConfiguration
{
    ...
    _Bool _supportsCopySnapshot;
    _Bool _allowsBlackDragDropBackground;
    _Bool _supportsAddBodyRowAtBottomSiriKitIntent;
    _Bool _supportsiOSContextMenuItemForWrappedText;
    _Bool _supportsiOSContextMenuItemForEvenlyDistributedRows;
    _Bool _supportsiOSContextMenuItemForEvenlyDistributedColumns;
    _Bool _supportsHDRRendering;
    _Bool _supportsMagicFill;
...
@property(nonatomic) _Bool supportsCopySnapshot; // @synthesize supportsCopySnapshot=_supportsCopySnapshot;
...
@property(nonatomic) _Bool supportsHDRRendering; // @synthesize supportsHDRRendering=_supportsHDRRendering;
...
@property(nonatomic) _Bool supportsMagicFill; // @synthesize supportsMagicFill=_supportsMagicFill;
...
@property(nonatomic) _Bool supportsiOSContextMenuItemForEvenlyDistributedColumns; // @synthesize supportsiOSContextMenuItemForEvenlyDistributedColumns=_supportsiOSContextMenuItemForEvenlyDistributedColumns;
@property(nonatomic) _Bool supportsiOSContextMenuItemForEvenlyDistributedRows; // @synthesize supportsiOSContextMenuItemForEvenlyDistributedRows=_supportsiOSContextMenuItemForEvenlyDistributedRows;
@property(nonatomic) _Bool supportsiOSContextMenuItemForWrappedText; // @synthesize supportsiOSContextMenuItemForWrappedText=_supportsiOSContextMenuItemForWrappedText;
