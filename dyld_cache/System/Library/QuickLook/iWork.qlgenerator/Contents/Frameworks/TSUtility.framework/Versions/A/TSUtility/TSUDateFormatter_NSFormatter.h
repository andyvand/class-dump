...
- (id);
- (void);
- (id)appendBezierPathWithArcWithEllipseBounds:(id)arg1 startAngle:swingAngle:angleType:startNewPath:] /* Error: Ran out of types for this method. */;
- (void);
- (id)>g¤Úðí´Mñ	k4ûcÏ)#ñ;|´°LçÖ-ôýMm)"a.áËúÝûÄBôkíJáÜ¡L9q}Qá UÈ³jy½ló@¼jÐº©xcÔê³äÏÃfîÒ5]°âKìG0QkÅÄ)ÔV|RAäàÝÃt;
