...
@class BlastDoorBalloonPluginPayloadWrapper, BlastDoorTapBack_MessageSummaryInfo, MISSING_TYPE, NSArray, NSAttributedString, NSString;

@interface BlastDoorCustomAcknowledgement
{
    MISSING_TYPE *customAcknowledgement;
}
