...
+ (id)y:similarityModel: /* Error: Ran out of types for this method. */;
...
@property(copy, nonatomic) NSString *popularityScoresOrderedByAOI; // @dynamic popularityScoresOrderedByAOI;
