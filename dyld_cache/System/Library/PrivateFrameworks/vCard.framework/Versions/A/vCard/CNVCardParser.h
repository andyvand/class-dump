...
@interface CNVCardParser
{
    ...
    _Bool _base64;
    id <_TtP5vCard25CNVCardTagInclusionPolicy_> _tagInclusionPolicy;
}
...
@property(readonly, nonatomic) id <_TtP5vCard25CNVCardTagInclusionPolicy_> tagInclusionPolicy; // @synthesize tagInclusionPolicy=_tagInclusionPolicy;
