...
operator new[](unsigned long);
operator new[](unsigned long, std::nothrow_t const&);
sConvertMetricToJson(std::__1::shared_ptr<AwdMetadataLoader> const&, unsigned char const*, unsigned long);
sConvertMetricToXpc(std::__1::shared_ptr<AwdMetadataLoader> const&, unsigned char const*, unsigned long);
sConvertTriggerToJson(std::__1::shared_ptr<AwdMetadataLoader> const&, unsigned char const*, unsigned long);
sCreateAwdMetadataLoaderForJsonConversion();
...
sDumpDeviceConfiguration(std::__1::shared_ptr<AwdMetadataLoader>, void const*, unsigned long, DumpFormat);
sDumpMetricFile(std::__1::shared_ptr<AwdMetadataLoader>, void const*, unsigned long, DumpFormat);
sDumpMetricLog(std::__1::shared_ptr<AwdMetadataLoader>, void const*, unsigned long, DumpFormat);
sGetMetricName(std::__1::shared_ptr<AwdMetadataLoader> const&, unsigned int);
sResolveMetricNames(std::__1::shared_ptr<AwdMetadataLoader> const&, std::__1::unordered_set<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::hash<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>, std::__1::equal_to<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>, std::__1::allocator<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>> const&);
