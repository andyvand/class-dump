...
@class NSString, _SFAirDropTransferObserver, _TtC7Sharing33_SFAirDropTransferObserverAdaptor;
...
@property(retain, nonatomic) _TtC7Sharing33_SFAirDropTransferObserverAdaptor *modernObserver; // @synthesize modernObserver=_modernObserver;
