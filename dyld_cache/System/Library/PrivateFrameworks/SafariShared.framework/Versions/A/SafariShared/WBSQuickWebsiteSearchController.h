...
@interface WBSQuickWebsiteSearchController
{
    ...
    id <WBSQuickWebsiteSearchControllerDelegate> _delegate;
}
...
@property(nonatomic) __weak id <WBSQuickWebsiteSearchControllerDelegate> delegate; // @synthesize delegate=_delegate;
