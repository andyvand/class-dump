...
@interface WBSTrialSearchParameters
{
    ...
    _Bool _shouldHideIgnoredSiriSuggestedSites;
...
@property(readonly, nonatomic) NSString *codepathIDs; // @synthesize codepathIDs=_codepathIDs;
...
@property(readonly, nonatomic) _Bool shouldHideIgnoredSiriSuggestedSites; // @synthesize shouldHideIgnoredSiriSuggestedSites=_shouldHideIgnoredSiriSuggestedSites;
...
@property(readonly, nonatomic) long long thresholdForHidingIgnoredSiriSuggestedSites; // @synthesize thresholdForHidingIgnoredSiriSuggestedSites=_thresholdForHidingIgnoredSiriSuggestedSites;
