...
@class NSAppearance, NSArray, NSString, StartPageOnboardingCollectionViewItem, _TtC6Safari27SafariOnboardingCoordinator;
...
@interface StartPageOnboardingSectionProvider
{
    ...
    _TtC6Safari27SafariOnboardingCoordinator *_coordinator;
