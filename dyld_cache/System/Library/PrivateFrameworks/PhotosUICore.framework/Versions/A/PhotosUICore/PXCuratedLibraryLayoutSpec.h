...
@class NSColor, NSNumber, PXAssetsSectionLayoutSpec, PXCuratedLibrarySectionHeaderLayoutSpec, PXExtendedImageConfiguration, PXMonthsLayoutMetrics, PXYearsLayoutMetrics;
...
@interface PXCuratedLibraryLayoutSpec
{
    ...
    NSColor *_contentUnavailableBackgroundColor;
    NSColor *_contentBackgroundColor;
    struct NSEdgeInsets _blurredBackgroundEdgeInsets;
}
...
@property(readonly, nonatomic) struct NSEdgeInsets blurredBackgroundEdgeInsets; // @synthesize blurredBackgroundEdgeInsets=_blurredBackgroundEdgeInsets;
@property(readonly, nonatomic) NSColor *contentBackgroundColor; // @synthesize contentBackgroundColor=_contentBackgroundColor;
@property(readonly, nonatomic) NSColor *contentUnavailableBackgroundColor; // @synthesize contentUnavailableBackgroundColor=_contentUnavailableBackgroundColor;
