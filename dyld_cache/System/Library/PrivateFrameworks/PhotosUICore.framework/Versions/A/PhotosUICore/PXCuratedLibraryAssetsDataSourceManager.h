...
@class NSArray, NSDictionary, NSPredicate, NSString, PXAssetsDataSource, PXAssetsDataSourceManager, PXContentSyndicationConfigurationProvider, PXCuratedLibraryAssetsDataSourceManagerConfiguration, PXPhotoKitAssetsDataSourceManager, PXUpdater, PXVisualPositionsChangeDetails;
