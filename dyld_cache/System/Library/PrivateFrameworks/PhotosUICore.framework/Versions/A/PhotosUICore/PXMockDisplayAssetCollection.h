...
@interface PXMockDisplayAssetCollection
{
    ...
    _Bool _isPrivacySensitiveAlbum;
...
- (long long);
- (id);
- (id)KenBurnsAnimationCurrentRect;
- (id)¸ü<tÀì8x´Ø;
- (id)|Ø÷ÿLÏúÿ8û÷ÿ;
...
@property(readonly, nonatomic) _Bool isPrivacySensitiveAlbum; // @synthesize isPrivacySensitiveAlbum=_isPrivacySensitiveAlbum;
...
@property(readonly, nonatomic) NSString *localizedShortDateDescription; // @synthesize localizedShortDateDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,N,VlocalizedShortDateDescription
