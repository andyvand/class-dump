...
@class NSArray, NSMapTable, NSMutableDictionary, NSObject, NSSet, NSString, NSUserDefaults, WBSPasswordAuditor, WBSPasswordBreachHelperProxy, WBSPasswordEvaluator, WBSPasswordManagerWebsiteMetadataStore, WBSPasswordWarningTopFraudTargetsManager, WBSSavedAccountStore, _TtC10SafariCore32WBSPasswordEvaluationsCacheStore;
