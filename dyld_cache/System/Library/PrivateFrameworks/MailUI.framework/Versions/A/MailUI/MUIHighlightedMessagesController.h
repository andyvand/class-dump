...
@class EFDebouncer, EMMessageRepository, MISSING_TYPE, NSArray, NSPredicate;
...
@interface MUIHighlightedMessagesController
{
    ...
    void delegate;
    MISSING_TYPE *$__lazy_storage_$_reloadDebouncer;
    MISSING_TYPE *$__lazy_storage_$_reloadWithEmptyUpdateDebouncer;
    void mailboxes;
