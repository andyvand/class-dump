...
@interface TIWordEntry : TIUserAction
{
    ...
    _Bool _editActionExtendsPriorWord;
    _Bool _isPunctuationEntryFollowingAWord;
    _Bool _originalWordInAlignment;
    int _wordEntryType;
...
@property(nonatomic) _Bool editActionExtendsPriorWord; // @synthesize editActionExtendsPriorWord=_editActionExtendsPriorWord;
@property(nonatomic) int editActionType; // @synthesize editActionType=_editActionType;
...
@property(nonatomic) _Bool originalWordInAlignment; // @synthesize originalWordInAlignment=_originalWordInAlignment;
