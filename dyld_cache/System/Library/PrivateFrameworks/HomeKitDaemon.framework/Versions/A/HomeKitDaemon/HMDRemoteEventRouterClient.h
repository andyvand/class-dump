...
@class HMEMessageDatagramClient, HMFMessageDispatcher, NSNotificationCenter, NSObject, NSString, NSUUID, _TtC13HomeKitDaemon28HMDRemoteConnectivityMonitor;
...
@interface HMDRemoteEventRouterClient
{
    ...
    _TtC13HomeKitDaemon28HMDRemoteConnectivityMonitor *_connectivityMonitor;
...
@property(readonly) _TtC13HomeKitDaemon28HMDRemoteConnectivityMonitor *connectivityMonitor; // @synthesize connectivityMonitor=_connectivityMonitor;
