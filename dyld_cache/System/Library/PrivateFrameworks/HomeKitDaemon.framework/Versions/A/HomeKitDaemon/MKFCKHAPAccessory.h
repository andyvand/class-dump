...
@property(retain, nonatomic) NSArray *adaptiveTemperatureSleepScheduleRules; // @dynamic adaptiveTemperatureSleepScheduleRules;
...
@property(retain, nonatomic) NSSet *localPresenceRooms; // @dynamic localPresenceRooms;
