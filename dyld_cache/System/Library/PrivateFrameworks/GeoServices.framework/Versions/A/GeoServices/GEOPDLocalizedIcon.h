...
@interface GEOPDLocalizedIcon
{
    PBUnknownFields *_unknownFields;
    NSString *_locale;
    unsigned int _accoladeIconId;
    struct {
        unsigned int has_accoladeIconId:1;
    } _flags;
}
