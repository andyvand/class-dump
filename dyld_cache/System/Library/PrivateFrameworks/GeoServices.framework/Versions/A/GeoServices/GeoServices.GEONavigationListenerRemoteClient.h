...
@interface GeoServices.GEONavigationListenerRemoteClient
{
    ...
    MISSING_TYPE *_noCellCoverageAlertPrecedingTime;
    MISSING_TYPE *_wantsRoutes;
    MISSING_TYPE *_details;
    MISSING_TYPE *_connection;
    MISSING_TYPE *_upcomingUnavailableCellCoverageSections;
    MISSING_TYPE *_lastUnavailableCellCoverageUpdateTime;
    MISSING_TYPE *_unavailableCellCoverageUpdateInterval;
}
