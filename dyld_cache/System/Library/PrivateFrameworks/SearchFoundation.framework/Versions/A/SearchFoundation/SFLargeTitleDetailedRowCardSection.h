...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, SFAppEntityAnnotation, SFButtonItem, SFCard, SFColor, SFCommand, SFCopyItem, SFRichText, SFUserReportRequest;

@interface SFLargeTitleDetailedRowCardSection : SFCardSection
{
    NSString *_type;
    SFRichText *_title;
    SFButtonItem *_subtitleButtonItem;
...
@property(retain, nonatomic) SFButtonItem *subtitleButtonItem; // @synthesize subtitleButtonItem=_subtitleButtonItem;
