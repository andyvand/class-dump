...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, NSURL, SFAppEntityAnnotation, SFCard, SFColor, SFCommand, SFCopyItem, SFUserReportRequest;
