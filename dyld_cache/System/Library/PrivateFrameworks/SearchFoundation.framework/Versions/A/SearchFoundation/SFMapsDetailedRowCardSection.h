...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, SFAppEntityAnnotation, SFCard, SFColor, SFCommand, SFCopyItem, SFDetailedRowCardSection, SFUserReportRequest;

@interface SFMapsDetailedRowCardSection : SFCardSection
{
    NSString *_type;
    NSData *_mapsData;
    NSString *_pinText;
    SFDetailedRowCardSection *_internalDetailedRowCardSection;
}
...
@property(retain, nonatomic) SFDetailedRowCardSection *internalDetailedRowCardSection; // @synthesize internalDetailedRowCardSection=_internalDetailedRowCardSection;
