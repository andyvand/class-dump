...
@class CALayer, ECAXObserverStoreWrapper, ECSBSpringboard, ECShadowTextLayer, ECTextLayer, LPAppManager, LPGroup, LPLayout, LPRoot, NSArray, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WALayerKitWindow;
...
@interface Springboard : NSObject <ECModalEventHandler, ECEventHandlingDelegate, ECSBDelegate, ECSBDataSource, ECSBActionHandling, CALayerDelegate>
{
    ...
    ECAXObserverStoreWrapper *_axObserverStore;
}
...
- (void)setVisible:(_Bool)arg1 slow:(_Bool)arg2 reason:(id)arg3;
- (void)_setVisible:(_Bool)arg1 reason:(id)arg2;
- (void)purgeItemContentsLater;
- (void)regionOrHiddenAppEligibilityChanged:(id)arg1;
...
- (void)_showGamesGroup;
- (void)orderWindowOn:(_Bool)arg1;
@property(readonly) _Bool filtersWithExcludeList;
...
- (void)setVisible:(_Bool)arg1 reason:(id)arg2;
- (_Bool)_shouldUseSlowMotionAnimations;
- (void)toggleForReason:(long long)arg1 slow:(_Bool)arg2;
- (void)toggleForReason:(long long)arg1;
- (void)dismissForReason:(long long)arg1;
- (void)showForReason:(long long)arg1;
- (void)_showSpotlightBasedLaunchpad;
