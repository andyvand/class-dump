...
@interface ECItemListLayer : CALayer
{
    ...
    struct NSEdgeInsets _horizontalContentInset;
}
...
@property(nonatomic) struct NSEdgeInsets horizontalContentInset; // @synthesize horizontalContentInset=_horizontalContentInset;
...
@property(readonly, nonatomic) float startOffset;
- (void)dealloc;
