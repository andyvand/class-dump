...
@class CALayer, NSString, WALayerKitWindow;

@interface ECEvent : NSObject
{
    id _event;
    CALayer *_hitLayer;
    WALayerKitWindow *_hitWindow;
...
@property(retain, nonatomic) WALayerKitWindow *hitWindow; // @synthesize hitWindow=_hitWindow;
