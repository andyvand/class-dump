...
@class ECFlagLayer, ECProgressLayer, ECSBItem, ECSBLabelLayer, ECSBProgressLabelLayer, ECStatusLabelDescription, ECStatusLabelLayer, NSDictionary, NSString;
...
@property(readonly, nonatomic) ECFlagLayer *flagLayer; // @synthesize flagLayer=_flagLayer;
