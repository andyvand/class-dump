...
@interface LPDownloadingApp : LPItem <LPItemContainer, LPItemProgress, LPLayoutItem>
{
    ...
    unsigned int _hasPostProcessing:1;
    NSString *_uniquePathIdentifier;
    _Bool _progressHasPostProcessing;
    _Bool _isRestricted;
    _Bool _isBeta;
}
...
@property(readonly, nonatomic) _Bool progressHasPostProcessing; // @synthesize progressHasPostProcessing=_progressHasPostProcessing;
