...
- (_Bool)tabBar:(NSTabBar *)arg1 acceptDrop:(id <NSDraggingInfo>)arg2 index:(unsigned long long)arg3;
...
- (_Bool)tabBar:(NSTabBar *)arg1 acceptTabDrop:(id <NSTabDraggingInfo>)arg2 index:(unsigned long long)arg3;
...
- (void)tabBar:(NSTabBar *)arg1 didMoveTabBarViewItem:(NSTabBarItem *)arg2 fromIndex:(unsigned long long)arg3 toIndex:(unsigned long long)arg4 isChangingPinnedness:(_Bool)arg5;
...
- (_Bool)tabBar:(NSTabBar *)arg1 canCloseTabBarViewItem:(NSTabBarItem *)arg2;
- (NSString *)placeholderTextInEmptyUnpinnedRegionOfTabBar:(NSTabBar *)arg1;
- (_Bool)tabBar:(NSTabBar *)arg1 canDetachTabBarViewItem:(NSTabBarItem *)arg2;
- (_Bool)tabBar:(NSTabBar *)arg1 canDragToPinTab:(NSTabBarItem *)arg2;
- (void)tabBar:(NSTabBar *)arg1 didBeginDraggingTab:(NSTabBarItem *)arg2;
- (_Bool)tabBarCanDragItems:(NSTabBar *)arg1;
- (_Bool)tabBar:(NSTabBar *)arg1 droppedWindowTabShouldMoveToSpace:(long long)arg2;
@end
