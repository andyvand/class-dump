...
@class NSArray, NSMutableArray, NSObject, NSString, TMDUserSearch, TSearchCriteriaSheetController, TSlicesInterpreter;
...
@interface TSearchCriteriaViewController : TViewController <NSTextFieldDelegate, NSRuleEditorDelegate, TSearchCriteriaSheetDelegate, TMarkTornDown>
{
    ...
    TSearchCriteriaSheetController *_sheetController;
    TMDUserSearch *_search;
    TSlicesInterpreter *_strongSliceInterpreter;
    _Bool tornDown;
}
