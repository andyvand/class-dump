...
@property(nonatomic) int galleryViewArrangeBy;
@property(nonatomic) _Bool galleryViewShowTitles;
@property(nonatomic) _Bool galleryViewShowPreviewPane;
@property(nonatomic) _Bool galleryViewShowIconPreview;
@property(nonatomic) double galleryViewIconSize;
@property(nonatomic) int columnViewArrangeBy;
- (void)resetAllColumnsToGlobalWidth;
...
- (vector_3c4d3754)columnPropertiesInOrder;
- (void)setColumnsOrder:(const void *)arg1;
...
- (_Bool)skipSavingSettingsForNode;
