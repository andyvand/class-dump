...
@interface TToolbarController : NSController <NSToolbarDelegate, NSSearchFieldDelegate, TMarkTornDown>
{
    NSToolbar *_toolbar;
    struct TNSWeakPtr<NSResponder<NSMenuItemValidation, TToolbarControllerDelegateProtocol>> _weakDelegate;
...
+ (_Bool)removeItemForSyncExtensionIdentifier:(struct TString)arg1;
...
+ (const void *)itemEntryFromKind:(unsigned int)arg1;
+ (id)identifierFromKind:(unsigned int)arg1;
+ (unsigned int)kindFromIdentifier:(const void *)arg1;
...
- (void)removeItemWithItemIdentifier:(id)arg1;
...
@property(nonatomic) __weak NSResponder<TToolbarControllerDelegateProtocol> *delegate;
