...
+ (_Bool)findFirstUserGroupInPermissionsArray:(struct __CFArray *)arg1 node:(const struct TFENode *)arg2 findUser:(_Bool)arg3 foundidentity:(void *)arg4;
...
- (_Bool)removeIdentity:(const void *)arg1 aci:(const struct TAccessControlInfo *)arg2;
- (_Bool)addIdentity:(const void *)arg1;
- (_Bool)updateIdentity:(const void *)arg1 from:(const struct TAccessControlInfo *)arg2 to:(const struct TAccessControlInfo *)arg3;
- (_Bool)changeGroupTo:(const void *)arg1;
- (_Bool)changeOwnerTo:(const void *)arg1;
- (_Bool)changeOwnerOrGroupTo:(const void *)arg1;
