...
- (_Bool)splitView:(NSSplitView *)arg1 shouldHideDividerAtIndex:(long long)arg2;
- (_Bool)splitView:(NSSplitView *)arg1 shouldAdjustSizeOfSubview:(NSView *)arg2;
...
- (_Bool)splitView:(NSSplitView *)arg1 shouldCollapseSubview:(NSView *)arg2 forDoubleClickOnDividerAtIndex:(long long)arg3;
- (_Bool)splitView:(NSSplitView *)arg1 canCollapseSubview:(NSView *)arg2;
@end
