...
+ (void)applySharedSmartSearchDefaultsToSettings:(id)arg1;
+ (id)settingsFromViewOptions:(id)arg1;
+ (id)settingsFromPList:(id)arg1;
+ (id)settingsFromBrowserSettings:(void *)arg1;
...
+ (id)columnDictionaryFromColumnArray:(void *)arg1;
...
- (id)initWithListBrowserSettings:(void *)arg1;
