...
- (_Bool)browser:(NSBrowser *)arg1 shouldTypeSelectForEvent:(NSEvent *)arg2 withCurrentSearchString:(NSString *)arg3;
- (NSString *)browser:(NSBrowser *)arg1 typeSelectStringForRow:(long long)arg2 inColumn:(long long)arg3;
- (_Bool)browser:(NSBrowser *)arg1 acceptDrop:(id <NSDraggingInfo>)arg2 atRow:(long long)arg3 column:(long long)arg4 dropOperation:(unsigned long long)arg5;
...
- (_Bool)browser:(NSBrowser *)arg1 canDragRowsWithIndexes:(NSIndexSet *)arg2 inColumn:(long long)arg3 withEvent:(NSEvent *)arg4;
...
- (_Bool)browser:(NSBrowser *)arg1 writeRowsWithIndexes:(NSIndexSet *)arg2 inColumn:(long long)arg3 toPasteboard:(NSPasteboard *)arg4;
- (_Bool)browser:(NSBrowser *)arg1 shouldShowCellExpansionForRow:(long long)arg2 column:(long long)arg3;
...
- (double)browser:(NSBrowser *)arg1 shouldSizeColumn:(long long)arg2 forUserResize:(_Bool)arg3 toWidth:(double)arg4;
- (void)browserDidScroll:(NSBrowser *)arg1;
- (void)browserWillScroll:(NSBrowser *)arg1;
- (_Bool)browser:(NSBrowser *)arg1 isColumnValid:(long long)arg2;
- (_Bool)browser:(NSBrowser *)arg1 selectRow:(long long)arg2 inColumn:(long long)arg3;
- (_Bool)browser:(NSBrowser *)arg1 selectCellWithString:(NSString *)arg2 inColumn:(long long)arg3;
...
- (_Bool)browser:(NSBrowser *)arg1 shouldEditItem:(id)arg2;
...
- (_Bool)browser:(NSBrowser *)arg1 isLeafItem:(id)arg2;
