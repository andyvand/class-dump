...
+ (void)createFrontFinderWindowWithTabbingMode:(long long)arg1 target:(const struct TFENode *)arg2 forceNewWindow:(_Bool)arg3;
...
+ (id)existingOrNewWindowForTimeMachine;
...
+ (void)retargetWindowForTarget:(const struct TFENode *)arg1 toPath:(const void *)arg2;
...
+ (struct TFENodeVector)openEnclosingFolderOfNodes:(const void *)arg1 windowOptions:(id)arg2 alwaysSelectNodes:(_Bool)arg3;
+ (id)targetSelectOrCreateWindowWithOptions:(id)arg1 inTarget:(const struct TFENode *)arg2;
+ (void)targetSelectOrCreateWindowsForTargetsAsync:(const void *)arg1 withOptions:(const void *)arg2;
+ (void)newTabOrWindowForTarget:(const struct TFENode *)arg1 nodesToSelect:(const void *)arg2;
+ (void)targetSelectOrCreate:(const struct TFENode *)arg1 windowController:(id)arg2;
+ (void)targetSelectOrCreateWindow:(id)arg1 inTarget:(const struct TFENode *)arg2 selectNodes:(const void *)arg3;
+ (id)windowCreationOptions:(id)arg1 nodes:(const void *)arg2;
+ (void)targetSelectOrCreateWindowWithTarget:(const struct TFENode *)arg1;
+ (void)retargetFrontOrCreateWindowForFind:(int)arg1 searchString:(id)arg2 shouldSpawn:(_Bool)arg3 scopes:(const void *)arg4;
+ (_Bool)okayToSpawnInTabForWindow:(id)arg1;
+ (pair_9fabd6c6)selectionForMainBrowserWindowUpTo:(unsigned long long)arg1;
+ (id)findBrowserWindowControllerAndSelectNodes:(const void *)arg1;
+ (id)firstWindowControllerWithTarget:(const struct TFENode *)arg1 onScreen:(id)arg2;
+ (id)previousWindowControllerForITunesDevice:(const struct TFENode *)arg1;
...
+ (struct TFENode)nodeForUrl:(const void *)arg1;
...
- (void)restoreOneBrowserWindowFromState:(id)arg1 forReopenEvent:(_Bool)arg2 withCompletion:(const void *)arg3;
...
- (void)cmdGoToSharedDocuments:(id)arg1;
- (_Bool)validateGoToSharedDocuments:(id)arg1;
...
- (void)cmdGoToDataSeparatedICloud:(id)arg1;
- (_Bool)validateGoToDataSeparatedICloud:(id)arg1;
- (void)cmdGoToICloud:(id)arg1;
- (_Bool)validateGoToICloud:(id)arg1;
...
- (void)spotlightFindFile:(const void *)arg1 isRawString:(_Bool)arg2 scopes:(const void *)arg3;
...
- (_Bool)validateNewFinderWindow:(id)arg1;
- (void)cmdNewFinderWindowWithOption:(id)arg1;
- (_Bool)validateNewFinderWindowWithOption:(id)arg1;
- (_Bool)commonValidateNewFinderWindow:(id)arg1;
...
- (struct TFENode)nodeFromDockPath:(const void *)arg1;
- (id)_init;
