...
#import "TPreviewOptionsGroupSettingsDelegate-Protocol.h"

@class NSArray, NSSet, NSString, TPreviewOptionsDynamicGroupSettings;

@interface TPreviewOptions : NSObject <TPreviewOptionsGroupSettingsDelegate>
{
    NSString *_baseUTI;
    ...
    function_ab00380a _saveOptionsCallback;
...
- (void)saveOptions;
- (void)setSaveOptionsCallback:(function_ab00380a)arg1;
- (id)optionsToSave;
- (_Bool)needToSaveGroups;
- (void)loadDefaultOptionsFromDictionary:(id)arg1;
- (void)loadDefaultOptions;
- (id)initWithBaseUTIString:(const void *)arg1 groups:(id)arg2;
- (void)dealloc;
