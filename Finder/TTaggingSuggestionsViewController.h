...
- (_Bool)showSuggestionsForString:(const void *)arg1;
...
- (void)insertSuggestionAndSelectUntypedPortionForString:(const void *)arg1;
- (void)generateNewTagCompletionsForString:(const void *)arg1;
