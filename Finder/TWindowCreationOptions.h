...
{
    TBaseBrowserWindowController *_targetWindowController;
...
+ (id)optionsForModifiers:(unsigned long long)arg1 spawnOrigin:(shared_ptr_3b64c573)arg2 allowTabs:(_Bool)arg3;
...
- (void)getNodesToSelect:(void *)arg1;
- (void)setNodesToSelect:(const void *)arg1;
@property(retain, nonatomic) TBaseBrowserWindowController *targetWindowController;
