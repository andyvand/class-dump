...
- (void);
- (id);
- (_Bool)nge:intendedPrecedingCharacter:omittedCharacter:intendedFollowingCharacter:errorModel:capitalizationDictionaryArray: /* Error: Ran out of types for this method. */;
- (struct CGSize);
- (id);
- (void);
- (void):(id)arg1;
- (_Bool)ys:count: /* Error: Ran out of types for this method. */;
- (void)ipients;
