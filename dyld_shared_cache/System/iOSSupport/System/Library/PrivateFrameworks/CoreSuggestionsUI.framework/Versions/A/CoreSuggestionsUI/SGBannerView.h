...
@class CoreSuggestionsUI.SGBannerContent, CoreSuggestionsUI.SGBannerContentHostingView, NSArray, NSAttributedString, NSString, SGBannerDividerParameter, SGSuggestionAction, SGSuggestionStore, UIColor, UIVisualEffectView;
@protocol SGSuggestion, SGSuggestionDelegate;

@interface SGBannerView
{
    _Bool _orientationChanged;
    CoreSuggestionsUI.SGBannerContentHostingView *_bannerHostingView;
    CoreSuggestionsUI.SGBannerContent *_banner;
}
...
@property(retain, nonatomic) CoreSuggestionsUI.SGBannerContent *banner; // @synthesize banner=_banner;
