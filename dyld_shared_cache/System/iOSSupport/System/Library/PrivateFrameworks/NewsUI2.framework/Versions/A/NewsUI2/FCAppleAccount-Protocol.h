...
- (_Bool);
- (NSString *)!;
- (long long)handlePurchaseListChangedNotificationWithNotification: /* Error: Ran out of types for this method. */;
- (NSString *)for %s. Exiting.;
- (NSString *)r;
- (NFPromise *)Labels;
- (void)Øÿ;
- (void)ÿ;
