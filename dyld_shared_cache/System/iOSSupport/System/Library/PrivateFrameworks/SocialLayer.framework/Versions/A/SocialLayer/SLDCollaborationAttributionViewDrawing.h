...
@class NSString, SLDCollaborationAttributionViewSlotTag, UISSlotStyle;
...
@property(retain, nonatomic) SLDCollaborationAttributionViewSlotTag *tag; // @synthesize tag=_tag;
