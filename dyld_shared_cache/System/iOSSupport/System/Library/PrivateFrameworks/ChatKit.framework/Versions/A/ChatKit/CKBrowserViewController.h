...
- (void);
- (_Bool);
- (void)spatch_queueCGShyA1_GGA4_GSg;
- (_Bool);
- (_Bool)GGG;
- (_Bool);
- (_Bool);
...
- (void);
- (void)s;
- (void)for metadata selected accountID %@;
- (void)ith object {share:(id)arg1 %@, objectID:(id)arg2 %@};
- (id)haring.;
- (_Bool)tNotification;
- (_Bool)d List;
- (_Bool)/kb/HT212507;
- (_Bool)ance.;
- (_Bool)tation level %lu;
- (id);
- (id);
- (id);
- (id)ViewController;
