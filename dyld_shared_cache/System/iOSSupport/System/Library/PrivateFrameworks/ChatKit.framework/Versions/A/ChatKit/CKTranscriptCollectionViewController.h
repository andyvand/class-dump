...
@class CKBalloonEmphasisManager, CKChatItemController, CKConversation, CKFullScreenEffectManager, CKGroupTypingAvatarAnimationCoordinator, CKImpactEffectManager, CKPluginPlaybackManager, CKTranscriptBackgroundScrollingObserver, CKTranscriptBalloonSelectionManager, CKTranscriptCollectionView, CKTranscriptCompositor, CKTranscriptLayoutMessageEditingContext, CKTranscriptTextEffectsState, ChatKit.CKTextEffectCoordinator, IMChat, IMStateCaptureAssistant, NSArray, NSDate, NSDictionary, NSIndexPath, NSIndexSet, NSMutableArray, NSMutableSet, NSObject, NSSet, NSString, NSValue, UICollectionViewDiffableDataSource, UIColor, UIImpactFeedbackGenerator, UIInputContextHistory, UITapGestureRecognizer, UIView;
...
@interface CKTranscriptCollectionViewController : CKViewController
{
    ...
    ChatKit.CKTextEffectCoordinator *_transcriptTextEffectCoordinator;
...
@property(retain, nonatomic) ChatKit.CKTextEffectCoordinator *transcriptTextEffectCoordinator; // @synthesize transcriptTextEffectCoordinator=_transcriptTextEffectCoordinator;
