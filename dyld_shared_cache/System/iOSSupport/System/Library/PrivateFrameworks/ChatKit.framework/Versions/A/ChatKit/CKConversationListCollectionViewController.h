...
@interface CKConversationListCollectionViewController
{
    ...
    ChatKit.CKCloudSyncViewCoordinator *_syncStatusCoordinator;
    ...
    ChatKit.CKInteractionNotificationView *_searchTapNotificationView;
...
@property(retain, nonatomic) ChatKit.CKInteractionNotificationView *searchTapNotificationView; // @synthesize searchTapNotificationView=_searchTapNotificationView;
...
@property(retain, nonatomic) ChatKit.CKCloudSyncViewCoordinator *syncStatusCoordinator; // @synthesize syncStatusCoordinator=_syncStatusCoordinator;
