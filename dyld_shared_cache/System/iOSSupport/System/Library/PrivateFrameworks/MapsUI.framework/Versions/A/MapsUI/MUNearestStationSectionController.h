...
@class MKETAProvider, MKMapItem, MUNearestStationRowView, MUPlaceActionBarItem, MUPlaceCallToActionAppearance, MUPlaceFooterAtributionViewModel, MUPlaceSectionFooterViewModel, MUPlaceSectionHeaderViewModel, MUPlaceSectionView, MUPlaceVerticalCardContainerView, NSArray, NSString, UIView, UIViewController;
@protocol MUInfoCardAnalyticsDelegate, MUNearestStationSectionControllerDelegate;

__attribute__((visibility("hidden")))
@interface MUNearestStationSectionController : MUTransitLineItemSectionController
{
