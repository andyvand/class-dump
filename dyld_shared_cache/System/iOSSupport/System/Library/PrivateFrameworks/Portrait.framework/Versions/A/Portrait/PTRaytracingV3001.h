...
@class NSDictionary, NSString, PTColorConversion, PTGlobalReduction, PTGuidedFilter, PTMetalContext, PTPyramid, PTQualitySettings, PTRaytracingInterpolateResult, PTRaytracingUtils, PTRenderDebugLayer;
