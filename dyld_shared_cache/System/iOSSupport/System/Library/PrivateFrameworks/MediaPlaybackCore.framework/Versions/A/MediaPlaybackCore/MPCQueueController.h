...
+ (Class);
+ (_Bool)k:(id)arg1;
+ (long long)h-notification-types/add-push-notification-type-url;
+ (id)Plugin  PROJECT:AppleMediaServices-1
 /* Error: Ran out of types for this method. */;
+ (id);
+ (_Bool)sionDisconnected;
- (void);
- (void)ystem.B.dylib;
- (void);
- (id);
...
- (void);
- (void);
- (void)/A/AccountsDaemon;
- (void)Versions/A/AppleIDAuthSupport;
- (id);
- (id);
- (id);
- (id)tionDelegate;
...
- (id);
- (double)8;
- (void)k/Versions/A/AccountsDaemon;
- (void)y/PrivateFrameworks/AccountsDaemon.framework/Versions/A/AccountsDaemon;
- (void);
- (id);
- (id);
- (_Bool);
...
- (_Bool)_methname;
- (void)?>20;
- (void)UUID:(CDUnknownBlockType)arg1 dateInterval:(CDUnknownBlockType)arg2 forceGenerate:completion: /* Error: Ran out of types for this method. */;
- (id)alQueue;
- (void)n returned %d;
- (id)thCompletion timed out!;
- (void);
- (void)@x;
- (void);
- (void);
...
- (_Bool);
- (id);
- (void)hIdentifier:(id)arg1 account: /* Error: Ran out of types for this method. */;
- (void);
- (void)fyCredentials:(id)arg1;
- (void)illPerformActionsForDataclasses:(id)arg1;
- (id)etFollowUpsForAccount:(long long)arg1;
- (void)nStore:(id)arg1;
- (id);
- (void);
- (id)ng automatic download kinds. error = %{public}@;
- (void)lic}@ [%{public}@] Error revoking user music token. error = %{public}@;
- (id);
- (_Bool);
- (long long);
- (id);
...
- (id);
- (void);
- (id)size:artworkFormat: /* Error: Ran out of types for this method. */;
- (id);
