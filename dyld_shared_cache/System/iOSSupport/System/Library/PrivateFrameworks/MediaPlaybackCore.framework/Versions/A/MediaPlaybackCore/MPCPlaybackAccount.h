...
- (_Bool);
- (void);
- (void)for this username, waiting... { username:(_Bool)arg1 %@ };
- (void);
- (void);
- (unsigned long long)acon:updates:completion: /* Error: Ran out of types for this method. */;
- (id)dBeaconsWithCompletion: /* Error: Ran out of types for this method. */;
- (_Bool)timed out!;
- (id);
- (id);
- (_Bool);
...
- (_Bool);
- (id);
- (id)lic}@:(id)arg1 [%{public}@] Local account's storefront doesn't need to be updated. account = %{public}@;
- (id)@:[%{public}@] canSaveAccount = %{public}@ /* Error: Ran out of types for this method. */;
- (_Bool)-push-notification-type-url;
- (void)mismatches the participant we requested control from:(id)arg1 %s;
- (void);
- (_Bool);
- (id);
- (id);
