...
+ (id);
- (void);
- (unsigned int)ification/IDSAccountNotificationPlugin.bundle/Contents/MacOS/IDSAccountNotificationPlugin;
- (id);
- (id)artUpdatingSimpleBeaconsWithContext:(long long)arg1 completion:(unsigned int)arg2;
- (id)s;
- (id)ctPhoneNumberFrom:(id)arg1;
- (id);
- (id);
- (id);
- (id);
- (_Bool)Type;
- (_Bool)efrontDidChangeWithAccount:(id)arg1;
- (_Bool)ccount:(id)arg1 willPerformActionsForDataclasses:(id)arg2;
- (_Bool);
- (_Bool)ype:(id)arg1;
- (long long)revoke Music User Tokens missing necessary method in ICCloudServiceStatusMonitor;
- (unsigned int)@] Revoking Music User Tokens;
- (id);
- (id);
- (id);
- (id);
...
- (void);
- (id);
- (long long)s_sharedAccountStore;
- (id);
- (long long);
- (id);
- (long long)tN;
...
- (unsigned int)ù
× ;
- (_Bool)ile:profileVersion: /* Error: Ran out of types for this method. */;
- (long long)blic}@:MPCModelGenericAVItemSubscriptionAssetLoadOperation execute [loading asset from cache] prefersVideoContent=%{BOOL}u preferredAudio=%{private}@ /* Error: Ran out of types for this method. */;
- (id)SessionController.accessQueue;
