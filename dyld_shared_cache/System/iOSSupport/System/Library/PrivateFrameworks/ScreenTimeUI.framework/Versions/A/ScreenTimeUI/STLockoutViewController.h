...
@class NSDictionary, NSObject, NSString, STLockoutPolicyController, ScreenTimeUI.CommunicationLimitsBlockingViewModel, UIAlertController, UIButton, UIImageView, UILabel, UIResponder, UIStackView, UIViewController, UIVisualEffectView;
...
@interface STLockoutViewController
{
    ...
    ScreenTimeUI.CommunicationLimitsBlockingViewModel *_communicationLimitsBlockingViewModel;
...
@property(retain) ScreenTimeUI.CommunicationLimitsBlockingViewModel *communicationLimitsBlockingViewModel; // @synthesize communicationLimitsBlockingViewModel=_communicationLimitsBlockingViewModel;
