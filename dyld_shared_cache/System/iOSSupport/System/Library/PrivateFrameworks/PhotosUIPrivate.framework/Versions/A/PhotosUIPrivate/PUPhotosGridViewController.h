...
- (void)teractionEnded;
- (void)kCropUseSymbol;
- (unsigned long long)GradientStartColor;
- (void)PlayStateDidChange;
- (_Bool)nalyticsPayload;
- (void)pdates: /* Error: Ran out of types for this method. */;
- (_Bool)itionAnimations:(id)arg1;
- (_Bool)IDs;
- (_Bool)tes=qq},N,V_anchorShiftOffset;
- (id),N,GisReusable,V_reusable;
- (void)legate;
- (id);
- (_Bool)2ðG;
- (id)4;
- (id)erControllerMessagesLayout;
- (id)osUIPrivate34PickerOnboardingHeaderViewDelegateP;
- (_Bool)lpaperShuffleSmartAlbumSectionContent;
- (long long);
- (void)ì$á
;
- (void)j;
