...
- (void);
- (id);
- (double)0:8@"Protocol"16 /* Error: Ran out of types for this method. */;
- (void)etReference: /* Error: Ran out of types for this method. */;
- (void)kerConfiguration;
- (void)Changed;
- (void)SizeActionsForAssets: /* Error: Ran out of types for this method. */;
- (void)ollageSize;
