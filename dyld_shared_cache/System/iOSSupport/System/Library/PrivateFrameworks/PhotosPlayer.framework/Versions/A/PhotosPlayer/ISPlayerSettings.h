...
@interface ISPlayerSettings : ISSettings
{
    ...
    _Bool _playAppleMusicWithMemoriesExports;
...
@property(nonatomic) _Bool playAppleMusicWithMemoriesExports; // @synthesize playAppleMusicWithMemoriesExports=_playAppleMusicWithMemoriesExports;
