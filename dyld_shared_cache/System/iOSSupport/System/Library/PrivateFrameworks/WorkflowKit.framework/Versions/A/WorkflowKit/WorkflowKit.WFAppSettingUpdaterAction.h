...
@class INAppDescriptor, NSArray, NSDictionary, WFActionParameterSummary;

@interface WorkflowKit.WFAppSettingUpdaterAction : WorkflowKit.WFEntityUpdatingAction
{
    id entityByEntityIdentifier;
    id $__lazy_storage_$_sortedLocalizedNames;
    id $__lazy_storage_$__localizedNameForEntityIdentifier;
    id $__lazy_storage_$_sortedParameterIdentifiers;
}
