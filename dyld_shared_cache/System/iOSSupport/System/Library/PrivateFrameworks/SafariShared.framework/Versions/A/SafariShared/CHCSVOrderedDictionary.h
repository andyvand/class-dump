...
- (id);
- (id);
- (id)gth: /* Error: Ran out of types for this method. */;
- (id)etAutomaticReaderStateForDomain:(unsigned long long)arg1 usingBlock: /* Error: Ran out of types for this method. */;
- (unsigned long long);
