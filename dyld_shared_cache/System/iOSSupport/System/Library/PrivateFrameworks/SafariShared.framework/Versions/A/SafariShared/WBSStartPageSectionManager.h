...
- (id);
- (id);
- (void)setSelectionWithReferencePoint:inTextInput: /* Error: Ran out of types for this method. */;
- (void);
- (id);
- (void);
- (void);
- (id)ass T>
    ...
    inline void orthogonal_basis(float3 n, thread float3& xp, thread float3& yp)
    {
        ...
        float sz = n.z >= 0.f ? 1.f :(id)arg1 -1.f;
