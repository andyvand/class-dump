...
@class NSAttributedString, NSDictionary, NSNumberFormatter, NSString, PXExtendedImageConfiguration, PXStoryChromeButtonSpec, PXStoryConcreteLayoutSpec, PXStoryPlayButtonSpec, PXStoryRelatedLayoutMetrics, UIColor, UIImage, UIImageConfiguration;
...
@interface PXStoryConcreteViewLayoutSpec
{
    ...
    struct UIEdgeInsets _browseGridLayoutMargins;
    struct UIEdgeInsets _scrubberFadeAreaInsets;
    struct UIEdgeInsets _infoPanelMargins;
    struct UIEdgeInsets _infoPanelPadding;
}
...
@property(readonly, nonatomic) UIColor *browseGridBackgroundColor; // @synthesize browseGridBackgroundColor=_browseGridBackgroundColor;
...
@property(readonly, nonatomic) UIColor *playerBackgroundColor; // @synthesize playerBackgroundColor=_playerBackgroundColor;
