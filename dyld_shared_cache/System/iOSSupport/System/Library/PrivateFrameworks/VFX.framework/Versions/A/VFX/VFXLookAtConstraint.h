...
+ (id);
+ (_Bool)nctionHandle>"32@0:8@"NSString"16Q24 /* Error: Ran out of types for this method. */;
- (id);
- (id);
- (void);
- (void);
...
- (id)specDir = hit_ls - probeOffset;
        ...
        float3 LD = float3(probeTextureArray.sample(vfx_lighting:(id)arg1:linearSampler, specDir, probeIndex, level(mips)).rgb);
#else
