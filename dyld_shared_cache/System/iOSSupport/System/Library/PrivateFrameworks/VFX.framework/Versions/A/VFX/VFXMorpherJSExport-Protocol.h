...
- (NSArray *);
- (void)thread float4& tessLevelOuter, thread float2& tessLevelInner)
{
                        ...
                        thread float4& tessOuterLo, thread float4& tessOuterHi)
{
    ...
    // refinement level of the mesh:(NSArray *)arg1 //     min(OSD_MAX_TESS_LEVEL, pow(2, MaximumRefinementLevel-1)
