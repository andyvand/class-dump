...
- (void);
- (unsigned long long);
- (long long)Hu	lw|xzø|h~l¸(Ì,¨	ð|¸	¸,äÐ´Ô;
- (void)~æÿ;
- (float);
- (id);
- (long long)uterLo[0] = OsdComputeTessLevel(OsdTessLevel, OsdProjectionMatrix, OsdModelViewMatrix,p0, *tPt);
