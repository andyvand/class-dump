...
@interface VFXClock
{
    ...
    double _time;
    double _timeStep;
    struct VFXClockTimeRange _replayLoopRange;
...
- (id)ff&?;
- (void)Mode;
- (void)â¢>ÿ=|?ôÞ@|ë½å>ÉY|?Úp@òëç½ð>ýh|?¹@ä ä½ªc>-y|?î#ÿ?ÐEã½ýz>²|?hñ?½¨Ý½äk>|?¾å?`tÙ½B[^>³³|?MôÙ?VÓÕ½vúQ>È|?ÆÏ?;ßÏ½¦
F>yç|?Æ?ß§Ê½ö
;>}?m6¾?iÅ½)0>l$}?,¶?êÏ¾½¼³&>9G}?B¯¯?Ú:(_Bool)arg1 ¸½Ø.>µl}?´Y©?
...
@property(nonatomic) struct VFXClockTimeRange replayLoopRange; // @synthesize replayLoopRange=_replayLoopRange;
