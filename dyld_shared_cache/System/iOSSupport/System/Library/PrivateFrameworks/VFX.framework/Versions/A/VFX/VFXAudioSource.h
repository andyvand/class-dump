...
- (id);
- (long long);
- (float)mmand buffer execution failed with status %d, error:%@
                        ...
                        thread float4& tessOuterLo, thread float4& tessOuterHi)
{
    ...
    // refinement level of the mesh:(float)arg1 //     min(OSD_MAX_TESS_LEVEL, pow(2, MaximumRefinementLevel-1)
                                ...
                                OsdPatchParamBufferSet osdBuffers)
{
 ...
 /* Error: Ran out of types for this method. */;
- (void)void add_ies_soft_shadows(vfx_light light, texture2d<half> iesTexture, depth2d<float> shadowMap, constant float4* shadowKernel, int sampleCount)
    {
