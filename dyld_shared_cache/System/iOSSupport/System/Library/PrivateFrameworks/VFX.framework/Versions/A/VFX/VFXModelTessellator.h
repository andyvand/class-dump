...
+ (id);
+ (_Bool)@"<MTLRenderPipelineState>"48@0:8@"MTLTileRenderPipelineDescriptor"16Q24^@32^@40 /* Error: Ran out of types for this method. */;
- (CDStruct_9b587744);
- (void);
- (void);
- (long long);
...
- (void)atchCoord);
    ...
    _geometry.texcoords[5] = vfx:(id)arg1:barycentric_mix(in.controlPoints[0].texcoord5, in.controlPoints[1].texcoord5, in.controlPoints[2].texcoord5, patchCoord);
#endif
