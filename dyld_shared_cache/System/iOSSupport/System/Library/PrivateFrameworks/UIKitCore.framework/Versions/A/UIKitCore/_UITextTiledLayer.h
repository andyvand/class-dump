...
- (void)inputAssistantViewHeightForInputViewSet: /* Error: Ran out of types for this method. */;
- (void)bezierPathWithRoundedRect:cornerRadius: /* Error: Ran out of types for this method. */;
- (id)_preferredConfigurationForFocusAnimation:(struct CGRect)arg1 inContext:(id)arg2;
- (void)onAnimation;
- (void)_isChromeHidden;
...
- (void);
- (_Bool)pasteVariant;
- (void)_UIImagePickerControllerShowCameraControls;
...
- (void)10parameters_t;
- (void)SDySo6UIViewCSo13_UIPortalViewCG;
- (void);
- (void)513  ¹þ;
- (id);
