...
+ (_Bool)hat is not backed by an ids account ---- please file a radar;
- (void);
- (void);
- (void);
- (void);
- (void);
- (void)appendItemUpdateForPreviousIndexPath:(id)arg1 finalIndexPath: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void);
- (long long);
...
- (void)setPrivateSubviews:(id)arg1;
- (_Bool)insertSiblingMenu:afterMenuForIdentifier: /* Error: Ran out of types for this method. */;
- (void)addOperation: /* Error: Ran out of types for this method. */;
- (void)_visibleHeightForContentOffset:(_Bool)arg1 origin: /* Error: Ran out of types for this method. */;
- (void)_dismissMenuPresentationForSizeChange;
- (id)_contentAnimationIdentifier;
- (struct CGRect)_UITypeSelectNavigationGestureRecognizer;
- (void)olete status bar cache items to delete.;
- (void)headlineRegular;
- (void)So29_UITabBarContentLayoutManagerCSg;
- (id)_UIFlexInteractionSmallVariantSpec;
- (void);
- (_Bool);
