...
- (void);
- (CDUnknownBlockType);
- (_Bool)_MPNowPlayingInfoPropertyRadioStationName;
- (void);
- (void);
- (id);
...
- (long long)setPreferredImageDynamicRange: /* Error: Ran out of types for this method. */;
- (void)initWithEditOperation:indexToEdit:newText:indexInArrayB: /* Error: Ran out of types for this method. */;
- (struct CGRect)_setLightSourceDescriptor:(struct CGPoint)arg1;
- (void)_allowsBandSelectionForMultipleSelection;
...
- (_Bool)ToolbarKeyboardAssistant;
- (CDUnknownBlockType);
- (id)É´1^;
- (id)þq;
- (struct CGPoint)h;
