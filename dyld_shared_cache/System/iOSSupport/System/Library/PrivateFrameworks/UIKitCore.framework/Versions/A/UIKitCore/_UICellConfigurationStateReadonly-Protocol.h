...
- (long long)_setCanBeParentTraitEnvironment: /* Error: Ran out of types for this method. */;
- (_Bool)_hoverGestureRecognizerChanged: /* Error: Ran out of types for this method. */;
- (_Bool));
