...
- (void)y:(id)arg1 shouldDisableScreenTimeRestrictions:(id)arg2 hasAttachments:requiredCapabilities: /* Error: Ran out of types for this method. */;
- (_Bool);
- (void);
- (id)!;
- (void)°!èFùeÐ1Â0@ù
...
- (id)__positionBarsExclusivelyWithSafeArea;
- (void)F;
