...
- (id)imulatePressesCallbacksForLegacyBehavior;
- (double)nstanceForCustomInputView: /* Error: Ran out of types for this method. */;
- (void)leteHitTestForTouchDown:(id)arg1 executionContext:(id)arg2;
- (int)ath: /* Error: Ran out of types for this method. */;
- (void)gRedrawFrame;
- (void)itions:(id)arg1 ,V__prefersZoomTransitions;
- (void)tch",R,N,V_replaceToggleSwitch;
- (void)llerDetentResolutionContext_Internal;
- (void)>>??ä?"h@AÌBC;
- (double)later. self = %@;
