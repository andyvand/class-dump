...
- (void)replayControllerWantsToSync;
- (void)relayDictionaryToPeers:(_Bool)arg1 requiresUpload:serviceName:requiredCapabilities:excludedCapabilities:excludesWatch:onlyWatch: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void);
- (void);
