...
+ (unsigned long long);
+ (unsigned long long);
+ (void)ateFrameworks/CoreRecents.framework/Versions/A/CoreRecents;
+ (id);
+ (id);
+ (id);
+ (id);
...
- (struct CGPoint)or Business;
- (struct CGPoint)<LPTextStyleable>"8Q16^B24;
- (struct CGPoint)PTextStyleable>"8Q16^B24;
- (void);
- (void);
- (void);
- (struct CGPoint);
...
- (void);
- (void);
- (void)or loading metadata dictionary with object of class:(double)arg1 %@;
- (double);
- (double);
- (_Bool);
- (_Bool);
...
- (id);
- (id);
- (void)ppleArchive.dylib;
- (void);
- (void)eFrameworks/SoftLinking.framework/Versions/A/SoftLinking;
- (void)ions/A/CollectionsInternal;
- (void)/Library/PrivateFrameworks/CollectionsInternal.framework/Versions/A/CollectionsInternal;
- (void);
- (void);
- (void)c;
- (void)n;
                   ...
                   thread float2& vSegments)
{
    ...
    for (int i=0; i<4; ++i) {
        for (int j=0; j<4; ++j) {
            ...
            :(const char *)arg1 ((s <= vSegments.y) ?  float3(cv[k].P1)
                 :float3(cv[k].P2));
