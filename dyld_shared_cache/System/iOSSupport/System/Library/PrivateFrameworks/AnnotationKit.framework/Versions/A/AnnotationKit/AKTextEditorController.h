...
- (void);
- (void)143452;
- (id)g on an LPMetadataProvider that has already started. LPMetadataProvider is a one-shot object.;
- (id)alysis;
- (id)tion.MetadataProvider.VisionAnalysis;
- (void)Artist;
- (void)6@?0@?<v@?@"NSData"@"NSError">8;
- (void)"8@"NSError"16;
- (void)Link;
- (void)ionMetadataClass(void)_block_invoke;
- (void)otherItemCount;
- (void)specialization;
- (void)albumURL;
- (void)LPMetadataCreatorTwitterUsername;
- (id)Z%;
- (double);
- (_Bool);
- (_Bool);
