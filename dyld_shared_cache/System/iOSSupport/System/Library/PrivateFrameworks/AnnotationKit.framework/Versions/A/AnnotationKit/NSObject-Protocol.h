...
@protocol NSObject
- (_Bool);
- (struct _NSZone *)CGSize=dd}24@40@48B56{CGSize=dd}60B76@?80;
- (_Bool)elif defined(USE_AMBIENT_COLOR)
...
;
- (_Bool);
- (NSString *)assingThrottler:completionHandler: /* Error: Ran out of types for this method. */;
- (_Bool)y_visits (origin, generation);
- (id)P;
- (unsigned long long);

@optional
- (NSString *)aractersInSet: /* Error: Ran out of types for this method. */;
