...
- (void);
- (id);
- (id)eMediaQueryOrientation:function(e){return e.replace(/orientation:(portrait|landscape)/,(function(e,t){return"orientation:"+("portrait"===t?"landscape":"portrait")}))}};var WebClipMetadataFinderJS=new WebClipMetadataFinder; /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (long long);
- (void)4J;
