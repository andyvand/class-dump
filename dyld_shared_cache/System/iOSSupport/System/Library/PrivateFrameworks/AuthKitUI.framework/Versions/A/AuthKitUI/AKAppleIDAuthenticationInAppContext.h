...
- (void);
- (void);
- (id)setExportedCredentialData: /* Error: Ran out of types for this method. */;
- (id);
- (void)vv2
//        |       Lo3       |       Hi3       |
//      --O-----------O-----+-----O-----------O--
                        ...
                        thread float4& tessOuterLo, thread float4& tessOuterHi)
{
    ...
    // refinement level of the mesh:(_Bool)arg1 //     min(OSD_MAX_TESS_LEVEL, pow(2, MaximumRefinementLevel-1)
