...
- (void);
- (id)!;
- (long long)_pendingCompletionHandlers;
- (void)length_squared(modelViewTransform[2]));
    ...
    _surface.tangent = normalize(scn:(_Bool)arg1:mat3(scn_node.modelViewTransform) * _geometry.tangent.xyz);
...
- (void);
- (void);
- (void)AUTHORIZATION_VIEWCONTROLLER_TITLE_MODERN;
