...
- (id);
- (id)needsUpdate;
- (void)RATES_NORMAL)) || defined(USE_TANGENT) || defined(USE_BITANGENT) || defined(USE_INSTANCING)
    ...
    float3x3 nrmTransform = scn:(_Bool)arg1:mat3(scn_node.modelViewTransform);
