...
+ (id);
+ (id);
+ (_Bool)dataJSController.formsMetadata(requestType);;
- (_Bool);
- (_Bool);
- (void);
- (id);
...
- (void);
- (id);
- (id)setOriginTValueForSnappedDrawing: /* Error: Ran out of types for this method. */;
- (id)setOpacityLabelTopConstraint:(id)arg1;
- (void);
- (void);
- (void);
- (void);
