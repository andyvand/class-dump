...
@property(nonatomic) id simdEulerAngles;
@property(nonatomic) CDStruct_183601bc simdOrientation;
@property(nonatomic) CDStruct_95fa7c00 simdPivot;
@property(nonatomic) id simdPosition;
@property(nonatomic) id simdRotation;
@property(nonatomic) id simdScale;
@property(nonatomic) CDStruct_95fa7c00 simdTransform;
@property(readonly, nonatomic) id simdWorldFront;
@property(nonatomic) CDStruct_183601bc simdWorldOrientation;
@property(nonatomic) id simdWorldPosition;
@property(readonly, nonatomic) id simdWorldRight;
@property(nonatomic) CDStruct_95fa7c00 simdWorldTransform;
@property(readonly, nonatomic) id simdWorldUp;
