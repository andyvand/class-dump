...
- (void);
- (void);
- (double)dd}{CGSize=dd}}24@0:8@"UIView"16 /* Error: Ran out of types for this method. */;
- (void);
- (id);
- (id);
- (id)copyAllChatsWithUnreadMessagesWithLimit:beforeDate:predicate:completionHandler: /* Error: Ran out of types for this method. */;
- (id)dictionary_result;
- (id)@;
- (void);
- (void);
- (void);
