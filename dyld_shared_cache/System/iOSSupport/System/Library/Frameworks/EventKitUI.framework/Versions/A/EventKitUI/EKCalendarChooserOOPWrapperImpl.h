...
@class EKAbstractCalendarEditor, EKCalendar, EKEvent, EKEventStore, EventKitUI.EKCalendarChooserOOPImpl, NSSet, NSString, UIBarButtonItem;
...
@interface EKCalendarChooserOOPWrapperImpl
{
    ...
    EventKitUI.EKCalendarChooserOOPImpl *_vc;
