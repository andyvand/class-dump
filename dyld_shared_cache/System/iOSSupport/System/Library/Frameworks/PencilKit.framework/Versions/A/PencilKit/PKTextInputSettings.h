...
- (void)al.framework/Versions/A/CoreMaterial;
- (void)orks/CoreEmoji.framework/Versions/A/CoreEmoji;
- (void);
- (void)reUI.framework/Versions/A/CoreUI;
- (void);
- (void)r;
- (void)NST;
- (void);
...
- (double)16@24B32;
- (void)SObject>";
- (void)h_queue>"16@?<v@?B>24;
- (_Bool)16;
- (double)responseData;
- (double)_millisecondTimeIntervalSinceDate: /* Error: Ran out of types for this method. */;
- (double)meIntervalSince1970;
- (long long)leID:deviceInfo:debugOverrides:useBackgroundRefreshRate:backgroundFetchConfiguration:requestMode:endpointTimeoutDuration:fallbackTimeoutDuration: /* Error: Ran out of types for this method. */;
- (_Bool)rID:storefrontID:bundleID:deviceInfo: /* Error: Ran out of types for this method. */;
- (_Bool)umber:buildNumber: /* Error: Ran out of types for this method. */;
- (_Bool)taWithContentsOfURL:options:error: /* Error: Ran out of types for this method. */;
- (double)countryCode;
- (double)gWithState:objects:count: /* Error: Ran out of types for this method. */;
- (_Bool)yEndpointURLString;
- (_Bool)timedOutTest;
- (_Bool)ended;
- (_Bool);
- (_Bool)tIfNeeded;
- (_Bool)ace;
- (_Bool)nWithRetryAfter: /* Error: Ran out of types for this method. */;
- (double)ers;
- (double)workEventHandler;
- (double)leAdditionalFields;
- (double)eoutDuration;
- (double);
- (double)_internalDebugOverrides;
- (double)alApplicationState;
- (double)incompleteTaskMetrics;
- (double)eoutDuration;
- (double)RefreshRate;
- (double)nSource;
- (id)V_observerLock;
- (double)ects: /* Error: Ran out of types for this method. */;
- (_Bool)SString",R,C,N,V_userID;
- (id);
- (double)(label=%d);
- (double);
- (double)f.;
...
- (_Bool)}@ did succeed;
- (_Bool)tusCode;
- (void)ry/BuildRoots/4~CG4tugAb8POCWQu-C8jX215VhPkqHdv-PsDAzNI/Library/Caches/com.apple.xbs/Sources/RemoteConfiguration/RemoteConfiguration/RCRequestInfo+News.m;
- (void)9D;
- (void);
- (_Bool)";
- (_Bool);
...
- (id)
;
- (void)paletteDidDockToPosition:(id)arg1 fromUserReposition:(id)arg2;
