...
- (void);
- (struct CGAffineTransform);
- (_Bool)"16@"SiriSharedUIAdditionalDomainFeedback"24;
- (void):(_Bool)arg1;
- (void)utEventForSiriViewController:(id)arg1 aceCommands:sashItem: /* Error: Ran out of types for this method. */;
- (id)nstraint;
- (void)?;
- (id)S;
- (void);
...
- (void);
- (id);
- (id)ernalSettings.drawing.apt.minimumMovementDistancePencil;
