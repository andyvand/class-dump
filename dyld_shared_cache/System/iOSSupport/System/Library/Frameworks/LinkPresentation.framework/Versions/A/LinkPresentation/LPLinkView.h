...
- (id);
- (id);
- (void)id tap to begin search in %s;
- (void)ations.;
- (void)ifier that was not in the pinned conversation identifier list. Ignoring. Conversation:(unsigned long long)arg1 %@;
- (void)n:(id)arg1 ] Pinned conversations are frozen. Removing conversation from frozenPinnedConversations:%@ /* Error: Ran out of types for this method. */;
- (void)wController | Unexpected indexPaths count. Expecting 1. Got indexPaths:(_Bool)arg1 %@;
- (void)@;
- (void)ifier not found on configuration:(_Bool)arg1 %@;
- (id)ssage is staged in new compose, recipientsListChanged, %s;
- (id)upActivity.;
- (void);
- (id);
- (_Bool);
...
- (struct CGSize)r:removingItemAtURL: /* Error: Ran out of types for this method. */;
- (void);
- (id);
- (void);
- (_Bool);
