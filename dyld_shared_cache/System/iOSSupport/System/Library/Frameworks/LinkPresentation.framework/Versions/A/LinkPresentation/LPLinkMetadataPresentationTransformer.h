...
@class LPImage, LPLinkMetadata, LPLinkRendererSizeClassParameters, NSString, NSURL, UITraitCollection;
...
@interface LPLinkMetadataPresentationTransformer
{
    ...
    UITraitCollection *_effectiveAppearance;
...
- (_Bool);
- (unsigned long long)%@;
- (void)cessType:(unsigned long long)arg1 %ld permissionType:%ld, allowOthersToInvite=%@ /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (_Bool);
- (unsigned long long)?;
...
@property(retain, nonatomic) UITraitCollection *effectiveAppearance; // @synthesize effectiveAppearance=_effectiveAppearance;
