...
@class CALayer, CNAvatarCardController, CNContact, CNContactStore, CNSharedProfileStateOracle, CNUnfairLock, ContactsUI.CNAvatarView_SwiftWrapper, NSArray, NSIndexSet, NSString, UIColor, UIImage, UIImageView, UINavigationController, UIView;
...
@interface CNAvatarView
{
    ...
    ContactsUI.CNAvatarView_SwiftWrapper *_avatarView;
...
@property(retain, nonatomic) ContactsUI.CNAvatarView_SwiftWrapper *avatarView; // @synthesize avatarView=_avatarView;
