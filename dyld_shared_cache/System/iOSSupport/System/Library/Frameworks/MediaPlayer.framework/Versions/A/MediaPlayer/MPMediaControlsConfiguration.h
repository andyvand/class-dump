...
+ (_Bool)equestedLength=%ld requestedOffset=%lld;
- (id);
- (id);
- (void);
- (void);
- (struct CGRect);
- (void);
- (void)48@0:(_Bool)arg1 8@16@24@32Q40;
- (id)ortsSuggestedActionsMenu;
- (void);
- (_Bool));
- (double);
- (void);
...
- (int);
- (void);
- (id)amed: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void)MediaClipStaticAssets;
