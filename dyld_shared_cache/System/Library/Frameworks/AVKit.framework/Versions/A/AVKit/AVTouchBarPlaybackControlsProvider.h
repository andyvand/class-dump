...
@class AVTouchBarPlaybackControlsViewController, NSTouchBar;
...
+ (void)setAccessibilityRole: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void);
- (id);
