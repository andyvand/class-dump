...
- (void);
- (void);
- (void)kernel vec4 moreGreen (sampler src, float param)                
{                                                               
    vec4 s;                                                     
