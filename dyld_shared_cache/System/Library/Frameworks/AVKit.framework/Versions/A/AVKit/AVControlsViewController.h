...
@class AVControlsPresentationContext, NSMutableArray;
...
- (double);
- (long long);
- (_Bool)stem/Library/Frameworks/Security.framework/Versions/A/Security;
- (struct CGSize);
- (long long);
- (id);
- (CDStruct_d2b197d1);
