...
class std::__1::__shared_ptr_pointer<AdobeXMPCore::IMetadata_v1*, std::__1::__mem_fn<void (AdobeXMPCommon::ISharedObject::*)() const>, std::__1::allocator<AdobeXMPCore::IMetadata_v1>> {
