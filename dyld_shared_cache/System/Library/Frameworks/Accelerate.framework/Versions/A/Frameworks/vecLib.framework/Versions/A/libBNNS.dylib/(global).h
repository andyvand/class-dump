...
std::nothrow;
typeinfo for MIL::IROpset;
typeinfo for MIL::Location;
typeinfo for MIL::TextFileLocation;
typeinfo for MIL::UnknownLocation;
typeinfo for bnns::GraphOptions;
...
typeinfo name for bnns::GraphOptions;
void * operator new(unsigned long);
void * operator new(unsigned long, std::__type_descriptor_t);
void * operator new(unsigned long, std::align_val_t, std::nothrow_t const&);
