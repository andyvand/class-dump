...
struct Face {
    ...
    int _field10;
    struct vector<apple::vision::libraries::facecore::coord, std::allocator<apple::vision::libraries::facecore::coord>> _field11;
    int _field12;
    _Bool _field13;
    _Bool _field14;
    float _field15;
...
struct unique_ptr<apple::vision::libraries::facecore::FaceCoreAPI, std::default_delete<apple::vision::libraries::facecore::FaceCoreAPI>> {
    struct {
        struct FaceCoreAPI *__ptr_;
    } ;
};

struct vector<apple::vision::libraries::facecore::coord, std::allocator<apple::vision::libraries::facecore::coord>> {
