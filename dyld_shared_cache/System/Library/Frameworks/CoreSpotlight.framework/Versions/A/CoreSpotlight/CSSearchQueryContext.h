...
@class CSSuggestion, NSArray, NSAttributedString, NSData, NSDate, NSDictionary, NSNumber, NSString, _MDQueryRewriteContext;
...
@property(nonatomic) id fuzzyMask;
@property(nonatomic) id fuzzyMatch;
