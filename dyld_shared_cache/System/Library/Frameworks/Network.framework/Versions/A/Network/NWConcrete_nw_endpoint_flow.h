...
@interface NWConcrete_nw_endpoint_flow
{
    ...
    struct retained_ptr<nw_protocol *> transport_protocol;
    struct retained_ptr<nw_protocol *> joined_protocol;
    struct retained_ptr<nw_protocol *> proxy_protocol;
    struct retained_ptr<nw_protocol *> bottom_protocol;
    struct nw_protocol_identifier *ip_protocol_identifier;
    NSObject<OS_nw_protocol_definition> *multiplexed_message_definition;
    struct retained_ptr<nw_protocol *> multiplexed_message_protocol;
    ...
    struct retained_ptr<nw_protocol *> socket_protocol;
