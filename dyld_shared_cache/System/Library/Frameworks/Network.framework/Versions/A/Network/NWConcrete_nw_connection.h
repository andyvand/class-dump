...
@class NSObject;
@protocol OS_dispatch_data, OS_dispatch_group, OS_dispatch_queue, OS_dispatch_workloop, OS_nw_array, OS_nw_candidate_manager, OS_nw_connection_progress_report, OS_nw_context, OS_nw_endpoint, OS_nw_endpoint_handler, OS_nw_establishment_report, OS_nw_interface, OS_nw_parameters, OS_nw_read_request, OS_nw_resolution_report, OS_nw_write_request;
...
@interface NWConcrete_nw_connection : NWDeallocOnQueueObject
{
    ...
    CDUnknownBlockType progress_handler;
