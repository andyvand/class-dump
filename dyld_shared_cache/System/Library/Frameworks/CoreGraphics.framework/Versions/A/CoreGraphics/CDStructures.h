...
struct shared_ptr<TextLine> {
    struct TextLine *__ptr_;
    struct __shared_weak_count *__cntrl_;
};

struct vector<std::shared_ptr<TextLine>, std::allocator<std::shared_ptr<TextLine>>> {
    void *__begin_;
    void *__end_;
    struct {
        void *__cap_;
...
typedef struct vector<std::shared_ptr<TextLine>, std::allocator<std::shared_ptr<TextLine>>> {
    void *__begin_;
    void *__end_;
    struct {
        void *__cap_;
