...
@interface UnknownClass (ImageCaptureCoreAdditions)
- (id)1.);
...
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(CDUnknownBlockType)arg1:linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
