...
- (void).sample(u_normalTextureSampler, _surface.normalTexcoord), USE_NORMAL_TEXTURE_COMPONENT).rg * 2.f - 1.f;
...
- (void)(defined USE_POSITION) && (USE_POSITION == 2)
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(int)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
...
- (void)Texcoord).r;
 ...
 /* Error: Ran out of types for this method. */;
- (void)metalnessTexture.sample(u_metalnessTextureSampler, _surface.metalnessTexcoord), USE_METALNESS_TEXTURE_COMPONENT).r;
#else
...
- (void)0.);
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(id)arg2:(id)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void).selfIllumination = u_selfIlluminationTexture.sample(u_selfIlluminationTextureSampler, _surface.selfIlluminationTexcoord);
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(unsigned int)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
...
- (void)f
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(id)arg2:(CDUnknownBlockType)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void)RoughnessTextureSampler, _surface.clearCoatRoughnessTexcoord).r;
#endif
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(CDUnknownBlockType)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
 ...
 /* Error: Ran out of types for this method. */;
- (void)ace.clearCoat = u_clearCoatTexture.sample(u_clearCoatTextureSampler, _surface.clearCoatTexcoord).r;
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(CDUnknownBlockType)arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
...
- (id)face.ambientTexcoord);
 ...
 /* Error: Ran out of types for this method. */;
- (void).sample(u_ambientTextureSampler, _surface.ambientTexcoord).r;
        #endif
        #ifdef USE_AMBIENT_INTENSITY
 ...
 /* Error: Ran out of types for this method. */;
- (_Bool)for (uint sampleID = 0; sampleID < get_num_samples(); ++sampleID) {
 ...
 /* Error: Ran out of types for this method. */;
- (id)ING * in.instanceID + in.sliceIndex];
#endif
#else
 ...
 /* Error: Ran out of types for this method. */;
- (void)des[USE_MULTIPLE_RENDERING * in.instanceID + amplificationID];
#else
...
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(id)arg1:(CDUnknownBlockType)arg2 linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)ant commonprofile_node& scn_node = scn_nodes[USE_MULTIPLE_RENDERING * in.instanceID + amplificationID];
#else
    constant commonprofile_node& scn_node = scn_nodes[USE_MULTIPLE_RENDERING * in.instanceID + in.sliceIndex];
#endif
#else
 ...
 /* Error: Ran out of types for this method. */;
- (void)#ifdef USE_VERTEX_AMPLIFICATION
...
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(id)arg1:linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
...
- (void)MULTIPLE_RENDERING
 ...
 /* Error: Ran out of types for this method. */;
- (void)amplificationID                  [[amplification_id]]
#endif
                                      )
{
#ifdef USE_MULTIPLE_RENDERING
 ...
 /* Error: Ran out of types for this method. */;
- (void)xture2d<float>              u_specularDFGDiffuseHammonTexture
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned int), texture2d<float>              u_reflectiveTexture
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
- (void)define u_selfIlluminationTextureSampler scn_commonprofile.selfIlluminationSampler
...
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(id)arg1:(id)arg2 linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(_Bool)arg3 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
- (int)u_ambientTexture                scn_commonprofile.ambientTexture
...
- (void)float3 v = surface.view;
        ...
        float3 n_cube_space = scn:(id)arg1:(CDUnknownBlockType)arg2 mat4_mult_float3(localDirToWorldCubemapDir, diffuseDominantNDirection);
