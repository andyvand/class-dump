...
- (long long)rIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn:(ICCameraDevice *)arg1:(NSArray *)arg2 linear_to_srgb(_output.color.rgb);
#endif
...
- (long long)IER
    ...
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(ICDevice *)arg1:(void (^)(id, NSMutableDictionary *))arg2 debugColorForCount(clusterIndex.z).xyz), 0.1f);
...
- (long long)0.5f + 0.5f, 1.f); break;
            case 2:(ICCameraDevice *)arg1 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:(NSData *)arg2 _output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:(NSData *)arg3 _output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:(void (^)(id, NSMutableDictionary *))arg4 _output.color = float4(_surface.diffuse.rgb, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (long long)FLECTIVE_TEXTURE_COMPONENT).r;
#endif
    ...
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(ICCameraDevice *)arg1:(NSArray *)arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
...
- (long long)_TEXTURE_COMPONENT)
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(ICCameraFile *)arg1:(ICCameraDevice *)arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(void (^)(id, NSMutableDictionary *))arg3 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
...
- (long long)0.f, 1.f);
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(ICCameraDevice *)arg1:(NSDictionary *)arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (long long)3(0.f, 0.f, 1.f), _surface._clearCoatNormalTS, scn_commonprofile.clearCoatNormalIntensity);
#endif
#else
        _surface._clearCoatNormalTS = float3(0.f, 0.f, 1.f);
#endif
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSDictionary *)arg1:(void *)arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (long long)* _surface.geometryNormal;         
 ...
 /* Error: Ran out of types for this method. */;
- (long long)float NoV = dot(_surface.geometryNormal, _surface.view);
 ...
 /* Error: Ran out of types for this method. */;
- (long long)ed USE_VIEW) && (USE_VIEW == 2)
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(NSDictionary *)arg3 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:(void (^)(id, NSMutableDictionary *))arg4 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
            case 6:_output.color = float4(float3(_surface.roughness), 1.f); break;
...
- (long long)T) && (USE_BITANGENT == 2)
 ...
 /* Error: Ran out of types for this method. */;
- (long long)rface.tangent = in.tangent;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (long long)IDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(ICCameraDevice *)arg1 -1.f );
#else
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSDictionary *)arg2:(void (^)(id, NSMutableDictionary *))arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (long long)#if (defined USE_NORMAL) && (USE_NORMAL == 2)
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(void (^)(id, NSMutableDictionary *))arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
...
- (long long)if
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(ICCameraFile *)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(ICCameraDevice *)arg2:(NSDictionary *)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(void (^)(id, NSMutableDictionary *))arg4 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
...
- (long long)NTENSITY
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(ICCameraDevice *)arg2:(void (^)(id, NSMutableDictionary *))arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (long long)ed(USE_TRANSPARENT_TEXTURE_COMPONENT)
 ...
 /* Error: Ran out of types for this method. */;
- (long long)re.sample(u_transparentTextureSampler, _surface.transparentTexcoord);
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(ICDevice *)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(void *)arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
