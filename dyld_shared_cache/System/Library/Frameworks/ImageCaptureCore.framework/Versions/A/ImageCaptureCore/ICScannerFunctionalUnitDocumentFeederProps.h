...
- (void)mal * 0.5f + 0.5f, 1.f); break;
            case 2:(_Bool)arg1 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
...
- (id)SITY
 ...
 /* Error: Ran out of types for this method. */;
- (_Bool)_surface.specular, USE_SPECULAR_TEXTURE_COMPONENT);
#endif
