...
- (double)hnessTexcoord).r;
    ...
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(double)arg1 -1.f );
#else
 ...
 /* Error: Ran out of types for this method. */;
- (double)12HSinFunction;
- (double);
- (void);
- (void)_insertObjectRelationshipStatement;
- (double);
- (void);
- (double);
- (double)setPrivOrientation: /* Error: Ran out of types for this method. */;
- (void)äT;
