...
+ (_Bool)= scn_commonprofile.materialShininess;
  #endif
...
- (_Bool)ion.pbr.albedo, float3(0.0), _surface.metalness);
...
- (void)ndif 
 ...
 /* Error: Ran out of types for this method. */;
- (void)turate(_lightingContribution.specular);
    #endif 
    #endif 
#else 
    _lightingContribution.diffuse = float3(1.);
...
- (unsigned char)NG
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)__FragmentDoLighting__
 ...
 /* Error: Ran out of types for this method. */;
- (_Bool)case 8:_output.color = float4(float3(_surface.ambientOcclusion), 1.f); break;
            default:break;
        }
        return _output;
    #endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:(id)arg1 _output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
            case 6:_output.color = float4(float3(_surface.roughness), 1.f); break;
            case 7:_output.color = float4(float3(_surface.metalness), 1.f); break;
            case 8:_output.color = float4(float3(_surface.ambientOcclusion), 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void).5f, 1.f); break;
            case 3:(_Bool)arg1 _output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
            case 6:_output.color = float4(float3(_surface.roughness), 1.f); break;
            case 7:_output.color = float4(float3(_surface.metalness), 1.f); break;
...
- (void)#endif 
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(unsigned char)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)global_probe(scn_frame.viewToCubeTransform, globalFactor * scn_frame.environmentIntensity,
                                           u_reflectionProbeTexture);
#else 
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(double)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
...
- (_Bool)lTS = float3(0.f, 0.f, 1.f);
 ...
 /* Error: Ran out of types for this method. */;
- (id)* _surface._clearCoatNormalTS.xyz );
    }
#else
    _surface._clearCoatNormalTS = float3(0.f, 0.f, 1.f);
#endif
...
- (unsigned long long)f);
 ...
 /* Error: Ran out of types for this method. */;
- (id)sTexture.sample(u_roughnessTextureSampler, _surface.roughnessTexcoord), USE_ROUGHNESS_TEXTURE_COMPONENT).r;
#else
    _surface.roughness = u_roughnessTexture.sample(u_roughnessTextureSampler, _surface.roughnessTexcoord).r;
#endif
#ifdef USE_ROUGHNESS_INTENSITY
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGSize)TEXTURE_COMPONENT)
    _surface.roughness = colorFromMask(u_roughnessTexture.sample(u_roughnessTextureSampler, _surface.roughnessTexcoord), USE_ROUGHNESS_TEXTURE_COMPONENT).r;
#else
    _surface.roughness = u_roughnessTexture.sample(u_roughnessTextureSampler, _surface.roughnessTexcoord).r;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)parent = float4(1.f);
#endif
...
- (unsigned long long)RANSPARENT)
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGSize)_TRANSPARENT_COLOR)
    _surface.transparent = scn_commonprofile.transparentColor;
#elif defined(USE_TRANSPARENT)
    _surface.transparent = float4(1.f);
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)ce.transparent = colorFromMask(_surface.transparent, USE_TRANSPARENT_TEXTURE_COMPONENT);
#endif
#ifdef USE_TRANSPARENT_INTENSITY
    _surface.transparent *= scn_commonprofile.transparentIntensity;
#endif
...
- (id)n = float4(0.);
 ...
 /* Error: Ran out of types for this method. */;
- (id)#if defined(USE_DIFFUSE) && defined(USE_VERTEX_COLOR)
    _surface.diffuse.rgb    *= in.vertexColor.rgb;
    _surface.diffuse        *= in.vertexColor.a; 
#endif
#ifdef USE_SPECULAR_MAP
 ...
 /* Error: Ran out of types for this method. */;
- (id)ffuse = float4(0.f,0.f,0.f,1.f);
#endif
#if defined(USE_DIFFUSE) && defined(USE_VERTEX_COLOR)
    _surface.diffuse.rgb    *= in.vertexColor.rgb;
    _surface.diffuse        *= in.vertexColor.a; 
...
- (void)MPONENT);
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned char)= scn_commonprofile.ambientIntensity;
        #endif
    #endif 
#elif defined(USE_AMBIENT_COLOR)
    _surface.ambient = scn_commonprofile.ambientColor;
 ...
 /* Error: Ran out of types for this method. */;
- (void)r, _surface.ambientTexcoord);
        #if defined(USE_AMBIENT_TEXTURE_COMPONENT)
            _surface.ambient = colorFromMask(_surface.ambient, USE_AMBIENT_TEXTURE_COMPONENT);
        #endif
        #ifdef USE_AMBIENT_INTENSITY
...
- (id);
- (unsigned long long);
- (void)elPropertyLibraryPinEntityPersistentID;
- (unsigned long long);
- (unsigned long long);
- (void);
- (id);
...
- (void);
- (void);
- (id)makeCommand: /* Error: Ran out of types for this method. */;
