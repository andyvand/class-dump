...
- (void).xyz) * (isFrontFacing ? 1.f :(id)arg1 -1.f );
#else
...
- (void)_surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(unsigned long long)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(_Bool)arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
- (id), texture2d<float>              u_clearCoatTexture
                                      , sampler                       u_clearCoatTextureSampler
#endif
#ifdef USE_CLEARCOATROUGHNESS_MAP
                                      , texture2d<float>              u_clearCoatRoughnessTexture
                                      ...
                                      )
{
...
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(id)arg1:(_Bool)arg2 linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void), sampler                       u_diffuseTextureSampler
#endif
#ifdef USE_SPECULAR_MAP
