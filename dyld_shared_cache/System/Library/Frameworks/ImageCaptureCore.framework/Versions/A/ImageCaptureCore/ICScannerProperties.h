...
- (void)_lightingContribution.pbr.transparency;
  #else
...
- (void)htingContribution.shadowFactor;
#else
...
- (void)0.0), _surface.metalness);
 ...
 /* Error: Ran out of types for this method. */;
- (void)urate(_lightingContribution.diffuse);
    #ifdef USE_SPECULAR
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(unsigned int)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
 ...
 /* Error: Ran out of types for this method. */;
- (void)_lightingContribution.specular = in.specular;
    #endif
#endif 
 ...
 /* Error: Ran out of types for this method. */;
- (void)entOcclusion), 1.f); break;
            default:(id)arg1 break;
        }
        return _output;
    #endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)case 1:(id)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)l_probe(scn_frame.viewToCubeTransform, globalFactor * scn_frame.environmentIntensity,
...
- (_Bool).0);
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned int)TextureSampler, _surface.normalTexcoord).rgb;
 ...
 /* Error: Ran out of types for this method. */;
- (id)xy = colorFromMask(u_normalTexture.sample(u_normalTextureSampler, _surface.normalTexcoord), USE_NORMAL_TEXTURE_COMPONENT).rg * 2.f - 1.f;
 ...
 /* Error: Ran out of types for this method. */;
- (id)olorFromMask(u_metalnessTexture.sample(u_metalnessTextureSampler, _surface.metalnessTexcoord), USE_METALNESS_TEXTURE_COMPONENT).r;
#else
...
- (id)(USE_CLEARCOAT)
 ...
 /* Error: Ran out of types for this method. */;
- (void)monprofile.clearCoatIntensity;
#endif
