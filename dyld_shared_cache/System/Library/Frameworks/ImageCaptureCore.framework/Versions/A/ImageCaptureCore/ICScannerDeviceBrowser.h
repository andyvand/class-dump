...
@class ICCommandCenter, NSMutableDictionary;
...
+ (id);
- (void)ightingContribution.add_global_probe(scn_frame.viewToCubeTransform, globalFactor * scn_frame.environmentIntensity,
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    _lightingContribution.add_global_probeClearCoat(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
        ...
        switch (DEBUG_PIXEL) {
            ...
            case 2:(unsigned long long)arg2 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
...
- (void)dSum.a);
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    _lightingContribution.add_global_probeClearCoat(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
        ...
        switch (DEBUG_PIXEL) {
            case 1:(id)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:(id)arg2 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
            case 6:_output.color = float4(float3(_surface.roughness), 1.f); break;
...
- (void)node.shCoefficients);
 ...
 /* Error: Ran out of types for this method. */;
- (void)rom_sh(scn_frame.viewToCubeTransform, scn_node.shCoefficients);
#else
    _lightingContribution.add_global_irradiance_probe(u_irradianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
#endif
#endif
...
- (void)ionOcclusion);
 ...
 /* Error: Ran out of types for this method. */;
- (void)mentPosition.xy * scn_frame.clusterScale.xy); 
 ...
 /* Error: Ran out of types for this method. */;
- (void)reflective *= _surface.fresnel;
#endif
#ifdef USE_SHININESS
...
- (void)normal );
 ...
 /* Error: Ran out of types for this method. */;
- (void)_normalTextureSampler, _surface.normalTexcoord), USE_NORMAL_TEXTURE_COMPONENT).rg * 2.f - 1.f;
 ...
 /* Error: Ran out of types for this method. */;
- (void)rface.bitangent, _surface.normal);
 ...
 /* Error: Ran out of types for this method. */;
- (void)_surface.multiply = float4(1.);
#endif
...
- (void)or;
 ...
 /* Error: Ran out of types for this method. */;
- (void)y, USE_MULTIPLY_TEXTURE_COMPONENT);
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (id)_surface.selfIllumination = float4(0.);
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)_surface.clearCoat *= scn_commonprofile.clearCoatIntensity;
#endif
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(SEL)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
 ...
 /* Error: Ran out of types for this method. */;
- (void)at = colorFromMask(_surface.clearCoat, USE_CLEARCOAT_TEXTURE_COMPONENT).r;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)d(USE_CLEARCOAT_TEXTURE_COMPONENT)
...
- (void)excoord).r;
 ...
 /* Error: Ran out of types for this method. */;
- (void)elif defined(USE_SPECULAR)
...
- (id)in.vertexColor;
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(unsigned long long)arg1:linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (struct os_unfair_lock_s)_surface.ambient *= in.vertexColor;
#endif
#if  defined(USE_SSAO)
...
- (id)_surface.ambient = float4(0.);
 ...
 /* Error: Ran out of types for this method. */;
- (id)tTexcoord), USE_AMBIENT_TEXTURE_COMPONENT).r;
        #else
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
- (_Bool), bool                          isFrontFacing                    [[front_facing]]
#endif
#ifdef USE_POINT_RENDERING
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
- (void)u_specularDFGDiffuseHammonTexture
...
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(struct os_unfair_lock_s)arg1:linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
- (id)ampler                       u_clearCoatNormalTextureSampler
#endif
#endif 
#endif 
#ifdef USE_PBR
