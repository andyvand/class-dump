...
+ (void)if defined(USE_CLEARCOAT_TEXTURE_COMPONENT)
    ...
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(unsigned long long)arg2:(unsigned long long)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
...
+ (void)float>              u_clearCoatNormalTexture
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
+ (id)d(USE_POSITION) && (USE_POSITION == 2)
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
+ (id)_lightingContribution.specular;
  #endif
#endif
#if defined(USE_POSITION) && (USE_POSITION == 2)
    out.position = _surface.position;
...
#endif
#if  defined(USE_SSAO)
    _surface.ambientOcclusion *= u_ssaoTexture.sample( sampler(filter:(id)arg1:(unsigned long long)arg2 linear), in.fragmentPosition.xy * scn_frame.inverseResolution.xy ).x;
#endif
...
+ (void)ansform[1]),
    ...
    _surface.tangent = normalize(scn:(id)arg1:mat3(scn_node.modelViewTransform) * _geometry.tangent.xyz);
                                      ...
                                      )
{
 ...
 /* Error: Ran out of types for this method. */;
+ (void)_squared(modelViewTransform[0]),
...
#endif
#if defined(USE_TANGENT) || defined(USE_BITANGENT)
    _surface.tangent = normalize(scn:(id)arg1:(_Bool)arg2 mat3(scn_node.modelViewTransform) * _geometry.tangent.xyz);
    _surface.bitangent = _geometry.tangent.w * cross(_surface.tangent, _surface.normal); 
