...
- (void)lor.rgb = mix(_output.color.rgb, float3(scn:(id)arg1:(id)arg2 debugColorForCount(clusterIndex.z).xyz), 0.1f);
...
- (void)#if defined(C3D_SUPPORTS_PROGRAMMABLE_BLENDING) && defined(USE_MODIFIER_FRAMEBUFFER_COLOR0)
...
- (void)entIntensity);
 ...
 /* Error: Ran out of types for this method. */;
- (void)mple(u_reflectiveTextureSampler, float2(float2(refl.x,-refl.y) / m) + 0.5f);
    ...
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(id)arg1:(id)arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)fl.y*refl.y + (refl.z+1.f)*(refl.z+1.f));
...
- (void)));
 ...
 /* Error: Ran out of types for this method. */;
- (void)ace._clearCoatNormalTS.xy)));
#else
        _surface._clearCoatNormalTS = u_clearCoatNormalTexture.sample(u_clearCoatNormalTextureSampler, _surface.clearCoatNormalTexcoord).rgb;
        _surface._clearCoatNormalTS = _surface._clearCoatNormalTS * 2.f - 1.f;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)- saturate(length_squared(_surface._clearCoatNormalTS.xy)));
#else
        _surface._clearCoatNormalTS = u_clearCoatNormalTexture.sample(u_clearCoatNormalTextureSampler, _surface.clearCoatNormalTexcoord).rgb;
        _surface._clearCoatNormalTS = _surface._clearCoatNormalTS * 2.f - 1.f;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)NormalTexcoord), USE_CLEARCOATNORMAL_TEXTURE_COMPONENT).rg * 2.f - 1.f;
...
- (void)iew);
 ...
 /* Error: Ran out of types for this method. */;
- (void)(defined USE_VIEW) && (USE_VIEW == 2)
...
- (void)ndif
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(id)arg4 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:(CDUnknownBlockType)arg5 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
            case 6:_output.color = float4(float3(_surface.roughness), 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)fined(USE_ROUGHNESS_COLOR)
...
- (id)surface.metalness = 0.f;
 ...
 /* Error: Ran out of types for this method. */;
- (void)ample(u_metalnessTextureSampler, _surface.metalnessTexcoord), USE_METALNESS_TEXTURE_COMPONENT).r;
#else
 ...
 /* Error: Ran out of types for this method. */;
- (long long)ifdef USE_MULTIPLY_INTENSITY
 ...
 /* Error: Ran out of types for this method. */;
- (void)llumination = u_selfIlluminationTexture.sample(u_selfIlluminationTextureSampler, _surface.selfIlluminationTexcoord);
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(id)arg2:(_Bool)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void)ss = scn_commonprofile.clearCoatRoughness;
#else
...
- (void)if
 ...
 /* Error: Ran out of types for this method. */;
- (void)ned(USE_CLEARCOATROUGHNESS_TEXTURE_COMPONENT)
