...
- (void)fragment.z - (in.mv_lastFragment.xy / in.mv_lastFragment.z))*half2(1.,-1.) * scn_frame.motionBlurIntensity;
#else
...
;
- (void)ak;
            case 8:(NSData *)arg1 _output.color = float4(float3(_surface.ambientOcclusion), 1.f); break;
            default:(NSData *)arg2 break;
        }
        return _output;
    #endif
    ...
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(void (^)(NSMutableDictionary *))arg3:debugColorForCount(clusterIndex.z).xyz), 0.1f);
...
- (void)dif
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(NSNumber *)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:(NSDictionary *)arg2 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:(void (^)(NSMutableDictionary *))arg3 _output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
...
- (void)RCOAT
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(void (^)(NSMutableDictionary *))arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)ame.viewToCubeTransform, globalFactor * scn_frame.environmentIntensity,
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    _lightingContribution.add_global_probeClearCoat(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
        ...
        switch (DEBUG_PIXEL) {
            case 1:(NSNumber *)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:(void (^)(NSMutableDictionary *))arg2 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
            case 6:_output.color = float4(float3(_surface.roughness), 1.f); break;
...
- (void)lectionProbeTexture);
 ...
 /* Error: Ran out of types for this method. */;
- (void)Contribution.add_local_probe(scn_lights[LightIndex(lid)], u_reflectionProbeTexture);
    }
#if PROBES_NORMALIZATION
#if PROBES_OUTER_BLENDING
    _lightingContribution.specular += _lightingContribution.probesWeightedSum.rgb / max(1.f, _lightingContribution.probesWeightedSum.a);
...
- (void)_lightingContribution.add_global_irradiance_probe(u_irradianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
 ...
 /* Error: Ran out of types for this method. */;
- (void)global_irradiance_from_sh(scn_frame.viewToCubeTransform, scn_node.shCoefficients);
#else
...
- (void)ELFILLUMINATION
 ...
 /* Error: Ran out of types for this method. */;
- (void)nprofile.selfIlluminationOcclusion);
...
- (void)_LIGHTING
 ...
 /* Error: Ran out of types for this method. */;
- (void)lif defined(USE_REFLECTIVE_COLOR)
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(NSArray *)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)efl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(_Bool)arg1:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
 ...
 /* Error: Ran out of types for this method. */;
- (void)eflect( -_surface.view, _surface.normal );
    ...
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(void (^)(NSMutableDictionary *))arg1:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void)rgb = normalize(ts2vs * _surface._clearCoatNormalTS.xyz );
    }
#else
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSDictionary *)arg1:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void)_surface.clearCoatNormal.rgb = normalize(ts2vs * _surface._clearCoatNormalTS.xyz );
    }
#else
    _surface._clearCoatNormalTS = float3(0.f, 0.f, 1.f);
#endif
...
- (void)lIntensity);
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSNumber *)arg1:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void), _surface._clearCoatNormalTS, scn_commonprofile.clearCoatNormalIntensity);
#endif
#else
        _surface._clearCoatNormalTS = float3(0.f, 0.f, 1.f);
#endif
