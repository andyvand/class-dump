...
- (void)#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)aturate(_lightingContribution.specular);
    #endif 
    #endif 
#else 
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(struct CGRect)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
 ...
 /* Error: Ran out of types for this method. */;
- (void)_lightingContribution.specular = saturate(_lightingContribution.specular);
    #endif 
    #endif 
#else 
    _lightingContribution.diffuse = float3(1.);
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(long long)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(char *)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
...
- (void).a;
 ...
 /* Error: Ran out of types for this method. */;
- (void)gContribution.probesWeightedSum.a;
#endif
    float globalFactor = saturate(1.f - _lightingContribution.probesWeightedSum.a);
#else
    float globalFactor = _lightingContribution.probeRadianceRemainingFactor;
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(long long)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)sWeightedSum.rgb / _lightingContribution.probesWeightedSum.a;
#endif
    float globalFactor = saturate(1.f - _lightingContribution.probesWeightedSum.a);
#else
    float globalFactor = _lightingContribution.probeRadianceRemainingFactor;
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGRect)urface.roughness, PBR_MIN_ROUGHNESS, 1.0);
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGRect)oat roughness = clamp(_surface.roughness, PBR_MIN_ROUGHNESS, 1.0);
        float alpha = scn_filteredAlphaFromRoughness(_surface.normal, roughness);
        _surface.roughness = sqrt(alpha);
    }
#endif
...
- (char *)3(0.f, 0.f, 1.f);
 ...
 /* Error: Ran out of types for this method. */;
- (id)ormal = normalize(in.normal.xyz);
#endif
#else 
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(unsigned long long)arg1:(unsigned long long)arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
...
- (void)AP
    ...
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(long long)arg1 -1.f );
#else
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(unsigned long long)arg2:(const char *)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(unsigned long long)arg4 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
...
- (_Bool)oat4(0.);
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(struct CGRect)arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGImage *)nprofile.selfIlluminationIntensity;
#endif
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(_Bool *)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
...
- (long long)hness;
 ...
 /* Error: Ran out of types for this method. */;
- (id)onprofile.clearCoatRoughness;
#else
    _surface.clearCoatRoughness = 0.03f;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned char)f USE_CLEARCOATROUGHNESS_INTENSITY
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)USE_SPECULAR)
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(unsigned long long)arg2:(char *)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void)nprofile.specularIntensity;
#endif
...
#if defined(HAS_NORMAL) || defined(USE_OPENSUBDIV)
#ifdef USE_DOUBLE_SIDED
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(struct CGRect)arg1 -1.f );
#else
    _surface.geometryNormal = normalize(in.normal.xyz);
#endif
#else 
...
- (unsigned long long);
- (void);
- (unsigned long long)RC %{public}@:Scheduled reload skipped. /* Error: Ran out of types for this method. */;
- (unsigned long long);
- (long long);
- (void)initWithUserDefaults:(unsigned long long)arg1 keys:queue:notifyForInitialValue:handler: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void);
- (void);
- (char *);
- (struct CGColorSpace *)read-only filter;
- (void);
