...
- (void)nel.y * pow(1.f - saturate(dot(_surface.view, _surface.normal)), scn_commonprofile.fresnel.z);
...
- (void)snel.x + scn_commonprofile.fresnel.y * pow(1.f - saturate(dot(_surface.view, _surface.normal)), scn_commonprofile.fresnel.z);
    _surface.reflective *= _surface.fresnel;
#endif
#ifdef USE_SHININESS
    _surface.shininess = scn_commonprofile.materialShininess;
 ...
 /* Error: Ran out of types for this method. */;
- (void)le(u_reflectiveTextureSampler, scn:(unsigned long long)arg1:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
 ...
 /* Error: Ran out of types for this method. */;
- (void)eflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(unsigned long long)arg1:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)= scn_commonprofile.clearCoatRoughnessIntensity;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)_surface.clearCoatRoughness *= scn_commonprofile.clearCoatRoughnessIntensity;
#endif
#elif defined(USE_CLEARCOATROUGHNESS_COLOR)
    _surface.clearCoatRoughness = scn_commonprofile.clearCoatRoughness;
#else
