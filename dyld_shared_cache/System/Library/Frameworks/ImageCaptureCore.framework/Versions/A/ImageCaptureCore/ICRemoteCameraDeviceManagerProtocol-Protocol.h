...
- (void)oatNormal.rgb = normalize(ts2vs * _surface._clearCoatNormalTS.xyz );
    }
#else
    ...
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSString *)arg1:(void (^)(NSMutableDictionary *))arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)1.f), _surface._clearCoatNormalTS, scn_commonprofile.clearCoatNormalIntensity);
#endif
#else
        _surface._clearCoatNormalTS = float3(0.f, 0.f, 1.f);
#endif
...
- (void)= normalize(in.normal.xyz);
 ...
 /* Error: Ran out of types for this method. */;
- (void)*= scn_commonprofile.transparentIntensity;
#endif
    ...
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(NSString *)arg1 -1.f );
#else
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(void (^)(NSMutableDictionary *))arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
