...
@class NSDictionary, NSMutableDictionary, NSNumber, NSXPCListenerEndpoint;

@protocol ImageCaptureProtocol
- (void)_lightingContribution.diffuse * diffuseAlbedo;
    ...
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(NSNumber *)arg1:(NSXPCListenerEndpoint *)arg2 debugColorForCount(clusterIndex.z).xyz), 0.1f);
    ...
    _output.color.rgb = scn:(NSNumber *)arg3:linear_to_srgb(_output.color.rgb);
#endif
...
- (void)ibution.add_local_omni(scn_lights[LightIndex(lid)]);
        }
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(NSDictionary *)arg1:(void (^)(NSDictionary *, NSError *))arg2 debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
 ...
 /* Error: Ran out of types for this method. */;
- (void)omni_count = cluster_offset_count.y & 0xff;
 ...
 /* Error: Ran out of types for this method. */;
- (void)viewToCubeTransform, scn_frame.environmentIntensity);
#endif
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(NSDictionary *)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:(void (^)(NSDictionary *, NSError *))arg2 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
...
- (void)fdef USE_CLEARCOAT
 ...
 /* Error: Ran out of types for this method. */;
- (void)ransform, scn_frame.environmentIntensity);
 ...
 /* Error: Ran out of types for this method. */;
- (void).add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
...
- (void)ntensity,
 ...
 /* Error: Ran out of types for this method. */;
- (void)viewToCubeTransform, globalFactor * scn_frame.environmentIntensity,
                                           u_reflectionProbeTexture);
#else 
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
...
- (void)ngFactor;
 ...
 /* Error: Ran out of types for this method. */;
- (void)float globalFactor = _lightingContribution.probeRadianceRemainingFactor;
#endif
    _lightingContribution.add_global_probe(scn_frame.viewToCubeTransform, globalFactor * scn_frame.environmentIntensity,
                                           u_reflectionProbeTexture);
#else 
 ...
 /* Error: Ran out of types for this method. */;
- (void)obe(u_irradianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
#endif
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)_lightingContribution.add_global_irradiance_probe(u_irradianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
#endif
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)(scn_frame.viewToCubeTransform, scn_node.shCoefficients);
#else
...
- (void)ationOcclusion);
 ...
 /* Error: Ran out of types for this method. */;
- (void)FGDiffuseHammonTexture, scn_commonprofile.selfIlluminationOcclusion);
 ...
 /* Error: Ran out of types for this method. */;
- (void)int lid = cluster_offset_count.x;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)ster_offset_count = u_clusterTexture.read(clusterIndex);
 ...
 /* Error: Ran out of types for this method. */;
- (void)terScale.z + scn_frame.clusterScale.w; 
...
- (void); 
 ...
 /* Error: Ran out of types for this method. */;
- (void)uint2(in.fragmentPosition.xy * scn_frame.clusterScale.xy); 
    clusterIndex.z = in.position.z * scn_frame.clusterScale.z + scn_frame.clusterScale.w; 
...
- (void)ndif
    ...
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSMutableDictionary *)arg1:(void (^)(NSMutableDictionary *))arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)rCoatNormalTS = float3(0.f, 0.f, 1.f);
#endif
        _surface.clearCoatNormal.rgb = normalize(ts2vs * _surface._clearCoatNormalTS.xyz );
    }
#else
...
- (void)ity);
 ...
 /* Error: Ran out of types for this method. */;
- (void)pler, _surface.clearCoatNormalTexcoord).rgb;
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSNumber *)arg1:(void (^)(NSMutableDictionary *))arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void)ess, PBR_MIN_ROUGHNESS, 1.0);
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(NSMutableDictionary *)arg1:(void (^)(NSError *))arg2 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (void)_roughnessTexture.sample(u_roughnessTextureSampler, _surface.roughnessTexcoord), USE_ROUGHNESS_TEXTURE_COMPONENT).r;
#else
    ...
    _surface.geometryNormal = normalize(in.normal.xyz) * (isFrontFacing ? 1.f :(NSDictionary *)arg1 -1.f );
#else
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(void (^)(NSDictionary *, NSError *))arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
