...
- (unsigned char)fndef USE_SHADOWONLY
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)uminate(_surface, _lightingContribution);
#endif
#endif
...
- (void)ABLE_SPECULAR
 ...
 /* Error: Ran out of types for this method. */;
- (void)htingContribution.diffuse * diffuseAlbedo;
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(_Bool)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
 ...
 /* Error: Ran out of types for this method. */;
- (void)ion) * _lightingContribution.pbr.albedo;
#else
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(unsigned char)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
 ...
 /* Error: Ran out of types for this method. */;
- (void)ibution.ambient * _surface.ambientOcclusion) * _lightingContribution.pbr.albedo;
#else
        float3 color = (_lightingContribution.ambient * _surface.ambientOcclusion) * _surface.diffuse.rgb;
#endif
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(unsigned long long)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
 ...
 /* Error: Ran out of types for this method. */;
- (void)tingContribution.pbr.albedo, float3(0.0), _surface.metalness);
...
- (void)#ifdef USE_PBR
 ...
 /* Error: Ran out of types for this method. */;
- (void)(_lightingContribution.diffuse);
    #ifdef USE_SPECULAR
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(double)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
...
- (void)lights[LightIndex(lid)]);
 ...
 /* Error: Ran out of types for this method. */;
- (void)htingContribution.add_local_omni(scn_lights[LightIndex(lid)]);
        }
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(struct CGSize)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
...
- (void)ter_offset_count.y & 0xff;
 ...
 /* Error: Ran out of types for this method. */;
- (void)int omni_count = cluster_offset_count.y & 0xff;
        for (int i = 0 ; i < omni_count; ++i, ++lid) {
            _lightingContribution.add_local_omni(scn_lights[LightIndex(lid)]);
        }
...
#endif
#if defined(USE_CLUSTERED_LIGHTING) && defined(DEBUG_CLUSTER_TILE)
    _output.color.rgb = mix(_output.color.rgb, float3(scn:(struct CGImage *)arg1:debugColorForCount(clusterIndex.z).xyz), 0.1f);
    _output.color.rgb = mix(_output.color.rgb, float3(clusterIndex.x & 0x1 ^ clusterIndex.y & 0x1).xyz, 0.01f);
#endif
#ifdef DISABLE_LINEAR_RENDERING
    _output.color.rgb = scn::linear_to_srgb(_output.color.rgb);
 ...
 /* Error: Ran out of types for this method. */;
- (void)olor = float4(float3(_surface.metalness), 1.f); break;
            case 8:(unsigned long long)arg1 _output.color = float4(float3(_surface.ambientOcclusion), 1.f); break;
            default:break;
        }
        return _output;
    #endif
 ...
 /* Error: Ran out of types for this method. */;
- (void)eak;
            case 7:(unsigned long long)arg1 _output.color = float4(float3(_surface.metalness), 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)float4(_surface.diffuse.rgb, 1.f); break;
            case 6:(struct CGSize)arg1 _output.color = float4(float3(_surface.roughness), 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)f, 1.f); break;
            case 4:(unsigned long long)arg1 _output.color = float4(in.uv0, 0.f, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)cn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(struct CGImage *)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)cn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(struct CGColorSpace *)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
 ...
 /* Error: Ran out of types for this method. */;
- (void)sterTexture.read(clusterIndex);
   ...
   _lightingContribution.add_global_probe(u_radianceTexture, scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(_Bool)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:_output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
            case 3:_output.color = float4(_surface.tangent * 0.5f + 0.5f, 1.f); break;
            case 4:_output.color = float4(in.uv0, 0.f, 1.f); break;
            case 5:_output.color = float4(_surface.diffuse.rgb, 1.f); break;
...
- (id)USE_LIGHTING
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)ution.ambient = scn_frame.ambientLightingColor.rgb;
#endif
#ifdef USE_LIGHTING
#ifdef USE_PER_PIXEL_LIGHTING
#ifdef USE_CLUSTERED_LIGHTING
...
- (id);
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGSize)urface.normalTexcoord), USE_NORMAL_TEXTURE_COMPONENT).rg * 2.f - 1.f;
        _surface._normalTS.z = sqrt(1.f - saturate(length_squared(_surface._normalTS.xy)));
#else
        _surface._normalTS = u_normalTexture.sample(u_normalTextureSampler, _surface.normalTexcoord).rgb;
        _surface._normalTS = _surface._normalTS * 2.f - 1.f;
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)f defined(USE_BITANGENT) && (USE_BITANGENT == 2)
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)angent = in.tangent;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGSize)Normal = _surface.geometryNormal;
#endif
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned long long)normalize(in.normal.xyz);
#endif
#else 
 ...
 /* Error: Ran out of types for this method. */;
- (id)u_roughnessTextureSampler, _surface.roughnessTexcoord), USE_ROUGHNESS_TEXTURE_COMPONENT).r;
#else
...
#elif defined(USE_REFLECTIVE_CUBEMAP)
    float3 refl = reflect( _surface.position, _surface.normal );
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(id)arg2:mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
#elif defined(USE_REFLECTIVE_COLOR)
 ...
 /* Error: Ran out of types for this method. */;
- (struct CGColorSpace *)TALNESS_TEXTURE_COMPONENT)
 ...
 /* Error: Ran out of types for this method. */;
- (unsigned char)learCoat, USE_CLEARCOAT_TEXTURE_COMPONENT).r;
#endif
...
- (_Bool);
- (unsigned long long);
- (id)GFNodeClassDescriptionRegistry;
- (unsigned long long);
- (id);
- (unsigned long long);
- (void)MPModelPropertyPlaybackPositionStoreUbiquitousIdentifier;
- (unsigned long long);
- (void);
- (id);
- (void);
...
- (void);
- (void);
- (id)openSession:withOptions:completion: /* Error: Ran out of types for this method. */;
