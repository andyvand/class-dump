...
- (double)AllCases;
- (id);
- (struct __CFArray *).get_global_size.i32;
- (struct __CFDictionary *);
- (_Bool);
- (unsigned char);
- (unsigned char);
...
- (_Bool);
- (int);
- (unsigned char)`Ò8ÓpÓ;
- (unsigned char)er to fire %{public}f seconds from now;
