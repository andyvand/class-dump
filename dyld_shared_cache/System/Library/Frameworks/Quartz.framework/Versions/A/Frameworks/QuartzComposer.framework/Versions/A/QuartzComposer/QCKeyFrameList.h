...
- (void);
- (void);
- (id)LT 0, keep_local INTEGER NOT NULL DEFAULT 0, keep_local_status INTEGER NOT NULL DEFAULT 0);
- (unsigned long long);
- (void)OORD6
    _geometry.texcoords[6] = scn:(_Bool)arg1:barycentric_mix(in.controlPoints[0].texcoord6, in.controlPoints[1].texcoord6, in.controlPoints[2].texcoord6, patchCoord);
#endif
