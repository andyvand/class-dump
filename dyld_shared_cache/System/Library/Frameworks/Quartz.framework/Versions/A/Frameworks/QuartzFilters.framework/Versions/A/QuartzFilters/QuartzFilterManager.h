...
;
+ (id)EqualToPoint(origin, prev) == false;
- (id)----------------------------------------------
...
;
- (_Bool)(osdBuffers.vertexBuffer[vertexId], hullVertex);
}
...
- (id)osdBuffers.patchParamBuffer[patchID],
#endif
		domainCoord);
}

;
- (id)put.patchCoord = OsdInterpolatePatchCoord(UV, patchParam);
