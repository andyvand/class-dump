...
struct CIImageProviderTextureInfoStruct {
...
struct __C3DEffect {
    struct __C3DEntity _field1;
    struct __C3DEffectProfile *_field2[3];
};

struct __C3DEffectCommonProfile {
    struct __C3DEffectProfile _field1;
    int _field2;
    struct __C3DEffectSlot *_field3;
    ...
    unsigned int :1;
    unsigned int :1;
    struct __C3DFXProgram *_field23;
};
...
struct __C3DEngineContext {
    ...
    _Bool _field9;
    struct __C3DCommonProfileProgramTree *_field10;
    struct __CFDictionary *_field11;
    struct _opaque_pthread_mutex_t _field12;
    struct __CFDictionary *_field13;
    struct __C3DObjectPool *_field14;
...
struct __C3DImage {
    ...
    struct CGContext *_field3;
    struct __CFData *_field4;
    unsigned int _field5;
    _Bool _field6;
    _Bool _field7;
    struct C3DVector2 _field8;
    unsigned int _field9;
    int _field10;
    struct __C3DPVRTCInfo *_field11;
    struct __C3DDDSInfo *_field12;
};
...
struct __C3DLight {
    struct __C3DEntity _field1;
    struct __C3DSceneID *_field2;
    struct C3DColor4 _field3;
    int _field4;
    float _field5[6];
    struct C3DColor4 _field6;
    _Bool _field7;
    _Bool _field8;
    float _field9;
    double _field10;
...
struct __C3DLinkableObject {
    struct __CFRuntimeBase _field1;
    struct __C3DLinkableObject *_field2;
    struct __C3DLinkableObject *_field3;
    _Bool _field4;
};

struct __C3DMaterial {
    struct __C3DEntity _field1;
    struct __C3DEffect *_field2;
};
...
struct __C3DMeshElement {
    ...
    unsigned int _field5;
    _Bool _field6;
    struct __C3DMeshSource *_field7;
    struct _SCNVector3 _field8[2];
    unsigned int _field9;
};
...
struct __C3DNode {
    ...
    struct __C3DSceneID *_field4;
    struct __C3DTransforms *_field5;
    float _field6;
    _Bool _field7;
    struct _SCNVector3 _field8[2];
    struct _SCNVector3 _field9[2];
    struct __C3DTransforms *_field10;
    float _field11;
    unsigned int :1;
    unsigned int :1;
    unsigned int :1;
...
struct __C3DRendererContext {
    ...
    struct __C3DTransformsStack *_field4[3];
    struct C3DPlane _field5[6];
    struct __C3DStack *_field6;
    void *_field7;
    _Bool _field8;
    _Bool _field9;
    _Bool _field10;
    ...
    struct C3DColor4 _field19;
    void *_field20;
    long long _field21;
    struct __C3DRendererContextFuncs {
        CDUnknownFunctionPointerType _field1;
        CDUnknownFunctionPointerType _field2;
        CDUnknownFunctionPointerType _field3;
        CDUnknownFunctionPointerType _field4;
    ...
    long long _field28;
    long long _field29;
    struct Stats _field30;
    struct Cache _field31;
};
...
struct __C3DScene {
    ...
    struct __C3DSceneID *_field2;
    struct __C3DNode *_field3;
    struct __C3DAnimationManager *_field4;
    double _field5;
    double _field6;
    double _field7;
    double _field8;
    struct __CFDictionary *_field9;
    struct _SCNVector3 _field10;
    struct __C3DFXDeformerManager *_field11;
    struct _opaque_pthread_mutex_t _field12;
};
...
struct __C3DSkinner {
    struct __C3DEntity _field1;
    struct __C3DSkin *_field2;
    struct __C3DNode *_field3;
    struct __CFArray *_field4;
    struct C3DMatrix4x4 *_field5;
    struct C3DMatrix4x4 *_field6;
    _Bool _field7;
    _Bool _field8;
    _Bool _field9;
    struct _SCNVector4 *_field10;
    _Bool _field11;
    _Bool _field12;
};
...
struct __C3DTexture {
    ...
    struct __C3DRectanglePacker *_field8;
    void *_field9;
};
