...
- (_Bool);
- (void);
- (void)custom samplers given (Max is %d);
- (_Bool)e class;
- (id)float3 vv1 = (cp[1] + cp[3] + cp[9] + cp[11]) * 0.015625 +
...
- (id);
- (unsigned long long)compositionPickerView:draggingEnteredComposition:sender: /* Error: Ran out of types for this method. */;
