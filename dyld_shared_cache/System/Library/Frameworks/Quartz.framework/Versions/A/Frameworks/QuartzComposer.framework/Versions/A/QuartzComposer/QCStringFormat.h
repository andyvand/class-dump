...
+ (id)";
+ (id)PrivateFrameworks/RemoteServiceDiscovery.framework/Versions/A/RemoteServiceDiscovery;
+ (_Bool)/PrivateFrameworks/CMCapture.framework/Versions/A/CMCapture;
+ (_Bool);
- (_Bool);
- (void);
- (_Bool)animation can't be changed to cumulative. To make this animation cumulative first convert it to a CAAnimation, set it to cumulative and convert back to SCNAnimation;
- (id)#else

    #define OSD_FUNCTION_STORAGE_CLASS static inline
    #define OSD_DATA_STORAGE_CLASS static
    #define OSD_OPTIONAL(a) (a)
    #define OSD_OPTIONAL_INIT(a,b) (a ? b :(id)arg1 0)
    #define OSD_OUT
    #define OSD_INOUT
