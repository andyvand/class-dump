...
;
- (id)patch[1], patch[3], patch[2], output);
...
;
- (int)Flag = short3(clip0) + 2*short3(clip1);
#endif
...
;
- (int)4 clipPos = mul(modelViewProjectionMatrix, position);    
    short3 clip0 = short3(clipPos.x < clipPos.w,                    
    clipPos.y < clipPos.w,                    
    clipPos.z < clipPos.w);                   
    short3 clip1 = short3(clipPos.x > -clipPos.w,                   
...
;
- (int)B,GisHighlighted,V_highlighted;
- (id);
- (int);
- (void);
- (int)MPHomeManagerObserverCurrentHomeDidChangeNotification;
- (void);
- (int);
- (int);
- (void);
