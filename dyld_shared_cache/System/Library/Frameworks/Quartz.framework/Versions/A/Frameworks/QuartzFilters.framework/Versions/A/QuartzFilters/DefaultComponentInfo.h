...
- (void)lVertex.clipFlag = short3(clip0) + 2*short3(clip1);
#endif
...
;
- (void)ort3 clip1 = short3(clipPos.x > -clipPos.w,                   
    clipPos.y > -clipPos.w,                   
    clipPos.z > -clipPos.w);                  
...
;
- (id)tions under the Apache License.
//
...
;
- (id)ffiliates, except as required to comply with Section 4(c) of
