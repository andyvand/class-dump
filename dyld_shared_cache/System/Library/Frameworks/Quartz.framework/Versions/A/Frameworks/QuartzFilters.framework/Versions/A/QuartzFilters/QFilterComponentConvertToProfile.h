...
;
- (void)actors.edgeTessellationFactor[3] = tessLevelOuter[3];
    quadFactors.insideTessellationFactor[0] = tessLevelInner[0];
    quadFactors.insideTessellationFactor[1] = tessLevelInner[1];
}
...
;
- (id)the Apache License with the above modification is
...
;
- (id)censed under the Apache License, Version 2.0 (the "Apache License")
