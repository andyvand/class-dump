...
- (id);
- (void);
- (_Bool)node not found:%@ /* Error: Ran out of types for this method. */;
- (id);
- (void);
- (id)@;
- (void);
...
- (void);
- (void)hb;
- (void)n-transition edge must be able to match up with
                        ...
                        thread float4& tessOuterLo, thread float4& tessOuterHi)
{
    ...
    // refinement level of the mesh:(id)arg1 //     min(OSD_MAX_TESS_LEVEL, pow(2, MaximumRefinementLevel-1)
...
- (id);
- (void);
- (id)ed:] passed in nil /* Error: Ran out of types for this method. */;
- (id);
- (void);
- (_Bool)0@ù
× ;
- (void)accessibilityActionDescription: /* Error: Ran out of types for this method. */;
...
- (id)ÿ;
- (void)ibSceneName;
- (void)C3DRectanglePackerGetRectWithSize;
- (void)fView;
- (void)for Core Image provider;
- (double)N36domFx_samplerCUBE_common_complexType18domMipmap_maxlevelE;
- (void)N16domCg_param_type7domEnumE;
- (void)l;
