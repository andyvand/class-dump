...
- (id);
- (void);
- (void)setPrebootMountpoint: /* Error: Ran out of types for this method. */;
- (_Bool)kernel cache override (%@):%@ /* Error: Ran out of types for this method. */;
- (void);
- (id);
- (void);
- (id);
- (void);
- (void);
- (_Bool)BLE item_extra ADD COLUMN data_url TEXT;
- (void);
- (id);
- (void);
- (void)o[1] = OsdComputeTessLevel(OsdTessLevel, OsdProjectionMatrix, OsdModelViewMatrix,c00, c03);
    }
...
- (void)erning;
- (struct CGSize)N23domGl_pipeline_settings15domPolygon_mode7domModeE;
- (void);
