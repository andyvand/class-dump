...
;
- (id)with the above modification is
...
;
- (id)roduce the content of the NOTICE file.
//
...
;
- (_Bool)tchVertex OsdComputePatch(
	float tessLevel,
	float2 domainCoord,
	unsigned patchID,
#if USE_STAGE_IN
