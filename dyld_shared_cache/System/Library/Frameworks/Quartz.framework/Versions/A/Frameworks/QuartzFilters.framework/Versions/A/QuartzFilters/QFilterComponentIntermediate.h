...
;
- (id)e and to reproduce the content of the NOTICE file.
//
...
- (_Bool)er the Apache License, Version 2.0 (the "Apache License")
//   with the following modification; you may not use this file except in
//   compliance with the Apache License and the following modification to it:(int)arg1 //   Section 6. Trademarks. is deleted and replaced with:(int)arg2 //
...
//   You may obtain a copy of the Apache License at
//
//       http:(int)arg3 //www.apache.org/licenses/LICENSE-2.0
//
//   Unless required by applicable law or agreed to in writing, software
//   distributed under the Apache License with the above modification is
//   distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY
	...
	)
{
 ...
 /* Error: Ran out of types for this method. */;
- (_Bool)dGetTessParameterization(domainCoord,
                                           tessOuterLo,
                                           tessOuterHi);
#else
    auto transitionMask = OsdGetPatchTransitionMask(patchParam);
