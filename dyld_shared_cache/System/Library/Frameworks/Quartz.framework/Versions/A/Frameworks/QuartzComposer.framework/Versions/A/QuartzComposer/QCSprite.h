...
+ (int);
+ (_Bool);
+ (id)Frameworks/IOKit.framework/Versions/A/IOKit;
+ (_Bool)/PrivateFrameworks/FTServices.framework/Versions/A/FTServices;
+ (_Bool);
- (_Bool);
- (struct _QCDod *);
- (void);
...
- (void);
- (double);
- (id)Size) elementType identifier[arraySize]
