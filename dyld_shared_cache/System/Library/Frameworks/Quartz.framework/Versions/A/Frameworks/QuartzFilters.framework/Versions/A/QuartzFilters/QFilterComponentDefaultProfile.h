...
;
+ (_Bool)hullVertex.clipFlag = short3(clip0) + 2*short3(clip1);              
#endif
...
;
- (void)sellationFactor[1] = tessLevelInner[1];
}
...
;
- (id)r express or implied. See the Apache License for the specific
...
;
- (id)compliance with the Apache License and the following modification to it://   Section 6. Trademarks. is deleted and replaced with://
