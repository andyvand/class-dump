...
+ (_Bool);
- (void);
- (_Bool)led. __appendRect2D:(id)arg1 uv but not texture;
- (id)// vertex-vertex and edge-vertex refined points along the edges of the
                            ...
                            int3 patchParam, thread float4& tessOuterLo, thread float4& tessOuterHi)
{
    ...
    // PERFOMANCE:(id)arg1 we just need to pick the correct corner points from P, P1, P2
...
- (id);
- (unsigned short);
- (unsigned int)setCanSelectHiddenExtension: /* Error: Ran out of types for this method. */;
- (void)C3DRendererContextBindProgramCommonGL;
