...
- (int);
- (void);
- (_Bool)thUID:(id)arg1 withClass:object with uid %@ exists but is not a morpher /* Error: Ran out of types for this method. */;
- (id)_ARRAY(OSD_OUT float, wP, 4), OSD_TYPE_ARRAY(OSD_OUT float, wDP, 4), OSD_TYPE_ARRAY(OSD_OUT float, wDP2, 4)) {

    // The four uniform cubic B-Spline basis functions evaluated at t:(id)arg1 const float one6th = 1.0f / 6.0f;
