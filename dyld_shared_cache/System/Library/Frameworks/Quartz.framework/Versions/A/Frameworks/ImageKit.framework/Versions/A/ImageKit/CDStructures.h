...
struct IrisListener {
    ...
    struct IONotificationPort *_field3;
    unsigned int _field4;
...
struct __IKImageBrowserLayoutParameter {
    ...
    _Bool _alignLeftForSingleRow;
    _Bool _automaticallyMinimizeRowMargin;
    _Bool _cellsHaveACommonHeightOfInfoSpace;
    int _columnCount;
    float _cellAspectRatio;
    struct CGSize _adjustedMargin;
