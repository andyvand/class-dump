...
;
+ (_Bool)short3 clip1 = short3(clipPos.x > -clipPos.w,                   
    clipPos.y > -clipPos.w,                   
    clipPos.z > -clipPos.w);                  
...
;
- (void)dPu = float3(0,0,0), dPv = float3(0,0,0);
...
;
- (void)float3 P = float3(0,0,0), dPu = float3(0,0,0), dPv = float3(0,0,0);
    float3 N = float3(0,0,0), dNu = float3(0,0,0), dNv = float3(0,0,0);
...
;
- (void)TessellationFactor[3] = tessLevelOuter[3];
    quadFactors.insideTessellationFactor[0] = tessLevelInner[0];
    quadFactors.insideTessellationFactor[1] = tessLevelInner[1];
}
...
;
- (id)ullVertex.clipFlag = short3(clip0) + 2*short3(clip1);
#endif
...
;
- (id)www.apache.org/licenses/LICENSE-2.0
//
...
;
- (id)late<typename PerPatchVertexBezier>
#endif
static OsdPatchVertex OsdComputePatch(
	float tessLevel,
	float2 domainCoord,
...
- (void);
- (void);
- (id)setIsOfflineDownload: /* Error: Ran out of types for this method. */;
- (id);
- (id);
- (void)7;
- (void);
