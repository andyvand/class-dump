...
@interface CNContactCardViewController
{
    ...
    ContactsUI.ContactCardViewWrapper *_cardViewWrapper;
...
@property(retain, nonatomic) ContactsUI.ContactCardViewWrapper *cardViewWrapper; // @synthesize cardViewWrapper=_cardViewWrapper;
