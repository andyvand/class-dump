...
+ (id)<%{public}@:%p> Observed endpoint volumeCapabilities changed to <%{public}@>. Endpoint=<%{public}@> /* Error: Ran out of types for this method. */;
+ (id);
+ (Class);
- (void)lback);
- (id)eForJoining=%d;
