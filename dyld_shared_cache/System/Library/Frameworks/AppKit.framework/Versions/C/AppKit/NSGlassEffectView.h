...
@class MISSING_TYPE, NSColor, NSString, NSViewCornerConfiguration;
...
@interface NSGlassEffectView : NSView
{
    ...
    MISSING_TYPE *_actualCornerRadius;
    MISSING_TYPE *__path;
    MISSING_TYPE *_contentViewConstraints;
    MISSING_TYPE *_contentView;
    MISSING_TYPE *_contentHolderView;
    MISSING_TYPE *_effectsViewIfExists;
    MISSING_TYPE *_enclosingGlassEffectContainerView;
    long long _disableEmbeddingCount;
    MISSING_TYPE *_swiftStorage;
}
