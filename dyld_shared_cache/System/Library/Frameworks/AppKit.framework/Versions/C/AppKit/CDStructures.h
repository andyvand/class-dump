...
struct SLMPopUpMenuContext_t {
    ...
    id _field24;
    id _field25;
    struct OpaqueMenuRef *_field26;
    struct Point _field27;
    _Bool _field28;
    struct Rect _field29;
...
struct _NSSymbolImageRepGeometry {
...
struct vector<NSURLAnnex, std::allocator<NSURLAnnex>> {
...
typedef struct {
    ...
    double normalizedNeutralValue;
    _Bool trackTintedWithValue;
    _Bool hasMinValueIcon;
    _Bool hasMaxValueIcon;
    ...
    _Bool prefersInactiveBezelArt;
    long long semanticContext;
    _Bool hasCustomDrawKnob;
    unsigned long long subviewRenderingMode;
    _Bool hidesKnob;
} CDStruct_6717dab8;
