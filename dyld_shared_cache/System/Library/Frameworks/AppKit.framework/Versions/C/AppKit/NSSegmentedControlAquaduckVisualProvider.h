...
@class MISSING_TYPE, NSArray, NSSegmentedCell, NSSegmentedControlBezelConfiguration, NSView;
...
@interface NSSegmentedControlAquaduckVisualProvider
{
    ...
    MISSING_TYPE *trackingPoint;
    MISSING_TYPE *$__lazy_storage_$_debugDrawFrames;
}
