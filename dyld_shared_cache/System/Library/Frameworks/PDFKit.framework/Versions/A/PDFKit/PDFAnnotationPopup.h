...
- (void);
- (id);
- (id)initWithTokenService:bag: /* Error: Ran out of types for this method. */;
- (void)T;
- (id);
- (void)ing) {
...
- (void);
- (void);
- (id)pdfDocumentDidRemoveAllPagesOrPlaceholders: /* Error: Ran out of types for this method. */;
- (void)_drawAnnotationWithBox:(_Bool)arg1 inContext: /* Error: Ran out of types for this method. */;
- (_Bool)AKStarAnnotation;
