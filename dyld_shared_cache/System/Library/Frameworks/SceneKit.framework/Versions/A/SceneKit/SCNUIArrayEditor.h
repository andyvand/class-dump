...
- (id);
- (void);
- (void)ssIODescriptor}SS}{PassResource=^^{RefCountedResource}^^{RefCountedResource}SS}I{Parameters=CCCCCCCBBB[6]I}BQB^{MainPassCustomPostProcessPassResource}};
- (void)ht.color.rgb, intensity);
    }
