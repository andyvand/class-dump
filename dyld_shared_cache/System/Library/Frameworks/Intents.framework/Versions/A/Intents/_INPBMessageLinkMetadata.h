...
@property(retain, nonatomic) _INPBURLValue *linkURL; // @synthesize linkURL=_linkURL;
...
@property(copy, nonatomic) NSString *openGraphType; // @synthesize openGraphType=_openGraphType;
