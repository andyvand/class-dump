...
- (id);
- (id);
- (void)_itemsForQueryCriteria: /* Error: Ran out of types for this method. */;
- (void)_MPNowPlayingInfoPropertySupportsIsLiked;
- (id)MPModelPropertyPersonHasSocialPosts;
