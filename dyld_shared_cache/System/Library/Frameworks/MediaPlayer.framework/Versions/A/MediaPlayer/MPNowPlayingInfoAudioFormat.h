...
- (id);
- (void);
- (void)PE_ARRAY(OSD_OUT float, wP, 4), OSD_TYPE_ARRAY(OSD_OUT float, wDs, 4), OSD_TYPE_ARRAY(OSD_OUT float, wDt, 4),
...
void OsdComputeTensorProductPatchWeights(float dScale, int boundary,
    ...
    if (OSD_OPTIONAL(wP)) {
        ...
        // corresponding to each control vertex:(long long)arg1 OsdAdjustBoundaryWeights(boundary, sWeights, tWeights);
...
- (id);
- (unsigned int);
- (_Bool)_drawBackgroundForPartRect:(id)arg1 isPressedOrHovered: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void);
- (void);
