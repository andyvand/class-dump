...
@class NSDictionary, NSHashTable, NSMutableDictionary, NSString, TSPObject, TSPReferenceOrderedSet, TSPersistence.TSPMutableIdentifierSet;
...
@interface TSPArchiverBase
{
    ...
    TSPersistence.TSPMutableIdentifierSet *_countedDataReferences;
}
...
- (unsigned long long);
- (id);
- (void)øÙPÚôÚ@ÛÛäÛÜxÜÜÝ8Þ$ß|ß´ßà@ààÐà	áâhâãdã¸ãääPæÀé;
- (long long)e.xbs/TemporaryDirectory.jAwLbJ/Sources/iWorkGenerator/shared/persistence/src/TSPObject.mm;
- (void);

// Remaining properties
@property(readonly, nonatomic) NSDictionary *alternates;
@property(readonly, nonatomic) TSPersistence.TSPMutableIdentifierSet *countedDataReferences; // @synthesize countedDataReferences=_countedDataReferences;
