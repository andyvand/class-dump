...
@class NSDate, NSUUID, TSKAccessController, TSKAnnotationAuthor, TSKAnnotationAuthorStorage, TSKChangeNotifier, TSKDocumentSupport, TSKPasteboardController, TSKSelectionDispatcher, TSKit.TSKSimpleCollaborationSuspensionManager, TSULocale;
...
@interface TSKDocumentRoot
{
    ...
    TSKit.TSKSimpleCollaborationSuspensionManager *_simpleCollaborationSuspensionManager;
    _Bool _isFindActive;
