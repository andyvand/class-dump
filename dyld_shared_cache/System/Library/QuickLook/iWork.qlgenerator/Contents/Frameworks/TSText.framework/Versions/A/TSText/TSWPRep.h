...
@class CALayer, CAShapeLayer, NSArray, NSMutableArray, NSNumber, NSString, NSView, TSDLayout, TSUColor, TSWPSearchReference, TSWPSelection, TSWPStorage, _TtC6TSText22TSWPSecondaryHighlight;
