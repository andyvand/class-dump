...
@class NSAttributedString, NSColor, NSDictionary, NSImage, NSNumberFormatter, NSString, PXExtendedImageConfiguration, PXStoryChromeButtonSpec, PXStoryConcreteLayoutSpec, PXStoryPlayButtonSpec, PXStoryRelatedLayoutMetrics;
...
@property(readonly, nonatomic) struct NSEdgeInsets browseGridLayoutMargins;
...
@property(readonly, nonatomic) struct NSEdgeInsets infoPanelMargins;
@property(readonly, nonatomic) double infoPanelMetadataToMetadataBaselines;
@property(readonly, nonatomic) struct NSEdgeInsets infoPanelPadding;
...
@property(readonly, nonatomic) struct NSEdgeInsets scrubberFadeAreaInsets;
...
@property(readonly, nonatomic) struct NSEdgeInsets tapNavigationAreaInsets;
