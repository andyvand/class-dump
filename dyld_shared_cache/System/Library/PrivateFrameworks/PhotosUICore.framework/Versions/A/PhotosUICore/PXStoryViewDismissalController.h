...
@class NSString, PXGItemPlacement, PXGViewControllerTransition, PXNumberAnimator, PXPointAnimator, PXStoryViewModel, PXSwipeDownTracker, PXUpdater, UXView;
...
@property(retain, nonatomic) UXView *referenceView; // @synthesize referenceView=_referenceView;
