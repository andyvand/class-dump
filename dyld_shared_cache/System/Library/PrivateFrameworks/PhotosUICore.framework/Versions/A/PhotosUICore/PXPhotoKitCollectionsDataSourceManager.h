...
@class NSArray, NSDate, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSOperationQueue, NSPredicate, NSString, PHCollectionList, PHFetchResult, PHPhotoLibrary, PXContentSyndicationConfigurationProvider, PXLibraryFilterState, PXPhotoKitCollectionsDataSource, PXPhotoKitCollectionsDataSourceManagerConfiguration;
@protocol OS_os_log;
