...
@class NSColor, NSDictionary, NSShadow, PXExploreLayoutMetrics, PXStoryChromeButtonSpec, PXStoryDetailsViewButtonSpec;
...
@interface PXStoryConcreteLayoutSpec
{
    ...
    struct NSEdgeInsets _styleSwitcherChromeInset;
    struct NSEdgeInsets _styleSwitcherViewportInset;
    struct NSEdgeInsets _styleSwitcherPageControlInset;
}
...
@property(readonly, nonatomic) struct NSEdgeInsets styleSwitcherChromeInset; // @synthesize styleSwitcherChromeInset=_styleSwitcherChromeInset;
...
@property(readonly, nonatomic) struct NSEdgeInsets styleSwitcherPageControlInset; // @synthesize styleSwitcherPageControlInset=_styleSwitcherPageControlInset;
...
@property(readonly, nonatomic) struct NSEdgeInsets styleSwitcherViewportInset; // @synthesize styleSwitcherViewportInset=_styleSwitcherViewportInset;
