...
@interface PXStoryViewModel
{
    ...
    PXStoryViewPointerVisibilityController *_pointerVisibilityController;
    ...
    id _generativeStoryInWatchNextController;
...
@property(readonly, nonatomic) id generativeStoryInWatchNextController; // @synthesize generativeStoryInWatchNextController=_generativeStoryInWatchNextController;
...
@property(readonly, nonatomic) _Bool pointerOverPlayer; // @synthesize pointerOverPlayer=_pointerOverPlayer;
@property(retain, nonatomic) PXStoryViewPointerVisibilityController *pointerVisibilityController; // @synthesize pointerVisibilityController=_pointerVisibilityController;
