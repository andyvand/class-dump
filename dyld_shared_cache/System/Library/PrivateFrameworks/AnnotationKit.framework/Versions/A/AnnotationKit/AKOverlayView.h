...
- (void);
- (_Bool);
- (void)response from XPC server for message:(id)arg1 %@;
- (id)}@Invalid presence left condition:%@ /* Error: Ran out of types for this method. */;
- (void)~;
- (void);
- (void);
- (_Bool);
...
- (void);
- (_Bool);
- (id)loat3(0,0,0),float3(0,0,0),float3(0,0,0)};
