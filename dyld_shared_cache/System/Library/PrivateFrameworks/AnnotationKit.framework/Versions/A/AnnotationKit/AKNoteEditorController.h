...
@class AKNoteStickyView, AKPopupAnnotation;
...
- (void);
- (id);
- (void)void scn_pbr_lighting(SCNLightingParameters params, thread SCNShaderLightingContribution& lightingContribution)
{
...
static float scn_distance_attenuation(SCNLightingParameters params)
{
    ...
    if (use_pbr) {
        ...
        if (distAttType != kC3DLightAttenuationTypeNone) {
            ...
            float dist = length(l);
            switch (distAttType) {
                case kC3DLightAttenuationTypeConstant:(id)arg1 return step(dist, att.x);
