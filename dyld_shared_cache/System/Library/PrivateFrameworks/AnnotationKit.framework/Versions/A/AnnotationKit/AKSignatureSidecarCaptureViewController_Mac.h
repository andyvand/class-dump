...
@class AKSidecarSignatureRequest, AKSignatureOutputView_Mac;
...
- (id);
- (void);
- (void)paintLineEnd:(id)arg1 atPoint:atAngle:withScale:inContext:useFastDrawing: /* Error: Ran out of types for this method. */;
