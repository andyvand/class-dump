...
- (id);
- (void);
- (double)_mediaSourceDisplayOrder;
- (void);
- (void);
- (void)`;
- (id);
- (void)useHammonTexture, scn_commonprofile.selfIlluminationOcclusion);
...
- (void);
- (void)_newCGImageWithBox:bitmapSize:scale:offset:colorSpace:backgroundColor:withRotation:withAntialiasing:withAnnotations:withBookmark:withOptions:withDelegate: /* Error: Ran out of types for this method. */;
- (id);
- (void)j;
