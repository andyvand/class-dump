...
#endif 
;
- (void)tureTransforms[roughness_transform_index] * float4(uv, 0.f, 1.f)).xy;
    ...
    switch (io_texcoord_count - 1) {
        case 7 :(id)arg1 out.texcoord7 = uvOut[7];
