...
static void scn_do_light(SCNLightingParameters params, thread SCNShaderLightingContribution& lightingContrib)
{
    ...
    switch (lighting_model) {
        case C3DLightingModelLambert:(id)arg1 scn_lambert_lighting(params, lightingContrib);
            break;
...
- (void);
- (void);
- (void)renderingStrokeAlignedRectForRect:(id)arg1 withStrokeWidth:alignToScreenUsingPageController:orAlignToContext:usingAnnotation: /* Error: Ran out of types for this method. */;
- (void)ÿ£¨;ór;
