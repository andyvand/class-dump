...
- (id)(;
- (void);
- (void)urn pow(saturate(dist * att.x + att.y), att.z);
            }
        }
    }
    return 1.f;
...
static float scn_spot_attenuation(SCNLightingParameters params)
{
    ...
    if (spotAttType != kC3DLightAttenuationTypeNone) {
        ...
        switch (spotAttType) {
            case kC3DLightAttenuationTypeConstant:(id)arg1 return step(spotFactors.x, dot(l, lightData.direction));
...
- (void);
- (void);
- (_Bool)didPressReturnOnTableView:(id)arg1;
