...
typeinfo for E5RT::E5RTError;
typeinfo for Espresso::base_kernel;
typeinfo for Espresso::blob_rtti_root;
typeinfo for Espresso::generic_activation_kernel;
typeinfo for Espresso::generic_batchnorm_kernel;
typeinfo for Espresso::generic_convolution_kernel;
typeinfo for Espresso::generic_inner_product_kernel;
typeinfo for Espresso::generic_instancenorm_1d_kernel;
typeinfo for Espresso::generic_pool_kernel;
typeinfo for Espresso::generic_reshape_kernel;
typeinfo for Espresso::generic_self_attention_kernel;
typeinfo for Espresso::generic_softmax_kernel;
typeinfo for Espresso::generic_transpose_kernel;
typeinfo for int;
