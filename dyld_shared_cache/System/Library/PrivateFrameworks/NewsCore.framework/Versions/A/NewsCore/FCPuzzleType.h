...
- (id);
- (id)__DATA_DIRTY;
- (unsigned long long)setBuffer:scaled:cgImageProperties:colorProfile:masterToRasterOrientation:rasterToDisplayOrientation:requestedSubsampleFactor:forKey:invalidationKey:request: /* Error: Ran out of types for this method. */;
- (id)t011, a.z);
...
- (_Bool);
- (id);
- (unsigned long long)of baseline anchor after the bar button item is used isn't implemented;
- (id);
- (id);
- (id);
- (id);
...
- (id);
- (_Bool);
- (id)bundleURLsForModuleAtURL:error: /* Error: Ran out of types for this method. */;
- (_Bool)DRAssetPromisesWithError:] /* Error: Ran out of types for this method. */;
- (void)space on device for %@:(id)arg1 %s;
- (long long);
- (id);
- (_Bool);
- (id);
...
- (_Bool)h;
- (id);
- (id)_ivarQueue_videoPlayerItemRequestID;
- (id)U;
- (_Bool);
- (id)@0:8@16@24@32@?40 /* Error: Ran out of types for this method. */;
- (_Bool)eClass;
- (id);
- (id);
- (id);
...
- (id)executeToolAtPath:withArguments:andCopyPath:usingDeferral:allowSIP: /* Error: Ran out of types for this method. */;
- (id)ser_Daemon"8@"NSDictionary"16;
- (id)to call MDCopySessionBegin(). Disabling further Spotlight operations;
- (id);
- (void);
- (id);
- (struct CGSize);
...
- (id)shape;
- (id)setNewspaperGroupMagazineFeedHeadlineScoringOutputName: /* Error: Ran out of types for this method. */;
- (id)setBiases: /* Error: Ran out of types for this method. */;
- (id)_resultInterestTokens;
- (id)_maxNativeAdCountIPhoneGreatStoriesYouMissed;
- (id)_lowQualityFilterShouldIsolateEvergreenItems;
- (_Bool)_imageURL3x;
- (id)initWithApplicationProxy:queue: /* Error: Ran out of types for this method. */;
- (id)ÿÿÿÿX;
...
- (double)TorTSoRzUT7uF3miBt8NIcw;
- (_Bool);
- (_Bool);
- (id)dWÀÿ;
- (id)j±;
