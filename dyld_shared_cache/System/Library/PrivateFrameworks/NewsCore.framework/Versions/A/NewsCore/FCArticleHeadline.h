...
- (void);
- (id);
- (_Bool)PAImageResponseInternal;
- (long long)GL_TEXTURE_RECTANGLE_ARB;
- (unsigned long long)apertureRedEye;
- (_Bool);
- (_Bool);
- (id);
- (_Bool);
- (id);
- (id)sampler src, vec4 bv) __attribute__ ((preserves_opacity)) 
{
    vec4 t = unpremultiply(sample(src, samplerCoord(src))); 
    return premultiply(t + bv); 
}

kernel vec4 biasGamutMap (sampler src, vec4 bv) __attribute__ ((preserves_opacity)) 
{
    vec4 t = unpremultiply(sample(src, samplerCoord(src))); 
    t += bv; 
	 float lum = dot(max(t.rgb, vec3(0.0)), vec3(1.0 / 3.0));	// target luminance, >= 0  
	 float tmin = min(min(t.r, t.g), t.b); 
...
- (_Bool);
- (id);
- (id)_internalAccessoryView;
- (id);
- (id);
- (void);
- (id);
- (void);
- (id)NSMutableArray",&,N,V_includeImprovers;
- (double)waypoint for location %@;
- (id);
- (_Bool);
- (id);
- (_Bool);
...
- (id)2;
- (id)7;
- (id)initWithName:client:transferPath:diskSpaceNeeded:location: /* Error: Ran out of types for this method. */;
- (id);
- (_Bool)ateSymbolicLinkAtURL:withDestinationURL:error:] /* Error: Ran out of types for this method. */;
- (long long)e platform.;
- (void);
- (void);
- (id)latencyGoalsForSignpostInterval:(id)arg1;
- (void);
- (id);
- (id)formingChanges;
- (_Bool);
- (void);
- (_Bool)localeifyIfNeeded: /* Error: Ran out of types for this method. */;
- (id);
- (id)retainCount;
- (id)outOfBandUpdateFilesFromReceipts;
- (void)iskID		:(id)arg1 %@
Is Final Selected System:%d
Is latest Backup	:%d
Backups			:%@ /* Error: Ran out of types for this method. */;
- (void)dsAttrTypeStandard:(_Bool)arg1 CopyTimestamp;
- (id)y/;
- (long long);
- (double);
- (id);
...
- (int);
- (id)cannotCreateExpressionFromAny;
- (void)¬ÃÿO;
- (id)ë½ÿQ;
- (id)13AsyncIteratorSciQz;
- (void)ÿLÓ·ÿ;
- (id);
- (id)Ì;
- (id)§`ä;
