...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, SFAppEntityAnnotation, SFButtonItem, SFCard, SFColor, SFCommand, SFCopyItem, SFUserReportRequest;

@interface RFBinaryButtonCardSection : SFCardSection
{
    SFButtonItem *_primary_button;
    SFButtonItem *_secondary_button;
}
...
@property(retain, nonatomic) SFButtonItem *secondary_button; // @synthesize secondary_button=_secondary_button;
