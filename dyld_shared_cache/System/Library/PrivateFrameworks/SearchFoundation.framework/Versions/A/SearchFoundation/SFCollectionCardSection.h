...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, SFAppEntityAnnotation, SFCard, SFCollectionStyle, SFColor, SFCommand, SFCommandButtonItem, SFCopyItem, SFRichText, SFUserReportRequest;

@interface SFCollectionCardSection : SFCardSection
{
    NSString *_type;
...
@property(retain, nonatomic) SFCommandButtonItem *titleButtonItem; // @synthesize titleButtonItem=_titleButtonItem;
