...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, RFTextProperty, SFAppEntityAnnotation, SFButtonItem, SFCard, SFColor, SFCommand, SFCopyItem, SFUserReportRequest;
...
@property(retain, nonatomic) SFButtonItem *player; // @synthesize player=_player;
