...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, SFAppEntityAnnotation, SFCard, SFColor, SFCommand, SFCopyItem, SFFlight, SFUserReportRequest;

@interface SFFlightCardSection : SFCardSection
{
    struct {
