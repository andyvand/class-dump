...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, RFVisualProperty, SFAppEntityAnnotation, SFCard, SFColor, SFCommand, SFCopyItem, SFUserReportRequest;
