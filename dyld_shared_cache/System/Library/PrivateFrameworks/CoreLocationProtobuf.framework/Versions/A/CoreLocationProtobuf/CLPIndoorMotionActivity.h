...
- (_Bool);
- (void);
- (void)ownloadsFolderInParent:(id)arg1 completion:]_block_invoke /* Error: Ran out of types for this method. */;
- (void);
- (id);
- (id);
- (void);
