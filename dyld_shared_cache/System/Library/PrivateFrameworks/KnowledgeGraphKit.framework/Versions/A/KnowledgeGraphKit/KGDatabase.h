...
- (id);
- (id);
- (id)=^{TFENode}^{TFENode}{?=^{TFENode}}}16@0:(id)arg1 8;
- (id)initWithActiveKeys:(id)arg1;
- (void)D33;
- (id);
- (id){public}@;
- (struct AttributeValueCursor)folder;
- (id);
- (_Bool);
- (struct AttributeValueCursor);
- (id)olumnViewController initCommon]E4$_18;
- (id)ZL10MakeSharedI22TEnableObserverAdaptorI13TNodeObserver13TRenameActionEJEENSt3__110shared_ptrIT_EEDpOT0_E19MakeInstanceEnabler;
- (id);
- (id);
- (_Bool)KzoM;
- (unsigned long long);
...
- (int);
- (id);
- (unsigned long long)_connectionKey;
- (id)eAuthenticationWithCompletion:(id)arg1 ];
- (unsigned long long);
- (struct AttributeValueCursor);
- (struct AttributeValueCursor);
- (id);
...
- (void);
- (unsigned long long);
- (id)enumerateNeighborNodesThroughEdgesOfType:(const void *)arg1 withLabel:(id)arg2 inDomain:(id)arg3 usingBlock:(_Bool)arg4;
- (void)ÿÿÿÿÀ;
