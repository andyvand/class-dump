...
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation; // @synthesize dictionaryRepresentation;
...
@property(copy, nonatomic) NSString *instanceIdentifier; // @synthesize instanceIdentifier;
@property(readonly, nonatomic) NSData *jsonData; // @synthesize jsonData;
...
@property(copy, nonatomic) NSString *typeIdentifier; // @synthesize typeIdentifier;
