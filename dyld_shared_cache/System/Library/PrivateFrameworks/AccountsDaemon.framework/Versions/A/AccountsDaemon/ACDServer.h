...
@property(retain, nonatomic) _TtC14AccountsDaemon35ACDAsyncAuthenticationPluginManager *asyncAuthenticationPluginManager; // @synthesize asyncAuthenticationPluginManager=_asyncAuthenticationPluginManager;
