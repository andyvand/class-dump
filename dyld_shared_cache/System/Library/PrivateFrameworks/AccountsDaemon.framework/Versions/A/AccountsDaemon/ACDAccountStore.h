...
@class ACDAccessPluginManager, ACDAccountNotifier, ACDAuthenticationDialogManager, ACDAuthenticationPluginManager, ACDClient, ACDClientAuthorizationManager, ACDDatabaseBackupActivity, ACDDatabaseConnection, ACDDataclassOwnersManager, ACDFakeRemoteAccountStoreSession, ACRemoteDeviceProxy, AccountsDaemon.ACDAsyncAuthenticationPluginManager, NSMutableArray, NSString;
...
@property(retain) AccountsDaemon.ACDAsyncAuthenticationPluginManager *asyncAuthenticationPluginManager; // @synthesize asyncAuthenticationPluginManager=_asyncAuthenticationPluginManager;
