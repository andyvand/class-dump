...
@class NSArray, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject, NSTimer, SafariCore.WBSAuthenticationServicesAgentMonitor, SafariCore.WBSPasskeyStore, WBSAuthenticationServicesAgentProxy, WBSAutoFillQuirksManager, WBSDiagnosticStateCollector, WBSKeychainCredentialNotificationMonitor, WBSSavedAccountKeychainCoordinator;
...
@interface WBSSavedAccountStore
{
    ...
    SafariCore.WBSAuthenticationServicesAgentMonitor *_authenticationServicesAgentMonitor;
    ...
    SafariCore.WBSPasskeyStore *_passkeyStore;
}
