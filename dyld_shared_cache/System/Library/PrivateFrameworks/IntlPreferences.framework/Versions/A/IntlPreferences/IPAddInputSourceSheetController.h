...
+ (void)autorelease;
+ (void)autoSwitchToFreeCamera;
+ (id);
- (id)contextWithCGLContext:(id)arg1 pixelFormat:colorSpace:options: /* Error: Ran out of types for this method. */;
- (void)contactTestWithBody:options: /* Error: Ran out of types for this method. */;
- (void)contactTestBetweenBody:andBody:options: /* Error: Ran out of types for this method. */;
- (void)contactPoint;
- (void)text: /* Error: Ran out of types for this method. */;
- (id)connect:to:format: /* Error: Ran out of types for this method. */;
- (void)componentsSeparatedByCharactersInSet:(id)arg1;
- (void)tion:(id)arg1 sourceColorSpace:destinationColorSpace:renderContext: /* Error: Ran out of types for this method. */;
- (void)lBufferColorPrimaries:(id)arg1 pixelBufferTransferFunction:sourceTextureY:sourceTextureCbCr:sourceColorSpace:destinationColorSpace:destinationTexture:renderContext: /* Error: Ran out of types for this method. */;
...
- (void)color4;
- (void)ame:(id)arg1 sourceCodeBlock:additionalFileBlock: /* Error: Ran out of types for this method. */;
- (void)collectShaderForProgram:(id)arg1 hashCode:newVertexFunctionName:newFragmentFunctionName:sourceCodeBlock:additionalFileBlock: /* Error: Ran out of types for this method. */;
- (void)collectOverrides;
- (void)clearColor;
- (void)clearCaches;
- (void)childNodesPassingTest:(id)arg1;
- (void)chainRootNode;
- (void)captureDeviceOutputConsumerWithOptions:(id)arg1;
- (id)buildTessellationVertexDescriptorIfNeeded;
- (id)baseGeometryBindTransform;
- (id)barycentricCoordsSupported;
...
- (id)authoringEnvironment:didMoveItems:fromTransform: /* Error: Ran out of types for this method. */;
- (id)authoringEnvironment:didCloneSelection: /* Error: Ran out of types for this method. */;
- (id)archivedDataWithRootObject:options: /* Error: Ran out of types for this method. */;
- (void)affectedByGravity;
- (void)adjustViewportForRendering:(id)arg1;
- (void)addNormalsWithAttributeNamed:(id)arg1 creaseThreshold:(id)arg2;
- (id)_vignettingIntensity;
- (void)_vectorCount;
- (void)_usesSpecificMainPassClearColorForRenderer:(id)arg1 clearColor: /* Error: Ran out of types for this method. */;
- (void)_IN_TEXCOORD2
...
inline float4 colorFromMask(float4 col, int mask)
{
    switch (mask) {
        ...
        case kC3DColorMaskRed:(id)arg1 return col.r;
