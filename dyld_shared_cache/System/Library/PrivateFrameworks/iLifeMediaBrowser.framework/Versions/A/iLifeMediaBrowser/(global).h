...
auto ILMBPMRRunLoopReporter_callback(__CFRunLoopObserver*, unsigned long, void*);
auto ensurePathExists(NSString*);
auto ilmbpmrContext_cppInstrument(__CFString const*);
auto ilmbpmrContext_cppInstrument(__CFString const*)::fallbackInstrument;
gContextLock;
