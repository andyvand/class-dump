...
@class CompletionWindow, NSCache, NSDictionary, NSMutableSet, NSString, NSView, WBSFaviconRequestsController, _TtC6Safari38CompletionListCollectionViewController;
...
@interface UnifiedFieldCompletionControllerObjCAdapter
{
    ...
    _TtC6Safari38CompletionListCollectionViewController *_collectionViewController;
}
...
@property(readonly, nonatomic) _TtC6Safari38CompletionListCollectionViewController *collectionViewController; // @synthesize collectionViewController=_collectionViewController;
