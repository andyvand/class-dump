...
@class CKDProcessScopedClientProxy, NSDate, NSHashTable, NSMutableDictionary, NSOperationQueue, NSString, NSXPCConnection, _TtC14CloudKitDaemon35CKDAdopterProcessScopedStateManager;
...
@interface CKDXPCConnection
{
    ...
    _TtC14CloudKitDaemon35CKDAdopterProcessScopedStateManager *_adopterProcessScopedStateManager;
...
@property(retain, nonatomic) _TtC14CloudKitDaemon35CKDAdopterProcessScopedStateManager *adopterProcessScopedStateManager; // @synthesize adopterProcessScopedStateManager=_adopterProcessScopedStateManager;
