...
- (void)";
- (_Bool);
- (id)ishResource(FigEndpointExtendedRef, CFStringRef, CFTypeRef);
- (id);
- (void);
- (void);
- (_Bool);
...
- (unsigned long long);
- (void);
- (void)em_authorizedContactStore;
- (void)trialRolloutDeploymentID;
- (void);
- (_Bool);
- (_Bool);
- (id);
...
- (_Bool);
- (void);
- (void)4a:f0:49:6e:8a:35:4a:4f:47:bb:3e:ea:cc:df:2e:f4:b8:96:16:94:dd:38:f6:f0:82:cf:26:fd:67:a1:73:01:43:d8:25:bd:02:2c:82:89:7c:70:01:68:c2:8a:85:60:84:77:83
