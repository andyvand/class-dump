...
- (void);
- (void);
- (void)"auroraFactor"f"edrHeadroom"f"colorAdaptationStrength"f"colorAdaptationMode"i"darkThemeApplied"B"landscapeOrientation"B"aabMultiModeEnabled"B"aabMode"i"edrHeadroomRequest"f}]};
- (void);
- (id);
...
- (void);
- (void);
- (long long)save_args:lvf_validate_new_properties returned %d
