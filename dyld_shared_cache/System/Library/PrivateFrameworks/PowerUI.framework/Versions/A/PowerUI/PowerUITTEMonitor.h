...
@class NSObject, NSUUID, NSUserDefaults;
@protocol OS_os_log, _CDLocalContext;

@interface PowerUITTEMonitor
{
    long long __tteMonitorStatus;
    NSUserDefaults *_defaults;
    id <_CDLocalContext> _context;
    NSObject<OS_os_log> *_log;
    NSUUID *_tteSessionID;
}
