...
- (_Bool);
- (id);
- (id)/System/Library/PrivateFrameworks/UserActivity.framework/Versions/A/UserActivity;
- (void)rtex commonprofile_io standard_vert(scn_vertex_t                      in                        [[ stage_in ]],
...
- (id);
- (void);
- (void)exportSessionWithAsset:(id)arg1 presetName: /* Error: Ran out of types for this method. */;
- (id);
- (id)lic}@;
