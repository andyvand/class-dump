...
- (_Bool);
- (void);
- (id)I^{__CFArray}}]^{__C3DArray}I^{__CFDictionary}}16@0:8 /* Error: Ran out of types for this method. */;
- (void)_texcoord_io_index))
...
- (id);
- (id)_virtualCardDataFromPKVirtualCards: /* Error: Ran out of types for this method. */;
- (id)e to receiving a push notification.;
- (id);
- (struct CGSize);
- (unsigned int);
- (struct CGRect)descriptionTag;
- (struct CGPoint)odle;
- (void);
- (id);
- (_Bool);
