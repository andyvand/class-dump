...
+ (id)PECULAR_COLOR)
    ...
    _surface.reflective = u_reflectiveTexture.sample(u_reflectiveTextureSampler, scn:(long long)arg2:(id)arg3 mat4_mult_float3(scn_frame.viewToCubeTransform, refl)); 
#ifdef USE_REFLECTIVE_INTENSITY
    _surface.reflective *= scn_commonprofile.reflectiveIntensity;
#endif
