...
+ (id);
- (id);
- (id)s = colorFromMask(u_clearCoatRoughnessTexture.sample(u_clearCoatRoughnessTextureSampler, _surface.clearCoatRoughnessTexcoord), USE_CLEARCOATROUGHNESS_TEXTURE_COMPONENT).r;
#else
...
- (void);
- (void);
- (void)setSharedActivityGroupSizeCurrent:(id)arg1;
- (struct os_unfair_lock_s)preferredMediaUser;
- (void)ô/;
- (void)ICDefaultsKeyDebugFetchConfiguration;
- (id)ices were lost;
- (id)FairPlayContextCreationFailed;
- (void);
