...
@class ICStoreURLRequest, NSString;
                            ...
                            int3 patchParam, thread float4& tessOuterLo, thread float4& tessOuterHi)
{
    ...
    // PERFOMANCE:(CDUnknownBlockType)arg2 we just need to pick the correct corner points from P, P1, P2
...
- (id);
- (id);
- (void)_allowsDocumentChangesIndicator;
- (id);
...
- (void);
- (id);
- (void)ICDelegationProviderServiceProtocolHandler;
- (id);
