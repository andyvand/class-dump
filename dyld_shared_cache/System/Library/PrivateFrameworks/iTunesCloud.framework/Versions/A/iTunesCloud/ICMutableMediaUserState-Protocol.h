...
@class ICMusicUserState, ICTVUserState, NSArray, NSString;

@protocol ICMutableMediaUserState
- (void);
- (ICMusicUserState *)st float4x4 OsdProjectionMatrix, const float4x4 OsdModelViewMatrix,
...
- (void);
- (ICTVUserState *)PagesAdded"B"pagesRemoved"B"pagesExchanged"B};
- (NSArray *)per node. Using the first and skipping the others;
- (void)_֠;
- (NSString *)ontroller;
- (NSString *)L$;
