...
+ (_Bool);
- (_Bool)3;
- (id)unarchive scene at %@ - unknown decoded object class (%@);
- (id)), function_constant(use_gobo0) ]]
...
- (id);
- (id);
- (void)_postAnnotationHitNotification: /* Error: Ran out of types for this method. */;
- (void)0:(id)arg1 8Q16Q24i32;
- (_Bool));
- (id)e;
- (void)N34domFx_sampler3D_common_complexType18domMipmap_maxlevelE;
- (id);
- (void);
- (_Bool);
- (id);
