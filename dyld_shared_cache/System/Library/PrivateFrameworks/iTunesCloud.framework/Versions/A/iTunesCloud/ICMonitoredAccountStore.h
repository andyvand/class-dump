...
- (id);
- (id);
- (id)softwareUpdateManager:(id *)arg1 didReceiveRequestToFetchUpdateWithCompletionHandler: /* Error: Ran out of types for this method. */;
- (void);
- (id)rd;     
    float4 diffuse;             
