...
- (id);
- (id);
- (_Bool)SD_PRIMVAR_INTERPOLATION_MODE_FACE_VARYING)
...
#endif 
;
- (id)ts  = light.parameters.probe.parallaxExtents;
...
- (void)em setParticleBounce:(_Bool)arg1 ];
- (void);
- (long long);
- (double);
- (id);
...
- (long long)!Ð1Â0@ù
× ;
- (void)setShouldDownloadResources:(id)arg1;
- (void)setCalloutQueue:(id)arg1;
- (id)_isPhoneNumberAccessRestricted;
