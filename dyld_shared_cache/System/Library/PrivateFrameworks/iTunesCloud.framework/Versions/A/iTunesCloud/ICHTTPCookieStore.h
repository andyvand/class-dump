...
+ (id)ansformation:%@ /* Error: Ran out of types for this method. */;
- (_Bool);
- (void);
- (id);
- (id)DFG.r + DFG.g);
...
inline float4 illuminate(SCNShaderSurface surface, SCNShaderLightingContribution lighting)
{
    ...
    if (use_specular || use_reflective) {
        float3 S = (use_specular) ? lighting.specular :(id)arg1 float3(0.);
        if (use_reflective)
...
- (void);
- (id);
- (id)9daeTArrayI11daeSmartRefI23domInstance_force_fieldEE;
- (_Bool);
- (id);
- (id);
- (id)shouldForceServerToUseDAAPDebugFeatureAlwaysBackoff;
