...
- (void), scn_frame.viewToCubeTransform, scn_frame.environmentIntensity);
    ...
    #if DEBUG_PIXEL
        switch (DEBUG_PIXEL) {
            case 1:(NSData *)arg1 _output.color = float4(_surface.normal * 0.5f + 0.5f, 1.f); break;
            case 2:(int)arg2 _output.color = float4(_surface.geometryNormal * 0.5f + 0.5f, 1.f); break;
...
- (void)allowLowAffinityRecommendations;
- (int)JËJº8m­hÈ;
@end
