...
- (void)peSpot) {
    ...
    switch (lighting_model) {
        case C3DLightingModelLambert:(_Bool)arg1 scn_lambert_lighting(params, lightingContrib);
            break;
...
- (void)or"
    ...
    "SceneKit-CI-nodetree-depth" :(id)arg1 {
      "type" :"depth"
    }
  }
} /* Error: Ran out of types for this method. */;
- (void)_C3DParametricGeometryCreateCacheHash_not_thread_safe;
- (void)E;
- (void);
- (void);
- (void);
