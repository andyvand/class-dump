...
- (unsigned long long);
- (int);
- (_Bool)C3DImage}^v^{__C3DImageProxy}^{__C3DTexture}^v)b8b1b1b1b4c^{__C3DTextureSampler}^(C3DMatrix4x4)fi^v}20@0:8B16 /* Error: Ran out of types for this method. */;
- (void)newAccelerationStructureWithSize:(int)arg1;
- (id)_deindexedToFirstDeindexedTableBufferIndexSize;
- (void)use_normal_intensity)
...
__DoFragmentModifier__
 ...
 /* Error: Ran out of types for this method. */;
- (int)*= scn_commonprofile.displacementIntensity;
...
- (int);
- (id);
- (void)beginFindString:(_Bool)arg1 withOptions: /* Error: Ran out of types for this method. */;
- (_Bool);
- (_Bool);
- (_Bool)setTriggerPatch: /* Error: Ran out of types for this method. */;
- (void);
- (void);
- (void)hes/com.apple.xbs/TemporaryDirectory.A4b0Lc/Sources/QuartzComposer/MeshKit/sources/Core3DKit/classes/SCNAnimation.m;
- (void)esources;
- (void);
- (_Bool)uT;
- (int);
...
- (_Bool)r",W,V_lastPageControllerWithCropRollover;
- (id);
- (_Bool);
- (_Bool);
- (void);
