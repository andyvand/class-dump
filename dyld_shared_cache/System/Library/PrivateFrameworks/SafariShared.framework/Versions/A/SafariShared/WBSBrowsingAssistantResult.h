...
@class NSArray, NSString, NSURL, SFSearchResult;

@interface WBSBrowsingAssistantResult
{
    _Bool _tableOfContentsAvailable;
...
@property(readonly, nonatomic) NSString *disclaimerText; // @synthesize disclaimerText=_disclaimerText;
@property(readonly, nonatomic) NSArray *entityResults; // @synthesize entityResults=_entityResults;
...
@property(nonatomic) long long remoteContentState; // @synthesize remoteContentState=_remoteContentState;
@property(readonly, nonatomic) SFSearchResult *summaryResult; // @synthesize summaryResult=_summaryResult;
@property(readonly, nonatomic) NSString *summaryText; // @synthesize summaryText=_summaryText;
@property(nonatomic) _Bool tableOfContentsAvailable; // @synthesize tableOfContentsAvailable=_tableOfContentsAvailable;
@property(readonly, copy, nonatomic) NSArray *tableOfContentsPaths; // @synthesize tableOfContentsPaths=_tableOfContentsPaths;
@property(readonly, copy, nonatomic) NSArray *tableOfContentsTitles; // @synthesize tableOfContentsTitles=_tableOfContentsTitles;
@property(readonly, copy, nonatomic) NSArray *tableOfContentsTrailingText; // @synthesize tableOfContentsTrailingText=_tableOfContentsTrailingText;
@property(readonly, nonatomic) int tableOfContentsType; // @synthesize tableOfContentsType=_tableOfContentsType;
