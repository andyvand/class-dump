...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject, NSString, _TtC12TextToSpeech15CoreSynthesizer;
...
@interface TTSSpeechSynthesizer
{
    ...
    _TtC12TextToSpeech15CoreSynthesizer *_coreSynth;
}
...
@property(retain, nonatomic) _TtC12TextToSpeech15CoreSynthesizer *coreSynth; // @synthesize coreSynth=_coreSynth;
