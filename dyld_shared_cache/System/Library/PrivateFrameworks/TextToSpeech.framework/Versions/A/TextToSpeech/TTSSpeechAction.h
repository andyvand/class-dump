...
@class AVSpeechUtterance, AXCVoiceSelection, NSAttributedString, NSMutableArray, NSString, _TtC12TextToSpeech10TaggedSSML;
...
@property(retain, nonatomic) _TtC12TextToSpeech10TaggedSSML *taggedSSML; // @synthesize taggedSSML=_taggedSSML;
