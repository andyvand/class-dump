...
@protocol NSObject
- (id);
- (_Bool)ed(USE_TANGENT) || defined(USE_BITANGENT) || defined(USE_INSTANCING)
...
@optional
- (NSString *)appendBezierPath:fromSegment:t:toSegment:t:withoutMove: /* Error: Ran out of types for this method. */;
