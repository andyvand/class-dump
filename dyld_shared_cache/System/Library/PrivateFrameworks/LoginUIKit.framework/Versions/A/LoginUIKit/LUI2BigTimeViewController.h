...
@class LUI2VibrancyEffectView, LUIClockSettings, NSDateFormatter, NSTextField, NSView, _TtC10LoginUIKit17LUI2GlassTextView;
...
@interface LUI2BigTimeViewController : LUI2ViewController
{
    ...
    _TtC10LoginUIKit17LUI2GlassTextView *_glassTextView;
}
...
@property(retain) _TtC10LoginUIKit17LUI2GlassTextView *glassTextView; // @synthesize glassTextView=_glassTextView;
