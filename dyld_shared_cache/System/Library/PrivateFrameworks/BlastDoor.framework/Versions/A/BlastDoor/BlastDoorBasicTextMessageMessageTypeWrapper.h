...
@class BlastDoorBasicAudioMessage, BlastDoorBasicEmojiTapback, BlastDoorBasicMessage, BlastDoorBasicTapBack, BlastDoorBasicTypingIndicator, BlastDoorUnsupportedMessage, MISSING_TYPE, NSString;

@interface BlastDoorBasicTextMessageMessageTypeWrapper
{
    MISSING_TYPE *basicTextMessage_MessageType;
}
