...
@class BlastDoorRelayGroupDisplayNameMutationEnvelope, BlastDoorRelayGroupParticipantMutationEnvelope, MISSING_TYPE, NSString;

@interface BlastDoorRelayGroupMutationWrapper
{
    MISSING_TYPE *relayGroupMutation;
}
