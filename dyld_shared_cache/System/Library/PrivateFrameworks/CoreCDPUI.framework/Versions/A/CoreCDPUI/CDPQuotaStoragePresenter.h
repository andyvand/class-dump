...
@class CDPContext, NSWindow, QuotaStorageViewHandler, _TtC9CoreCDPUI21QuotaStorageViewModel;
...
@interface CDPQuotaStoragePresenter
{
    ...
    _TtC9CoreCDPUI21QuotaStorageViewModel *_quotaStorageViewModel;
}
...
@property(readonly) _TtC9CoreCDPUI21QuotaStorageViewModel *quotaStorageViewModel; // @synthesize quotaStorageViewModel=_quotaStorageViewModel;
