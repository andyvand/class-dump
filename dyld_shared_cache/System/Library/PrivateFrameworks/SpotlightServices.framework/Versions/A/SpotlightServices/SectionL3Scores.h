...
+ (float)setAllowsGroupBlending:(float)arg1;
+ (void)forceDarkLuminanceThreshold;
+ (void)fontDescriptor;
- (void);
- (float);
- (float);
- (float);
- (id)tationTransformer"16;
- (_Bool)setNavigationDelegate:(id)arg1;
- (void);
- (float)shouldSendSegmentRequest:ignoreTimestamps: /* Error: Ran out of types for this method. */;
- (void);
- (float);
- (id);
- (id);
