...
- (void);
- (id);
- (void)sportType: /* Error: Ran out of types for this method. */;
...
@property(copy, nonatomic) NSString *leftBarButton; // @synthesize leftBarButton=_leftBarButton;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,C,N,V_leftBarButton
