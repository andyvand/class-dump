...
@class NSArray, NSAttributedString, NSImage, NSString, NSView, OBTemplatePartBulletList, OBTemplateView, SiriUI.LoopedVideoPlayerView, SiriUIBuddyController;

__attribute__((visibility("hidden")))
@interface SiriUIBuddyVoiceTriggerIntroController
{
    _Bool _showingCompactTrigger;
    SiriUI.LoopedVideoPlayerView *_talkPlayerView;
    SiriUI.LoopedVideoPlayerView *_typePlayerView;
