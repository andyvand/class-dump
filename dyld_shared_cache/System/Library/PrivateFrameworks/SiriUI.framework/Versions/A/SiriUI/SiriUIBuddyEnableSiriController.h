...
@class CALayer, CAStateController, NSArray, NSAttributedString, NSButton, NSImage, NSString, NSView, OBTemplateView, SiriUIBuddyController, _TtC6SiriUI21LoopedVideoPlayerView;
