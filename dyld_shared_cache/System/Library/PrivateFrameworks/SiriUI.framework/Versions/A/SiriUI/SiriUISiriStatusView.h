...
@class AVPlayerLooper, AVQueuePlayer, NSColor, NSLayoutConstraint, NSMutableArray, NSPressGestureRecognizer, NSString, SRFLockStateNotifier, SiriSharedUINotificationCenterPlatterView, SiriSharedUISpinningActivityIndicator, SiriUIEdgeLightWindow, SiriUIOrbView, SiriUIRequestHandlingStatusView, SiriUITalkGestureTarget, SiriUITextInputField, _TtC6SiriUI21SiriUICloseButtonView, _TtC6SiriUI26SiriUITalkToSiriButtonView, _TtC6SiriUI29SiriUIReportConcernButtonView, _TtC6SiriUI30SiriUISiriIconToggleButtonView, _TtC6SiriUI48SiriUISystemAssistantExperienceAnimationExecutor;
...
@interface SiriUISiriStatusView
{
    ...
    _TtC6SiriUI30SiriUISiriIconToggleButtonView *_siriIconToggleButton;
    ...
    _TtC6SiriUI21SiriUICloseButtonView *_closeButtonView;
...
@property(retain) _TtC6SiriUI21SiriUICloseButtonView *closeButtonView; // @synthesize closeButtonView=_closeButtonView;
