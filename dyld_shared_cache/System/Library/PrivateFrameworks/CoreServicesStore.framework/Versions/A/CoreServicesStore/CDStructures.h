...
struct AttributedStringWriter {
    CDUnknownFunctionPointerType *_vptr$AttributedStringWriter;
    unsigned long long _reserved[30];
    struct Impl *_impl;
};

struct CSStoreAccessContextInterface;
...
struct Store {
    ...
    CDUnknownBlockType unitIdentifierExhaustionHandler;
    struct {
...
struct optional<CSStore2::AttributedStringWriter> {
    union {
        char __null_state_;
        struct AttributedStringWriter __val_;
    } ;
    _Bool __engaged_;
};
