...
- (int);
- (unsigned long long);
- (_Bool)_makeManagedObjectContextWithConcurrencyType: /* Error: Ran out of types for this method. */;
...
- (void);
- (void)P;
- (void)_secondPassHasMadeDecision;
- (id);
- (unsigned long long);
- (_Bool);
- (_Bool)P;
...
- (id)hasDisplayNameOverride;
- (id)GEOStorageResumeRouteHandle;
