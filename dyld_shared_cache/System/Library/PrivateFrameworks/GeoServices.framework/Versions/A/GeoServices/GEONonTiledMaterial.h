...
+ (_Bool)setHasUpdateVersion:(id)arg1;
- (void);
- (id);
- (id);
- (void)emissionModelScore;
- (void)SpeechController audioSessionProvider:(id)arg1 providerInvalidated:]_block_invoke_2 /* Error: Ran out of types for this method. */;
- (unsigned long long);
- (_Bool);
- (_Bool);
- (void);
