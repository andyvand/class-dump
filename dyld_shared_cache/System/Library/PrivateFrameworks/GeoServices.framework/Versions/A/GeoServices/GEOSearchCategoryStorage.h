...
+ (_Bool)setMapViewIsGlobeProjection:(id)arg1;
- (id);
- (void);
- (id);
- (id);
...
- (void);
- (id);
- (void)_runningSampleCount;
- (void)earing VoiceTrigger candidate in the voiceTriggerJarvis;
- (id);
- (unsigned long long);
- (void);
- (_Bool);
