...
;
- (void);
- (id)endpointer:didDetectHardEndpointAtTime:withMetrics:eventType: /* Error: Ran out of types for this method. */;
- (unsigned long long);
- (_Bool);
- (_Bool);
- (id);
...
- (id)_relatedPlaceListForComponentIdentifier: /* Error: Ran out of types for this method. */;
- (id)|;
- (void)qãSI@;
