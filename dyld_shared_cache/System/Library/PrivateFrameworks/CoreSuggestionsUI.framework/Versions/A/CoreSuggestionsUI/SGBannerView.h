...
@class CoreSuggestionsUI.SGBannerContent, CoreSuggestionsUI.SGBannerContentHostingView, NSArray, NSAttributedString, NSColor, NSString, NSVisualEffectView, SGBannerDividerParameter, SGSuggestionAction, SGSuggestionStore;
