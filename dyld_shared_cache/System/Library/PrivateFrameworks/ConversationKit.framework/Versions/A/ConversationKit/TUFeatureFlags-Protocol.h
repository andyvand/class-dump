...
@property(readonly, nonatomic) _Bool isBackgroundCameraEnabled;
...
@property(readonly, nonatomic) _Bool remoteControlClientSideCursorEnabled;
@property(readonly, nonatomic) _Bool remoteControlEnabled;
