...
@interface BKSLocalDefaults
{
    ...
    _Bool _allowWirelessExtendedDisplay;
...
@property(nonatomic) _Bool allowWirelessExtendedDisplay; // @synthesize allowWirelessExtendedDisplay=_allowWirelessExtendedDisplay;
@property(nonatomic) int brightnessCurve; // @dynamic brightnessCurve;
@property(nonatomic) NSArray *digitizerServicePersistentProperties; // @dynamic digitizerServicePersistentProperties;
...
@property(nonatomic) _Bool disableExtendedDisplayByDefault; // @synthesize disableExtendedDisplayByDefault=_disableExtendedDisplayByDefault;
...
@property(nonatomic, getter=isEventBufferingEnabled) _Bool eventBufferingEnabled; // @dynamic eventBufferingEnabled;
...
@property(retain, nonatomic) NSDictionary *keyboardTypeRemap; // @dynamic keyboardTypeRemap;
@property(nonatomic) __weak NSArray *loggingTypesEnabled; // @dynamic loggingTypesEnabled;
@property(retain, nonatomic) NSArray *mouseInterpolation; // @dynamic mouseInterpolation;
@property(nonatomic) unsigned int pointerRegionArrangementEdge; // @dynamic pointerRegionArrangementEdge;
...
@property(nonatomic, getter=isSqueezeForSystemShortcutEnabled) _Bool squeezeForSystemShortcutEnabled; // @dynamic squeezeForSystemShortcutEnabled;
