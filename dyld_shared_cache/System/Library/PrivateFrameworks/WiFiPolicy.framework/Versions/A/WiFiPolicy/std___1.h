...
public: // (access info unavailable from symbols alone)
    ...
    std::__1::__allocation_result<std::__1::allocator_traits<std::__1::allocator<gloria::TileId>>::pointer> __allocate_at_least[abi:nqe210106]<std::__1::allocator<gloria::TileId>>(std::__1::allocator<gloria::TileId>&, unsigned long);
