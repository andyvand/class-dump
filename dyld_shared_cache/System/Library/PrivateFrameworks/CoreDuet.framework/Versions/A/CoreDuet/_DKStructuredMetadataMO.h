...
@property(nonatomic) short _CDPortraitMetadataKey__compatibilityVersion; // @dynamic _CDPortraitMetadataKey__compatibilityVersion;
...
@property(copy, nonatomic) NSNumber *_DKAlarmMetadataKey__isSleep; // @dynamic _DKAlarmMetadataKey__isSleep;
@property(copy, nonatomic) NSString *_DKAppClipUsageMetadataKey__URLHash; // @dynamic _DKAppClipUsageMetadataKey__URLHash;
@property(copy, nonatomic) NSString *_DKAppClipUsageMetadataKey__appBundleID; // @dynamic _DKAppClipUsageMetadataKey__appBundleID;
@property(copy, nonatomic) NSString *_DKAppClipUsageMetadataKey__clipBundleID; // @dynamic _DKAppClipUsageMetadataKey__clipBundleID;
@property(copy, nonatomic) NSURL *_DKAppClipUsageMetadataKey__fullURL; // @dynamic _DKAppClipUsageMetadataKey__fullURL;
@property(copy, nonatomic) NSString *_DKAppClipUsageMetadataKey__launchReason; // @dynamic _DKAppClipUsageMetadataKey__launchReason;
@property(copy, nonatomic) NSString *_DKAppClipUsageMetadataKey__referrerBundleID; // @dynamic _DKAppClipUsageMetadataKey__referrerBundleID;
@property(copy, nonatomic) NSURL *_DKAppClipUsageMetadataKey__referrerURL; // @dynamic _DKAppClipUsageMetadataKey__referrerURL;
@property(nonatomic) double _DKAppClipUsageMetadataKey__timeSinceDownload; // @dynamic _DKAppClipUsageMetadataKey__timeSinceDownload;
@property(copy, nonatomic) NSString *_DKAppClipUsageMetadataKey__webAppBundleID; // @dynamic _DKAppClipUsageMetadataKey__webAppBundleID;
...
@property(copy, nonatomic) NSURL *_DKAppMediaUsageMetadataKey__URL; // @dynamic _DKAppMediaUsageMetadataKey__URL;
@property(copy, nonatomic) NSURL *_DKAppMediaUsageMetadataKey__mediaURL; // @dynamic _DKAppMediaUsageMetadataKey__mediaURL;
...
@property(copy, nonatomic) NSNumber *_DKApplicationActivityMetadataKey__beginningOfActivity; // @dynamic _DKApplicationActivityMetadataKey__beginningOfActivity;
...
@property(nonatomic) long long _DKApplicationActivityMetadataKey__shortcutAvailability; // @dynamic _DKApplicationActivityMetadataKey__shortcutAvailability;
...
@property(retain, nonatomic) NSData *_DKBehavioralRuleFeaturesMetadataKey__featureDict; // @dynamic _DKBehavioralRuleFeaturesMetadataKey__featureDict;
@property(copy, nonatomic) NSString *_DKBluetoothMetadataKey__address; // @dynamic _DKBluetoothMetadataKey__address;
@property(copy, nonatomic) NSNumber *_DKBluetoothMetadataKey__batteryLevelHeadphoneCase; // @dynamic _DKBluetoothMetadataKey__batteryLevelHeadphoneCase;
@property(copy, nonatomic) NSNumber *_DKBluetoothMetadataKey__batteryLevelHeadphoneLeft; // @dynamic _DKBluetoothMetadataKey__batteryLevelHeadphoneLeft;
@property(copy, nonatomic) NSNumber *_DKBluetoothMetadataKey__batteryLevelHeadphoneRight; // @dynamic _DKBluetoothMetadataKey__batteryLevelHeadphoneRight;
@property(copy, nonatomic) NSNumber *_DKBluetoothMetadataKey__deviceType; // @dynamic _DKBluetoothMetadataKey__deviceType;
@property(copy, nonatomic) NSNumber *_DKBluetoothMetadataKey__isAppleAudioDevice; // @dynamic _DKBluetoothMetadataKey__isAppleAudioDevice;
@property(copy, nonatomic) NSNumber *_DKBluetoothMetadataKey__isUserWearing; // @dynamic _DKBluetoothMetadataKey__isUserWearing;
@property(copy, nonatomic) NSString *_DKBluetoothMetadataKey__name; // @dynamic _DKBluetoothMetadataKey__name;
@property(copy, nonatomic) NSNumber *_DKBluetoothMetadataKey__productID; // @dynamic _DKBluetoothMetadataKey__productID;
...
@property(nonatomic) _Bool _DKDeviceIsPluggedInMetadataKey__adapterIsWireless; // @dynamic _DKDeviceIsPluggedInMetadataKey__adapterIsWireless;
...
@property(nonatomic) _Bool _DKDigitalHealthMetadataKey__isUsageTrusted; // @dynamic _DKDigitalHealthMetadataKey__isUsageTrusted;
@property(copy, nonatomic) NSString *_DKDigitalHealthMetadataKey__safariProfileID; // @dynamic _DKDigitalHealthMetadataKey__safariProfileID;
...
@property(retain, nonatomic) NSData *_DKFamilyPredictionMetadataKey__suggestions; // @dynamic _DKFamilyPredictionMetadataKey__suggestions;
...
@property(copy, nonatomic) NSString *_DKIntentMetadataKey__interactionIdentifier; // @dynamic _DKIntentMetadataKey__interactionIdentifier;
@property(copy, nonatomic) NSString *_DKIntentMetadataKey__relatedContactIdentifiers; // @dynamic _DKIntentMetadataKey__relatedContactIdentifiers;
...
@property(nonatomic) long long _DKIntentMetadataKey__shortcutAvailability; // @dynamic _DKIntentMetadataKey__shortcutAvailability;
...
@property(retain, nonatomic) NSData *_DKMetadataHomeKitAccessoryControl__accessoryState; // @dynamic _DKMetadataHomeKitAccessoryControl__accessoryState;
...
@property(nonatomic) _Bool _DKMetadataHomeKitAccessoryControl__eligibleForSuggestions; // @dynamic _DKMetadataHomeKitAccessoryControl__eligibleForSuggestions;
@property(nonatomic) long long _DKMetadataHomeKitAccessoryControl__homeOccupancy; // @dynamic _DKMetadataHomeKitAccessoryControl__homeOccupancy;
...
@property(copy, nonatomic) NSString *_DKMetadataHomeKitAccessoryControl__serviceUUID; // @dynamic _DKMetadataHomeKitAccessoryControl__serviceUUID;
@property(copy, nonatomic) NSString *_DKMetadataHomeKitAccessoryControl__source; // @dynamic _DKMetadataHomeKitAccessoryControl__source;
...
@property(retain, nonatomic) NSData *_DKMetadataHomeKitScene__associatedAccessoryUUIDs; // @dynamic _DKMetadataHomeKitScene__associatedAccessoryUUIDs;
@property(copy, nonatomic) NSString *_DKMetadataHomeKitScene__clientName; // @dynamic _DKMetadataHomeKitScene__clientName;
@property(nonatomic) long long _DKMetadataHomeKitScene__homeOccupancy; // @dynamic _DKMetadataHomeKitScene__homeOccupancy;
...
@property(copy, nonatomic) NSString *_DKMetadataHomeKitScene__source; // @dynamic _DKMetadataHomeKitScene__source;
...
@property(copy, nonatomic) NSNumber *_DKNowPlayingMetadataKey__iTunesStoreIdentifier; // @dynamic _DKNowPlayingMetadataKey__iTunesStoreIdentifier;
@property(copy, nonatomic) NSNumber *_DKNowPlayingMetadataKey__iTunesSubscriptionIdentifier; // @dynamic _DKNowPlayingMetadataKey__iTunesSubscriptionIdentifier;
...
@property(retain, nonatomic) NSData *_DKPeopleSuggesterOutputForSiriNLMetadataKey__rankedSuggestions; // @dynamic _DKPeopleSuggesterOutputForSiriNLMetadataKey__rankedSuggestions;
...
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__adaptedModelRecipeID; // @dynamic _DKShareSheetFeedbackMetadataKey__adaptedModelRecipeID;
@property(retain, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__attachments; // @dynamic _DKShareSheetFeedbackMetadataKey__attachments;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__derivedIntentIdentifier; // @dynamic _DKShareSheetFeedbackMetadataKey__derivedIntentIdentifier;
@property(nonatomic) long long _DKShareSheetFeedbackMetadataKey__engagementType; // @dynamic _DKShareSheetFeedbackMetadataKey__engagementType;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__extensionContextUUID; // @dynamic _DKShareSheetFeedbackMetadataKey__extensionContextUUID;
@property(copy, nonatomic) NSNumber *_DKShareSheetFeedbackMetadataKey__iCloudFamilyInvocation; // @dynamic _DKShareSheetFeedbackMetadataKey__iCloudFamilyInvocation;
@property(nonatomic) long long _DKShareSheetFeedbackMetadataKey__indexSelected; // @dynamic _DKShareSheetFeedbackMetadataKey__indexSelected;
@property(copy, nonatomic) NSNumber *_DKShareSheetFeedbackMetadataKey__isAdaptedModelCreated; // @dynamic _DKShareSheetFeedbackMetadataKey__isAdaptedModelCreated;
@property(copy, nonatomic) NSNumber *_DKShareSheetFeedbackMetadataKey__isAdaptedModelUsed; // @dynamic _DKShareSheetFeedbackMetadataKey__isAdaptedModelUsed;
@property(retain, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__locationUUIDs; // @dynamic _DKShareSheetFeedbackMetadataKey__locationUUIDs;
@property(retain, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__modelSuggestionProxies; // @dynamic _DKShareSheetFeedbackMetadataKey__modelSuggestionProxies;
@property(nonatomic) double _DKShareSheetFeedbackMetadataKey__numberOfVisibleSuggestions; // @dynamic _DKShareSheetFeedbackMetadataKey__numberOfVisibleSuggestions;
@property(nonatomic) long long _DKShareSheetFeedbackMetadataKey__peopleSuggestionsDisabled; // @dynamic _DKShareSheetFeedbackMetadataKey__peopleSuggestionsDisabled;
@property(retain, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__photoSuggestedContacts; // @dynamic _DKShareSheetFeedbackMetadataKey__photoSuggestedContacts;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__reason; // @dynamic _DKShareSheetFeedbackMetadataKey__reason;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__reasonType; // @dynamic _DKShareSheetFeedbackMetadataKey__reasonType;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__sourceBundleID; // @dynamic _DKShareSheetFeedbackMetadataKey__sourceBundleID;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__supportedBundleIDs; // @dynamic _DKShareSheetFeedbackMetadataKey__supportedBundleIDs;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__targetBundleID; // @dynamic _DKShareSheetFeedbackMetadataKey__targetBundleID;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__trackingID; // @dynamic _DKShareSheetFeedbackMetadataKey__trackingID;
@property(copy, nonatomic) NSString *_DKShareSheetFeedbackMetadataKey__transportBundleID; // @dynamic _DKShareSheetFeedbackMetadataKey__transportBundleID;
@property(copy, nonatomic) NSString *_DKShareSheetSuggestLessFeedbackMetadataKey__bundleId; // @dynamic _DKShareSheetSuggestLessFeedbackMetadataKey__bundleId;
@property(copy, nonatomic) NSString *_DKShareSheetSuggestLessFeedbackMetadataKey__contactId; // @dynamic _DKShareSheetSuggestLessFeedbackMetadataKey__contactId;
@property(copy, nonatomic) NSString *_DKShareSheetSuggestLessFeedbackMetadataKey__conversationIdentifier; // @dynamic _DKShareSheetSuggestLessFeedbackMetadataKey__conversationIdentifier;
@property(copy, nonatomic) NSString *_DKShareSheetSuggestLessFeedbackMetadataKey__derivedIntentIdentifier; // @dynamic _DKShareSheetSuggestLessFeedbackMetadataKey__derivedIntentIdentifier;
@property(copy, nonatomic) NSString *_DKShareSheetSuggestLessFeedbackMetadataKey__handle; // @dynamic _DKShareSheetSuggestLessFeedbackMetadataKey__handle;
...
@property(retain, nonatomic) NSData *_DKSiriIntentEventMetadataKey__eventData; // @dynamic _DKSiriIntentEventMetadataKey__eventData;
@property(copy, nonatomic) NSString *_DKSiriIntentEventMetadataKey__eventType; // @dynamic _DKSiriIntentEventMetadataKey__eventType;
