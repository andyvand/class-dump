...
- (_Bool)textView:(NSTextView *)arg1 clickedOnLink:(id)arg2;
- (NSArray *)textView:(NSTextView *)arg1 writingToolsIgnoredRangesInEnclosingRange:(struct _NSRange)arg2;
- (void)textViewWritingToolsDidEnd:(NSTextView *)arg1;
- (void)textViewWritingToolsWillBegin:(NSTextView *)arg1;
- (_Bool)textView:(NSTextView *)arg1 shouldSelectCandidateAtIndex:(unsigned long long)arg2;
...
- (_Bool)textView:(NSTextView *)arg1 doCommandBySelector:(SEL)arg2;
- (_Bool)textView:(NSTextView *)arg1 shouldChangeTextInRange:(struct _NSRange)arg2 replacementString:(NSString *)arg3;
...
- (_Bool)textView:(NSTextView *)arg1 shouldChangeTextInRanges:(NSArray *)arg2 replacementStrings:(NSArray *)arg3;
...
- (_Bool)textView:(NSTextView *)arg1 writeCell:(id <NSTextAttachmentCell>)arg2 atIndex:(unsigned long long)arg3 toPasteboard:(NSPasteboard *)arg4 type:(NSString *)arg5;
...
- (_Bool)textView:(NSTextView *)arg1 clickedOnLink:(id)arg2 atIndex:(unsigned long long)arg3;
@end
