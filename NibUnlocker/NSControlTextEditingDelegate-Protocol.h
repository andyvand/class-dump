...
- (_Bool)control:(NSControl *)arg1 textView:(NSTextView *)arg2 doCommandBySelector:(SEL)arg3;
- (_Bool)control:(NSControl *)arg1 isValidObject:(id)arg2;
- (void)control:(NSControl *)arg1 didFailToValidatePartialString:(NSString *)arg2 errorDescription:(NSString *)arg3;
- (_Bool)control:(NSControl *)arg1 didFailToFormatString:(NSString *)arg2 errorDescription:(NSString *)arg3;
- (_Bool)control:(NSControl *)arg1 textShouldEndEditing:(NSText *)arg2;
- (_Bool)control:(NSControl *)arg1 textShouldBeginEditing:(NSText *)arg2;
