...
- (_Bool)outlineView:(NSOutlineView *)arg1 acceptDrop:(id <NSDraggingInfo>)arg2 item:(id)arg3 childIndex:(long long)arg4;
...
- (_Bool)outlineView:(NSOutlineView *)arg1 writeItems:(NSArray *)arg2 toPasteboard:(NSPasteboard *)arg3;
...
- (_Bool)outlineView:(NSOutlineView *)arg1 isItemExpandable:(id)arg2;
