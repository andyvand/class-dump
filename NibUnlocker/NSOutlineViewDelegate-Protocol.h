...
@class NSArray, NSCell, NSEvent, NSIndexSet, NSNotification, NSOutlineView, NSString, NSTableColumn, NSTableRowView, NSTintConfiguration, NSView;
...
- (void)outlineView:(NSOutlineView *)arg1 userDidChangeVisibilityOfTableColumns:(NSArray *)arg2;
- (_Bool)outlineView:(NSOutlineView *)arg1 userCanChangeVisibilityOfTableColumn:(NSTableColumn *)arg2;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldShowOutlineCellForItem:(id)arg2;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldReorderColumn:(long long)arg2 toColumn:(long long)arg3;
...
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldCollapseItem:(id)arg2;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldExpandItem:(id)arg2;
- (_Bool)outlineView:(NSOutlineView *)arg1 isGroupItem:(id)arg2;
- (NSCell *)outlineView:(NSOutlineView *)arg1 dataCellForTableColumn:(NSTableColumn *)arg2 item:(id)arg3;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldTrackCell:(NSCell *)arg2 forTableColumn:(NSTableColumn *)arg3 item:(id)arg4;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldShowCellExpansionForTableColumn:(NSTableColumn *)arg2 item:(id)arg3;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldTypeSelectForEvent:(NSEvent *)arg2 withCurrentSearchString:(NSString *)arg3;
...
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldSelectTableColumn:(NSTableColumn *)arg2;
- (NSIndexSet *)outlineView:(NSOutlineView *)arg1 selectionIndexesForProposedSelection:(NSIndexSet *)arg2;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldSelectItem:(id)arg2;
- (_Bool)selectionShouldChangeInOutlineView:(NSOutlineView *)arg1;
- (_Bool)outlineView:(NSOutlineView *)arg1 shouldEditTableColumn:(NSTableColumn *)arg2 item:(id)arg3;
