...
- (NSWindow *)windowForSharingRequestFromWindow:(NSWindow *)arg1;
- (NSArray *)previewRepresentableActivityItemsForWindow:(NSWindow *)arg1;
...
- (_Bool)window:(NSWindow *)arg1 shouldDragDocumentWithEvent:(NSEvent *)arg2 from:(struct CGPoint)arg3 withPasteboard:(NSPasteboard *)arg4;
- (_Bool)window:(NSWindow *)arg1 shouldPopUpDocumentPathMenu:(NSMenu *)arg2;
...
- (_Bool)windowShouldZoom:(NSWindow *)arg1 toFrame:(struct CGRect)arg2;
...
- (_Bool)windowShouldClose:(NSWindow *)arg1;
@end
